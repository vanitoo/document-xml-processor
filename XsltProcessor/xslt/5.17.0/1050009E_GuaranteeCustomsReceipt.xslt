...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:grn_cr="urn:customs.ru:Information:GuaranteeDocuments:GuaranteeCustomsReceipt:5.16.0">
												...
												<td class="graph" style="border-right:1px solid gray;width:50%">
													...
													<xsl:for-each select="grn_cr:WayEnsure">
														<span class="sign">
															...
															<xsl:text> </xsl:text-->
															<xsl:apply-templates select="grn_crWayEnsureName"/>
														</span>
													</xsl:for-each>
												</td>
														...
														<xsl:choose>
															<xsl:when test="grn_cr:GeneralEnsure">
																<xsl:if test="grn_cr:GeneralEnsure != '0'">
																	<!--xsl:apply-templates select="grn_crGeneralEnsure"/-->
											...
											<xsl:for-each select="grn_cr:DetailsEnsure/grn_cr:RecDetailsEnsure">
												<tr>
													<td class="sign" style="border-top:1px solid gray; border-right:1px solid gray;" valign="top" align="center">
														<xsl:apply-templates select="grn_crPaymentModeCode"/>
													</td>
										...
										<tbody>
											<tr>
												...
												<td rowspan="2" class="sign">
													<xsl:apply-templates select="grn_crCustomsReceiptOfficialMark/grn_cr:CustomsPerson/cat_ru:PersonName"/>
													<xsl:text> </xsl:text>
													<xsl:apply-templates select="grn_crCustomsReceiptOfficialMark/grn_cr:CustomsPerson/cat_ru:LNP"/>
												</td>
											</tr>
										</tbody>
									</table>
										...
										<tbody>
											...
											<tr>
												<td colspan="3" class="sign" valign="top">
													<xsl:apply-templates select="grn_crCustomsReceiptCorrectMark/grn_cr:CustomsPerson/cat_ru:PersonName"/>
													<xsl:text> </xsl:text>
													<xsl:apply-templates select="grn_crCustomsReceiptCorrectMark/grn_cr:CustomsPerson/cat_ru:LNP"/>
												</td>
											</tr>
