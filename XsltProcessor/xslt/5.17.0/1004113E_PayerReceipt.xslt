					...
					<table class="w190">
						<tr>
							<td align="center" class="graphMain">
								<font size="4">
								<b>
								<xsl:text>Квитанция от </xsl:text>
