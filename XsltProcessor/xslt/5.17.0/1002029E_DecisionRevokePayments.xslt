...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:drp="urn:customs.ru:Information:CommercialFinanceDocuments:DecisionRevokePayments:5.17.0">
	<!-- 
						...
						<tr class="graphMain" align="center">
							...
							<td width="38%" class="border_bottom">
								<span class="normal">
									...
									<xsl:value-of select="drp:CustomsChief/drp:PersonName"/>&#160;
									<xsl:if test="drp:CustomsChief/drp:PersonMiddleName">
										<xsl:value-of select="drp:CustomsChief/drp:PersonMiddleName"/>&#160;
									</xsl:if>
