...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:impn="urn:customs.ru:Information:CustomsDocuments:OEZ_ImportNotif:5.17.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0">
                     ...
                     <tr>
                        ...
                        <td align="left" style="width:167mm" valign="top">
                           ...
                           <xsl:if test="impn:DocSign='3'">Разрешение</xsl:if> № <u>
                              <xsl:apply-templates select="impn:RegistrationNumber/impn:CustomsCode"/>/<xsl:apply-templates select="impn:RegistrationNumber/impn:RegistrationDate" mode="russian_date_gtd"/>/<xsl:apply-templates select="impn:RegistrationNumber/impn:Number"/>
                           </u>
                           <br/>
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td>Примечание</td>
							<xsl:if test="//impn:TechID">                        
								<td>Технические идентификаторы</td>
							</xsl:if>
                        </tr>
                        <tr>
                           <td>1</td>
                        ...
                        <xsl:for-each select="impn:GoodsInfo">
                           ...
                           <tr>
                              ...
                              <td>
                                 <xsl:apply-templates select="impn:GoodsStatus"/>/<xsl:apply-templates select="impn:CustomsModeCode"/>
                              </td>
                              <td>
