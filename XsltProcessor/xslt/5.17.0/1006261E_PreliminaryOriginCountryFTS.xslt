...
<xsl:stylesheet exclude-result-prefixes="cat_ru porc_fts" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:porc_fts="urn:customs.ru:Information:CustomsDocuments:PreliminaryOriginCountryFTS:5.17.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
