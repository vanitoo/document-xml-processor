...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.17.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:ain="urn:customs.ru:Information:CustomsDocuments:ActInspection:5.17.0" xmlns:catESAD_ru="urn:customs.ru:RUCommonAggregateTypes:5.17.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0">
								...
								<tbody>
									<tr>
										<td align="center" class="graphMain" style="width:100%">
											<xsl:if test="ain:Customs/cat_ru:Code">
												<xsl:apply-templates select="ain:Customs/cat_ru:Code"/>, </xsl:if>
											<xsl:apply-templates select="ain:Customs/cat_ru:OfficeName"/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td class="graph" style="width:100%">Время начала таможенного <xsl:choose>
											...
											<xsl:text> </xsl:text>Дата <xsl:apply-templates mode="russian_date" select="ain:BeginInspectionDate"/>
											<br/>
											<br/>
										</td>
									</tr>
...
декларанта, лица, обладающего полномочиями в отношении товаров (транспортных средств), либо их представителей:<br/>
									...
									<xsl:if test="ain:InspectionParticipant/ain:Status='3'">
										<tr>
											...
											<xsl:apply-templates select="cat_ru:PersonSurname"/> <xsl:apply-templates select="cat_ru:PersonName"/> <xsl:apply-templates select="cat_ru:PersonMiddleName"/> ,
											
														<xsl:if test="ain:Job">
															<xsl:apply-templates select="ain:Job"/>
															<xsl:text> ,</xsl:text>
														</xsl:if>
                    ...
                    Описание места проведения досмотра (таможенного осмотра). Иная информация о месте досмотра<xsl:text> </xsl:text>
							...
							Применялись технические средства таможенного контроля:
									...
									<tr>
										<td class="graph" style="width:100%">[ <xsl:choose>
												...
												<xsl:when test="ain:AMTInspResults or ain:BusInspResults or ain:TrailerInspResults or ain:TruckInspResults or ain:MotoInspResults or ain:InspTransport[ain:ArriveMode &lt; 4]">
													<span class="graphBold">х</span>
												</xsl:when>
												<xsl:otherwise>
													<span class="graphBold">–</span>
							...
							– товар из 
									...
									] –  транспортное средство: регистрационный номер: <xsl:apply-templates select="ain:InspTransport[not(ain:ArriveMode)]/ain:InspTransportMean"/> 
							...
							№ <xsl:apply-templates select="ain:Seize/ain:SeizeAct/cat_ru:PrDocumentNumber"/>
									...
									<tr>
										<td class="graph" style="width:100%">
							Обнаружены признаки правонарушений:  <xsl:apply-templates select="ain:InspectionResults/ain:AKParts"/>
										</td>
									</tr>
									<tr>
										<td class="graph" style="width:100%">
							Наложены средства идентификации <xsl:apply-templates select="ain:InspectionResults/ain:NewIdentMarks"/> в количестве <xsl:apply-templates select="ain:InspectionResults/ain:NumberOfNewIdentMarks"/> шт
									...
									<xsl:for-each select="ain:ATDCustomsPerson">
										<tr>
											<td class="graph" style="width:100%">
							Должностные лица: <xsl:apply-templates select="cat_ru:PersonSurname"/>
												<xsl:text> </xsl:text>
												<xsl:apply-templates select="cat_ru:PersonName"/>
												<xsl:text> </xsl:text>
												<xsl:apply-templates select="cat_ru:PersonMiddleName"/>
							...
							<xsl:if test="ain:InspectionParticipant[ain:Status ='5']">
												<xsl:apply-templates select="ain:InspectionParticipant[ain:Status ='5']/cat_ru:PersonSurname"/> 
										<xsl:apply-templates select="ain:InspectionParticipant[ain:Status ='5']/cat_ru:PersonName"/> 
										<xsl:apply-templates select="ain:InspectionParticipant[ain:Status ='5']/cat_ru:PersonMiddleName"/> 
									</xsl:if>
										</td>
									</tr>
									<tr>
							...
							<xsl:if test="ain:InspectionParticipant[ain:Status ='5']">
									...
									<tr>
										<td class="graph" style="width:100%">Дата и время окончания таможенного <xsl:choose>
											...
											<xsl:text> </xsl:text>
											<xsl:apply-templates mode="russian_date" select="ain:EndInspectionDate"/>
											<xsl:text> </xsl:text>
											<xsl:apply-templates mode="russian_time" select="ain:EndInspectionTime"/>
											<xsl:if test="ain:EndComposeDate">
												<xsl:text> </xsl:text>(время завершения составления акта <xsl:apply-templates mode="russian_date" select="ain:EndComposeDate"/>
												<xsl:if test="ain:EndComposeTime">
													<xsl:text> </xsl:text>
													<xsl:apply-templates select="ain:EndComposeTime"/>
												</xsl:if>)</xsl:if>
											<br/>
											<br/>
										</td>
									...
									<tr>
										...
										Второй экземпляр акта получил на руки 
														...
														<td align="center" class="graph" style="width:20%">
															<xsl:apply-templates select="ain:InspectionParticipant[ain:ATDReceiveCopy='1' or ain:ATDReceiveCopy='t' or ain:ATDReceiveCopy='true']/cat_ru:PersonSurname"/> 
													<xsl:apply-templates select="ain:InspectionParticipant[ain:ATDReceiveCopy='1' or ain:ATDReceiveCopy='t' or ain:ATDReceiveCopy='true']/cat_ru:PersonName"/> 
													<xsl:apply-templates select="ain:InspectionParticipant[ain:ATDReceiveCopy='1' or ain:ATDReceiveCopy='t' or ain:ATDReceiveCopy='true']/cat_ru:PersonMiddleName"/> 
												</td>
													</tr>
													<tr>
								...
								<tbody>
									...
									<tr>
										<td class="graph" style="width:100%">Время начала таможенного <xsl:choose>
											...
											<xsl:text> </xsl:text>
											<xsl:apply-templates mode="russian_time" select="ain:BeginInspectionTime"/>
											<xsl:text> </xsl:text>Дата <xsl:apply-templates mode="russian_date" select="ain:BeginInspectionDate"/>
											<br/>
											<br/>
										</td>
								...
								<xsl:for-each select="ain:InspectionParticipant">
									...
									<tr>
										<td class="graph" style="width:100%">
											<xsl:for-each select="ain:InspectionParticipant">
												<xsl:choose>
													<xsl:when test="ain:Status ='6'">
														оператор почтовой связи <xsl:if test="ain:Job">Место работы <xsl:apply-templates select="ain:Job"/>
														</xsl:if>
														<xsl:if test="cat_ru:PersonPost"> <xsl:apply-templates select="cat_ru:PersonPost"/>
														</xsl:if>
														<xsl:if test="cat_ru:PersonSurname"> <xsl:apply-templates select="cat_ru:PersonSurname"/>
														</xsl:if>
													...
													<xsl:when test="ain:Status ='3'">
														декларант или иное лицо, обладающее полномочиями в отношении товаров <xsl:if test="ain:Job">Место работы <xsl:apply-templates select="ain:Job"/>
														</xsl:if>
														<xsl:if test="cat_ru:PersonPost"> <xsl:apply-templates select="cat_ru:PersonPost"/>
														</xsl:if>
														<xsl:if test="cat_ru:PersonSurname"> <xsl:apply-templates select="cat_ru:PersonSurname"/>
									...
									<tr>
										<td class="graph" style="width:100%">
											...
											<xsl:for-each select="ain:InspectionParticipant">
												<xsl:if test="ain:Status='5'">
														специалист <xsl:if test="ain:Job">Место работы <xsl:apply-templates select="ain:Job"/>
													</xsl:if>
													<xsl:if test="cat_ru:PersonPost"> <xsl:apply-templates select="cat_ru:PersonPost"/>
													</xsl:if>
													<xsl:if test="cat_ru:PersonSurname"> <xsl:apply-templates select="cat_ru:PersonSurname"/>
									...
									<tr>
										<td class="graph" style="width:100%">
											<br/>Таможенный досмотр проведен в отсутствие декларанта или иного лица, обладающего полномочиями в отношении товаров (их представителей) по причине: <xsl:for-each select="ain:InspectionParticipant[ain:Status='4']">
												<xsl:apply-templates select="ain:Reason"/>
											</xsl:for-each>
										</td>
									</tr>
									<tr>
...
для физического лица – Ф.И.О., место жительства)<br/>
									...
									<tr>
										<td class="graph" style="width:100%">Фактический вес товара брутто <xsl:apply-templates select="ain:InspectionResults/ain:FactWeight/ain:Brutto"/> кг определен способом фактического взвешивания
							</td>
									</tr>
									<tr>
							...
							<xsl:if test="ain:IdentKind=1">пломба</xsl:if>
									...
									<tr>
										<td class="graph" style="width:100%">
							К акту прилагаются: <xsl:apply-templates select="ain:InspectionResults/ain:ApplicMarks"/>
										</td>
									</tr>
									<tr>
										<td align="center" class="graphtop" style="width:100%"> (документы, фотографии, этикетки и т.п.)<br/>
							...
							Наложены средства идентификации <xsl:value-of select="ain:InspectionResults/ain:NewIdentMarks"/> в количестве <xsl:value-of select="ain:InspectionResults/ain:NumberOfNewIdentMarks"/> шт
									...
									<xsl:for-each select="ain:ATDCustomsPerson">
										<tr>
											<td class="graph" style="width:100%">
							Должностное лицо (должностные лица): <xsl:apply-templates select="cat_ru:PersonSurname"/>
												<xsl:text> </xsl:text>
												<xsl:apply-templates select="cat_ru:PersonName"/>
												<xsl:text> </xsl:text>
												<xsl:apply-templates select="cat_ru:PersonMiddleName"/>
										...
										<table>
											<tbody>
												<tr>
													...
													<td align="center" class="graph" style="width:30%">
														<xsl:apply-templates select="ain:ATDCustomsPerson[catESAD_ru:OfficialStatus='1' or catESAD_ru:OfficialStatus='t' or catESAD_ru:OfficialStatus='true']/cat_ru:PersonSurname"/> 
													<xsl:apply-templates select="ain:ATDCustomsPerson[catESAD_ru:OfficialStatus='1' or catESAD_ru:OfficialStatus='t' or catESAD_ru:OfficialStatus='true']/cat_ru:PersonName"/> 
													<xsl:apply-templates select="ain:ATDCustomsPerson[catESAD_ru:OfficialStatus='1' or catESAD_ru:OfficialStatus='t' or catESAD_ru:OfficialStatus='true']/cat_ru:PersonMiddleName"/> 
												</td>
												</tr>
												<tr>
								...
								<table width="100%">
									<tbody>
										<tr>
											...
											<td class="graph underlined" width="50%">
												<xsl:choose>
													<xsl:when test="ain:GoodsViolationFlag=1">по весу нетто</xsl:when>
													<xsl:when test="ain:GoodsViolationFlag=2">по количеству товаров, в единицах измерения</xsl:when>
													<xsl:when test="ain:GoodsViolationFlag=3">по описанию</xsl:when>
													<xsl:otherwise>
   ...
   <xsl:template match="ain:DTRegNum">
	   <xsl:apply-templates select="cat_ru:CustomsCode"/>
		...
		<xsl:if test="RUScat_ru:AddNumber">
		   <xsl:choose>
				<xsl:when test="RUScat_ru:AddNumber = 'ЗВ'">В</xsl:when>
				<xsl:otherwise><xsl:apply-templates select="RUScat_ru:AddNumber"/></xsl:otherwise>
			</xsl:choose>
		</xsl:if>
