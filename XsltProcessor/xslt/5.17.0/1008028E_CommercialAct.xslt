										...
										<table>
											...
											<xsl:if test="catWH_ru:MPONumber">
												<tr>
													...
													<td class="graph" style="border:solid 1pt #000000" width="60%">
									Указатель сервиса:<xsl:apply-templates select="catWH_ru:MPONumber/catWH_ru:ServiceIndicator"/>
														<br/>
									Порядковый номер:<xsl:apply-templates select="catWH_ru:MPONumber/catWH_ru:SerialNumber"/>
														<br/>
									Код страны:<xsl:apply-templates select="catWH_ru:MPONumber/catWH_ru:CountryCode"/>
													</td>
												</tr>
											</xsl:if>
