				...
				<tr>
									...
									<xsl:for-each select="do2r:GoodsShipment/do2r:Goods">
                                       ...
                                       <xsl:apply-templates select="do2r:DO1GoodLink/do2r:DO1Time"/-->
												...
												<td class="bordered" style="width:18mm">
													<xsl:apply-templates select="catWH_ru:GoodsDescription"/>
												</td>
					...
					<td align="center">21</td-->
                                       ...
                                       <xsl:apply-templates select="do2r:DO1GoodLink/do2r:DO1Time"/-->
												...
												<td class="bordered" style="width:18mm">
													<xsl:if test="catWH_ru:MPONumber">
														<xsl:apply-templates select="catWH_ru:MPONumber/catWH_ru:ServiceIndicator"/>/
													<xsl:apply-templates select="catWH_ru:MPONumber/catWH_ru:SerialNumber"/>/
													<xsl:apply-templates select="catWH_ru:MPONumber/catWH_ru:CountryCode"/>
													</xsl:if>
						...
						<xsl:apply-templates select="do2r:Input/catWH_ru:GoodsTNVEDCode"/>
												...
												<!--7 складской номер-->
												<td class="bordered" style="width:11mm">
													<xsl:apply-templates select="do2r:MPOCaseNum"/>
												</td>
												<!--8 Количество грузовых мест -->
												<td class="bordered" style="width:7mm">
						1
				...
				<xsl:choose>
						...
						<table width="250mm">
							...
							<xsl:for-each select="do2r:GoodsShipment/do2r:Goods">
								<tr>
									...
									<!--5 Наименование товара-->
									<td class="bordered">
										<xsl:apply-templates select="do2r:Input/catWH_ru:GoodsDescription"/>
									</td>
									<!--6 Код товара в соответствии с ГС или ТН ВЭД ЕАЭС-->
									<td class="bordered">
										<xsl:apply-templates select="do2r:Input/catWH_ru:GoodsTNVEDCode"/>
					...
					<td align="center">21</td-->
						...
						<xsl:apply-templates select="do2r:Input/catWH_ru:GoodsTNVEDCode"/>
									...
									<!--7 складской номер-->
									<td class="bordered">
										<xsl:apply-templates select="do2r:Input/do2r:MPOCaseNum"/>
									</td>
									<!--8 Количество грузовых мест -->
									<td class="bordered">
						1
