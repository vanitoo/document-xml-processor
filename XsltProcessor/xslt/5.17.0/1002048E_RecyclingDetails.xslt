                  ...
                  <xsl:apply-templates select="cat_ru:RefDocumentID" />
						...
						<tr>
							...
							<td class="value graphMain" style="width:50%">
								<xsl:variable name="xpath_DocType">
									<xsl:call-template name="get_xpath">
										<xsl:with-param name="node" select="rd:DocType"/>
									</xsl:call-template>
								</xsl:variable>
							...
							<tbody>
								<xsl:for-each select="rd:Payer">
									...
									<tr>
										...
										<td class="value graphMain" style="width:50%">
											<xsl:variable name="xpath_PersonIDIndicator">
												<xsl:call-template name="get_xpath">
													<xsl:with-param name="node" select="rd:PersonIDIndicator"/>
												</xsl:call-template>
											</xsl:variable>
											<element xml_node="{$xpath_PersonIDIndicator}">
												<xsl:choose>
									...
									<tr>
										...
										<td class="value graphMain" style="width:50%">
											<xsl:variable name="xpath_FactPayerIndicator">
												<xsl:call-template name="get_xpath">
													<xsl:with-param name="node" select="rd:FactPayerIndicator"/>
												</xsl:call-template>
											</xsl:variable>
											<element xml_node="{$xpath_FactPayerIndicator}">
												<xsl:choose>
					...
					<table>
						<tr>
							...
							<td class="value graphMain" style="width:50%">
								<xsl:variable name="xpath_NoPayIndicator">
									<xsl:call-template name="get_xpath">
										<xsl:with-param name="node" select="rd:NoPayIndicator"/>
									</xsl:call-template>
								</xsl:variable>
								<element xml_node="{$xpath_NoPayIndicator}">
									<xsl:choose>
					...
					<xsl:if test="rd:NoPayReasons">
						<table>
							<tr>
								...
								<td class="value graphMain" style="width:50%">
									<xsl:apply-templates select="rd:NoPayReasons"/>
								</td>
							</tr>
						</table>
					</xsl:if>
