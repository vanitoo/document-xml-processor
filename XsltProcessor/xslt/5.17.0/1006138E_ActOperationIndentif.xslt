...
<xsl:stylesheet version="1.0" xmlns:aopin="urn:customs.ru:Information:CustomsDocuments:ActOperationIndentif:5.17.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
						...
						<tbody>
							...
							<xsl:variable name="xpath_ActDate">
								<xsl:call-template name="get_xpath">
									<xsl:with-param name="node" select="aopin:ActDate"/>
								</xsl:call-template>
							</xsl:variable>
							<tr>
								<td>
									...
									&lt;&lt;<span class="bordered">
												<element xml_node="{$xpath_ActDate}">
													<xsl:value-of select="substring(aopin:ActDate,9,2)"/>
												</element>
												</span> &gt;&gt;
									<span class="bordered">
												<element xml_node="{$xpath_ActDate}">
							...
							<tr>
								<td class="bordered">
									<xsl:apply-templates select="aopin:OperationPlace/aopin:InspPlaceName"/> 
							...
							<tr>
								<td class="bordered">
									<xsl:apply-templates select="aopin:PersonGoods/cat_ru:PersonSurname"/> 
							<xsl:apply-templates select="aopin:PersonGoods/cat_ru:PersonName"/> 
							<xsl:apply-templates select="aopin:PersonGoods/cat_ru:PersonMiddleName"/> 
							<xsl:apply-templates select="aopin:PersonGoods/cat_ru:PersonPost"/> 
							<xsl:apply-templates select="aopin:PersonGoods/aopin:Job"/> 
						</td>
							</tr>
							<tr>
								<td class="graphLittle">
						   ...
						   <span class="bordered">
							...
							<tr>
								<td class="bordered">
									<xsl:apply-templates select="aopin:SecondCopyReceived/cat_ru:PersonSurname"/> 
							<xsl:apply-templates select="aopin:SecondCopyReceived/cat_ru:PersonName"/> 
							<xsl:apply-templates select="aopin:SecondCopyReceived/cat_ru:PersonMiddleName"/> 
							<xsl:apply-templates select="aopin:SecondCopyReceived/cat_ru:PersonPost"/> 
							<xsl:apply-templates select="aopin:SecondCopyReceived/aopin:Job"/> 
						</td>
							</tr>
							<tr>
								<td class="graphLittle">
