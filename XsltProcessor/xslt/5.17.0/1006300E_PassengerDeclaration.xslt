...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.17.0" xmlns:pas_d="urn:customs.ru:Information:CustomsDocuments:PassengerDeclaration:5.17.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:RUSclt_ru="urn:customs.ru:RUSCommonLeafTypes:5.14.3" xmlns:RUDECLcat="urn:customs.ru:RUDeclCommonAggregateTypesCust:5.17.0">
		...
		<html>
			...
			<body>
				<div class="page">
					...
					<table>
						<tbody>
							...
							<tr>
								<td colspan="5" class="border-bottom">
									<xsl:for-each select="pas_d:DeclarantPerson/pas_d:Address[RUScat_ru:AddressKindCode = '1']/*">
				...
				<div class="page">
						...
						<tbody>
							...
							<xsl:for-each select="pas_d:GoodsShipmentDetails/pas_d:PassDeclGoodsInfo/pas_d:GoodsListDetails/pas_d:PassDeclGoods">
								<tr>
									...
									<td class="bordered" valign="top">
										<xsl:value-of select="translate(translate(format-number(pas_d:GoodsCost/RUScat_ru:Amount, '#,###.00'),',',' '),'.',',')"/>
										<xsl:text> </xsl:text>
					...
					<br/>
					<xsl:choose>
						<xsl:when test="pas_d:GoodsShipmentDetails/pas_d:TransportMeans/pas_d:TransportMeansDetails[pas_d:TransportModeCode='30']">
							<xsl:for-each select="pas_d:GoodsShipmentDetails/pas_d:TransportMeans/pas_d:TransportMeansDetails[pas_d:TransportModeCode='30']">
					...
					<xsl:choose>
						<xsl:when test="pas_d:GoodsShipmentDetails/pas_d:TransportMeans/pas_d:TransportMeansDetails[pas_d:TransportModeCode='10']">
							<xsl:for-each select="pas_d:GoodsShipmentDetails/pas_d:TransportMeans/pas_d:TransportMeansDetails[pas_d:TransportModeCode='10']">
								<xsl:if test="position() != 1">
									<br/>
								</xsl:if>
					...
					<xsl:choose>
						<xsl:when test="pas_d:GoodsShipmentDetails/pas_d:TransportMeans/pas_d:TransportMeansDetails[pas_d:TransportModeCode='40']">
							<xsl:for-each select="pas_d:GoodsShipmentDetails/pas_d:TransportMeans/pas_d:TransportMeansDetails[pas_d:TransportModeCode='40']">
								<xsl:if test="position() != 1">
									<br/>
								</xsl:if>
			...
			<tbody>
				<tr>
					...
					<td width="16%" class="border-bottom" align="center">
						<xsl:value-of select="$node/pas_d:EngineVolumeQuanity"/>
					</td>
				</tr>
				<tr>
			...
			<tbody>
				<tr>
					<td width="23%" class="border-bottom" align="center">
						<xsl:apply-templates select="pas_d:BodyID"/>
					</td>
					<td width="2%">
						<br/>
					</td>
					...
					<td width="2%"/>
					<td width="24%" class="border-bottom" align="center">
						<xsl:apply-templates select="$node/pas_d:OfftakeYear"/>
					</td>
					<td width="2%"/>
					<td width="23%" class="border-bottom" align="center">
				...
				<tr>
					...
					<td width="63%" class="border-bottom">
						...
						<xsl:if test="$SignatoryRepresentativeDetails">
							<br/>
							<xsl:apply-templates select="$SignatoryRepresentativeDetails/RUDECLcat:BrokerRegistryDocDetails/RUDECLcat:RegisterDocumentDetails/RUScat_ru:RegistrationNumberId"/>
