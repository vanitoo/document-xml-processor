...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:diac="urn:customs.ru:Information:CommercialFinanceDocuments:DebtIncashANDCommission:5.17.0">
								...
								<tbody>
									...
									<tr>
										...
										<td class="value underlined" colspan="2" align="center">
											<xsl:for-each select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:ExtInformation/diac:TypePayment">
												<xsl:choose>
										...
										<td valign="top" align="left" rowspan="2" colspan="2" class="bordered">
											...
											<span class="value">
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:ExtInformation/diac:Order2"/>
											</span>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="14" class="value underlined">
											<br/>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:Amount/diac:PaymentAmountText"/>
										</td>
									</tr>
									<tr>
										<td colspan="4" valign="bottom" class="underlined" style="border-right: solid 1px black;">
											...
											<span class="value">
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/diac:INN"/>
											</span>
										</td>
										<td colspan="5" class="underlined">
											<xsl:text>КПП </xsl:text>
											<span class="value">
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/diac:KPP"/>
											</span>
										</td>
									...
									<tr>
										<td colspan="9" class="value">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/diac:OrganizationName"/>
											<xsl:if test="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/diac:ShortName">
												<xsl:if test="string-length(diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/diac:OrganizationName) &gt; 0"> (</xsl:if>
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/diac:ShortName"/>
												<xsl:if test="string-length(diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/diac:OrganizationName) &gt; 0">)</xsl:if>
											</xsl:if>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
										</td>
									...
									<tr>
										...
										<td colspan="5" class="value">
											...
											<xsl:choose>
												<xsl:when test="diac:DocumentInfo/diac:DocumentType = 0 and diac:DocumentInfo/diac:OrderType = 0">
													<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:AccountPayer"/>
												</xsl:when>
												<xsl:when test="diac:DocumentInfo/diac:DocumentType = 0 and diac:DocumentInfo/diac:OrderType = 2">
													<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:CorporatePayer"/>
												</xsl:when>
												<xsl:when test="diac:DocumentInfo/diac:DocumentType = 0 and diac:DocumentInfo/diac:OrderType = 3">
													<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:AccountPayer"/>
												</xsl:when>
									...
									<tr>
										<td class="value" colspan="9">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BankInfoPayer/diac:OrganizationName"/>
											<xsl:if test="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BankInfoPayer/diac:ShortName">
												<xsl:if test="string-length(diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BankInfoPayer/diac:OrganizationName) &gt; 0"> (</xsl:if>
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BankInfoPayer/diac:ShortName"/>
												<xsl:if test="string-length(diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BankInfoPayer/diac:OrganizationName) &gt; 0">)</xsl:if>
											</xsl:if>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
										</td>
										...
										<td colspan="5" class="value">
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BICBankPayer"/>
										</td>
									</tr>
									<tr>
										<td class="underlined" colspan="9">
										...
										<td colspan="5" class="value underlined">
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:sKorAccountBankPayer"/>
										</td>
									</tr>
									<tr>
										<td class="value" colspan="9">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:BankInfoRecipient"/>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
										</td>
										<td class="bordered" colspan="2">
											<xsl:text>БИК</xsl:text>
										...
										<td colspan="5" class="value">
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:BICBankRecipient"/>
										</td>
									</tr>
									<tr>
										<td class="underlined" colspan="9">
									...
									<tr>
										<td colspan="4" class="underlined" style="border-right: solid 1px black;">
											<xsl:text>ИНН </xsl:text>
											<span class="value">
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:RecipientINN"/>
											</span>
										</td>
										<td colspan="5" class="underlined">
											<xsl:text>КПП </xsl:text>
											<span class="value">
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:RecipientKPP"/>
											</span>
										</td>
										...
										<td valign="top" rowspan="3" colspan="5" class="value underlined">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:AccountRecipient"/>
										</td>
									</tr>
									<tr>
										<td colspan="9" class="value">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:RecipientName"/>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="value">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:TypeOfOperation"/>
										</td>
										...
										<td rowspan="2" colspan="2" valign="top" class="value underlined">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:PriorityPayment"/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="value">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:PaymentCode"/>
										</td>
									</tr>
									<tr>
										...
										<td class="value bordered" colspan="2" valign="top">
											<sup>3</sup>
											<br/>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:ExtInformation/diac:Order105"/>
										</td>
										<td class="value bordered" colspan="3" valign="top">
											<sup>4</sup>
											<br/>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:ExtInformation/diac:Order106"/>
										</td>
										<td class="value bordered" colspan="2" valign="top">
											<sup>5</sup>
											<br/>
										...
										<td class="value bordered" colspan="3" valign="top">
											<sup>6</sup>
											<br/>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:ExtInformation/diac:Order108"/>
										</td>
										<td class="value bordered" colspan="2" valign="top">
											<sup>7</sup>
											<br/>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:ExtInformation/diac:Order109"/>
										</td>
										<td class="value bordered" colspan="2" valign="top">
											<sup>8</sup>
											<br/>
										...
										<tr>
											<td colspan="16">
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:DetailInformation/diac:PurposePayment"/>
											</td>
										</tr>
										<tr>
						...
						<xsl:when test="diac:DocumentInfo/diac:DocumentType = 0 and diac:DocumentInfo/diac:OrderType = 1">
							<table width="100%" class="graphMain">
								<tbody>
									...
									<tr>
										<td class="value_line">
											<xsl:apply-templates select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BankInfoPayer" mode="organization"/>
											<xsl:if test="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BICBankPayer">
												<xsl:text>, БИК: </xsl:text>
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BICBankPayer"/>
											</xsl:if>
										</td>
									...
									<tr>
										<td class="value_line">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:AccountTypePayer"/>
											<xsl:if test="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:AccountPayer">
												<xsl:if test="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:AccountTypePayer">
													<xsl:text>, </xsl:text>
												</xsl:if>
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:AccountPayer"/>
											</xsl:if>
												...
												<tbody>
													<tr>
														<td class="value_line" width="99%">
															<xsl:apply-templates select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization" mode="organization2"/>
														</td>
								...
								<tbody>
									<tr>
										<td align="center">
											<font size="4">
												<b>
													<xsl:text>Поручение таможенного органа на продажу драгоценных металлов и перечисление денежных средств от продажи драгоценных металлов на расчетный (текущий) счет плательщика (лица, несущего солидарную обязанность)</xsl:text>
												</b>
											</font>
										</td>
									</tr>
									...
									<tr>
										<td>
											<xsl:text>осуществить продажу продажу драгоценных металлов, находящихся на счете </xsl:text>
										</td>
									</tr>
									<tr>
										<td class="value_line">
									...
									<tr>
										<td align="center" class="graphLittle">
											<xsl:text>(указывается вид и номер счета (вклада) плательщика)</xsl:text>
										</td>
									</tr>
									<tr>
										<td class="delim_3"/>
										...
										<td>
											<table>
												<tbody>
													<tr>
														<td class="value_line" width="99%">
															<xsl:apply-templates select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization" mode="organization"/>
														</td>
														<td width="1%" valign="bottom">
															<xsl:text>, </xsl:text>
														</td>
									...
									<tr>
										<td style="text-align: justify">
											<xsl:text>в соответствии с поручением таможенного органа на бесспорное взыскание (поручением таможенного органа на перевод электронных денежных средств на счет плательщика (лица, несущего солидарную обязанность) от </xsl:text>
											<xsl:choose>
												<xsl:when test="diac:DocumentInfo/diac:BaseDocument/diac:DecisInconGR/cat_ru:PrDocumentDate">
													<span class="value_line">
														<xsl:call-template name="russian_date">
															<xsl:with-param select="diac:DocumentInfo/diac:BaseDocument/diac:DecisInconGR/cat_ru:PrDocumentDate" name="dateIn"/>
														</xsl:call-template>
													</span>
												</xsl:when>
												<xsl:when test="diac:DocumentInfo/diac:BaseDocument/diac:Indocrn/cat_ru:PrDocumentDate">
											...
											<xsl:text> N </xsl:text>
											<xsl:choose>
												<xsl:when test="diac:DocumentInfo/diac:BaseDocument/diac:DecisInconGR/cat_ru:PrDocumentNumber">
													<span class="value_line">
														<xsl:text>&#160;</xsl:text>
														<xsl:value-of select="diac:DocumentInfo/diac:BaseDocument/diac:DecisInconGR/cat_ru:PrDocumentNumber"/>
														<xsl:text>&#160;</xsl:text>
													</span>
												</xsl:when>
												<xsl:when test="diac:DocumentInfo/diac:BaseDocument/diac:Indocrn/cat_ru:PrDocumentNumber">
	...
	<xsl:template mode="organization2" match="*">
		...
		<xsl:if test="diac:RFOrganizationFeatures or diac:RKOrganizationFeatures or diac:RBOrganizationFeatures or diac:RAOrganizationFeatures or diac:KGOrganizationFeatures and (diac:OrganizationName or diac:ShortName)">&#032;<xsl:apply-templates select="diac:RFOrganizationFeatures" mode="RFOrganizationFeatures"/>
			<xsl:apply-templates select="diac:RKOrganizationFeatures"/>
			<xsl:apply-templates select="diac:RBOrganizationFeatures"/>
			<xsl:apply-templates select="diac:RAOrganizationFeatures"/>
			<xsl:apply-templates select="diac:KGOrganizationFeatures"/>
		</xsl:if>
		<xsl:if test="diac:OKPOID">,&#032;ОКПО:&#032;<xsl:value-of select="diac:OKPOID"/>
		</xsl:if>
		<xsl:if test="diac:ITN">,&#032;ИТН:&#032;<xsl:value-of select="diac:ITN"/>
		</xsl:if>
		<xsl:if test="diac:Address">,&#032;Адрес:&#032;<xsl:for-each select="diac:Address">
				<xsl:for-each select="*">
					<xsl:value-of select="."/>
		...
		<xsl:if test="diac:Contact">,&#032;<xsl:for-each select="diac:Contact">
		...
		<table class="graphMain" width="100%">
			<tbody>
				<tr valign="bottom">
					...
					<td width="55%" class="value_line" align="center">
				...
				<tr align="center" valign="top">
					<td/>
					<td class="graphLittle">(фамилия, инициалы должностного лица таможенного органа)</td>
					<td/>
				</tr>
			</tbody>
		</table>
	...
	<xsl:template match="*" mode="personBase">
		...
		<xsl:text> </xsl:text>
		<xsl:value-of select="diac:PersonName"/>
		<xsl:text> </xsl:text>
		<xsl:value-of select="diac:PersonMiddleName"/>
		<xsl:text> </xsl:text>
	</xsl:template>
</xsl:stylesheet>
