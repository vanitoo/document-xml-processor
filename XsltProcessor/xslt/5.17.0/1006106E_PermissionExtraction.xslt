...
<xsl:stylesheet exclude-result-prefixes="cat_ru pex" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:pex="urn:customs.ru:Information:CustomsDocuments:PermissionExtraction:5.16.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0">
