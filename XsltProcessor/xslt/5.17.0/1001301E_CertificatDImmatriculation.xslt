					...
					<table height="352" width="678">
						...
						<tr>
							...
							Идентификационный номер (VIN) <span class="value">
									<xsl:if test="cdi:CDITransportMeans/cat_ru:VINID">
										<xsl:apply-templates select="cdi:CDITransportMeans/cat_ru:VINID"/>
									</xsl:if>
								</span>
							</td>
						...
						<tr>
							...
							Марка, модель <span class="value">
									<xsl:apply-templates select="cdi:CDITransportMeans/cat_ru:Mark"/>
									<xsl:text> </xsl:text>
									<xsl:apply-templates select="cdi:CDITransportMeans/cat_ru:Model"/>
								</span>
							</td>
						...
						<tr>
							...
							Год выпуска ТС <span class="value">
									<xsl:apply-templates select="cdi:CDITransportMeans/cat_ru:OfftakeYear"/>
								</span>
							</td>
						...
						<tr>
							...
							Двигатель N <span class="value">
									<xsl:apply-templates select="cdi:CDITransportMeans/cat_ru:EngineID"/>
						...
						<tr>
							...
							Шасси (рама) N <span class="value">
									<xsl:apply-templates select="cdi:CDITransportMeans/cat_ru:ChassisID"/>
								</span>
							</td>
							<td class="border-right" height="17" width="331">
							Нас. пункт <span class="value">
									<xsl:apply-templates select="cdi:CDIAutomobileowner/cdi:PostalAdress/cat_ru:City"/>
								</span>
							</td>
						</tr>
						<tr>
							...
							Кузов (коляска) N <span class="value">
									<xsl:apply-templates select="cdi:CDITransportMeans/cat_ru:BodyID"/>
								</span>
							</td>
						...
						<tr>
							...
							ID аварийного устройства <span class="value">
									<xsl:apply-templates select="cdi:CDITransportMeans/cat_ru:EmergencyDeviceID"/>
								</span>
							</td>
						</tr>
						<tr>
