					...
					<xsl:when test="gc:GuaranteeContractKind='1'">
						<div class="page">
							...
							<div style="text-align: justify">
								...
								<br/>
								<br/>
								<xsl:text>1.2. Размер финансовых обязательств Поручителя по настоящему Договору уменьшается на суммы платежей, осуществленных Поручителем, суммы денежных средств, взысканных по банковской гарантии</xsl:text>
								<sup>1</sup>
							...
							<div style="text-align: justify">
								...
								<xsl:choose>
									...
									<xsl:when test="gc:CollOrderReason='2'">в случае невозможности взыскания таких сумм по банковской гарантии, представленной в соответствии с пунктом 2.1.7 настоящего Договора.</xsl:when>
									<xsl:otherwise>
										<u>
											<xsl:value-of select="gc:CollOrderReason"/>
										</u>
									</xsl:otherwise>
								</xsl:choose>
								<br/>
							...
							<div style="text-align: justify">
								...
								<br/>
								<xsl:text>4.1. Настоящий Договор вступает в силу с даты предоставления Кредитору в соответствии с пунктом 2.1.7 настоящего Договора банковской гарантии, но не ранее даты </xsl:text>
								<sup>8</sup>
							...
							<div style="text-align: justify">
								...
								<br/>
								<xsl:text>5.2. Действия, предусмотренные пунктами 2.4.1, 2.4.2, 2.4.4 </xsl:text>
								<sup>9</sup>
					...
					<xsl:when test="gc:GuaranteeContractKind='2'">
						<div class="page">
							...
							<div style="text-align: justify">
								...
								<xsl:text> включительно.</xsl:text>
								<br/>
								<xsl:text>4.2. Настоящий Договор может быть расторгнут досрочно по соглашению Сторон при отсутствии у Должника неисполненной в установленный срок обязанности по уплате таможенных пошлин, налогов, таможенных сборов, специальных, антидемпинговых, компенсационных пошлин, пеней, процентов в случаях, указанных в пункте 13 статьи 399 Кодекса (Федеральный закон от 14 ноября 2017 г. N 317-ФЗ "О ратификации Договора о Таможенном кодексе Евразийского экономического союза" (Собрание законодательства Российской Федерации, 2017, N 47, ст. 6843), и (или) пункте 23 статьи 436 Кодекса (Федеральный закон от 14 ноября 2017 г. N 317-ФЗ "О ратификации Договора о Таможенном кодексе Евразийского экономического союза" (Собрание законодательства Российской Федерации, 2017, N 47, ст. 6843), и при соблюдении условий, установленных пунктом 25 статьи 436 Кодекса и (или) частью 7 статьи 57 Федерального закона (Собрание законодательства Российской Федерации, 2018, N 32, ст. 5082) (в зависимости от обязанностей, указанных в пункте 1.1 настоящего Договора).</xsl:text>
							</div>
							<!-- Прочие условия -->
							<div style="text-align: justify">
								<p align="center" class="head">V. Прочие условия</p>
						...
						<div class="page">
							...
							<div style="text-align: justify">
								...
								<xsl:choose>
									...
									<xsl:when test="gc:ReasonForTerminatingContract='2'">Поручителем в общей сложности в течение более 3 (трех) месяцев не обеспечено надлежащее исполнение своих обязательств перед таможенными органами Российской Федерации в размере не менее принимаемых Поручителем на себя обязательств по настоящему Договору.</xsl:when>
									<xsl:otherwise>
										<u>
											<xsl:value-of select="gc:ReasonForTerminatingContract"/>
										</u>
									</xsl:otherwise>
								</xsl:choose>
								<br/>
							...
							<div style="text-align: justify">
								...
								<br/>
								<xsl:text>5.4. Действия, предусмотренные пунктами 2.4.1, 2.4.2, 2.4.5 </xsl:text>
								<sup>11</sup>
								<xsl:text> настоящего Договора, в соответствии с частью 2 статьи 76 Федерального закона вправе совершать таможенный орган Российской Федерации, осуществляющий взыскание таможенных платежей, специальных, антидемпинговых, компенсационных пошлин, процентов и пеней.</xsl:text>
								<br/>
					...
					<xsl:when test="gc:GuaranteeContractKind='4'">
						<div class="page">
							...
							<div style="text-align: justify">
								...
								<br/>
								<xsl:text>5.3. Действия, предусмотренные пунктами 2.4.1, 2.4.2, 2.4.5 </xsl:text>
								<sup>11</sup>
								<xsl:text> настоящего Договора, в соответствии с частью 2 статьи 76 Федерального закона вправе совершать таможенный орган Российской Федерации, осуществляющий взыскание таможенных платежей, специальных, антидемпинговых, компенсационных пошлин, процентов и пеней.</xsl:text>
								<br/>
