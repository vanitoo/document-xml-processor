...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.20.0" xmlns:tpo_rcp="urn:customs.ru:Information:ExchangeDocuments:TPOReceipt:5.20.0">
						...
						<tr>
							...
							<td class="graphMain center" style="width: 55mm" align="right">
								<xsl:if test="tpo_rcp:BarCode[1] and string-length(tpo_rcp:BarCode[1]) != 0">
									<img style="width: 50mm; height: 50mm;" src="{tpo_rcp:BarCode[1]}"/>
								</xsl:if>
							</td>
							<td class="graphMain" style="width: 5mm"></td>
							<td class="graphMain center" style="width: 55mm" align="right">
								<xsl:if test="tpo_rcp:BarCode[2] and string-length(tpo_rcp:BarCode[2]) != 0">
									<img style="width: 50mm; height: 50mm;" src="{tpo_rcp:BarCode[2]}"/>
								</xsl:if>
							</td>
						</tr>
					</table>
