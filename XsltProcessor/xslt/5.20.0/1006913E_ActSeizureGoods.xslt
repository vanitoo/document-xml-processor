...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.20.0" xmlns:adt_cat="urn:customs.ru:Information:CustomsAuditDocuments:AuditCommonAggregateTypesCust:5.20.0" xmlns:asg="urn:customs.ru:Information:CustomsAuditDocuments:ActSeizureGoods:5.20.0">
										...
										<xsl:when test="asg:SeizureKind=1">
											...
											<xsl:call-template name="inlinetable">
												...
												<xsl:with-param name="descr">
													<xsl:if test="asg:SeizureKind=2">
														<xsl:text>(должность, фамилия, имя, отчество (отчество указывается при наличии), лица, составившего акт)</xsl:text>
													</xsl:if>
												</xsl:with-param>
	...
	<xsl:template mode="signature2ndCopy" match="*">
		...
		<xsl:value-of select="cat_ru:PersonSurname"/>&#160;<xsl:value-of select="substring(cat_ru:PersonName,1,1)"/>
