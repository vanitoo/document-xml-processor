						...
						<table>
							<tbody>
								...
								<xsl:choose>
									...
									<xsl:when test="rccd:RefusalPayPercentSign = 1 or translate(substring(rccd:RefusalPayPercentSign,1,1), 'F', 'f') = 'f'">
										<tr>
											<td>
