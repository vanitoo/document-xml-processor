	...
	<xsl:template match="rda:ReqDoc4Audit">
		<html>
			...
			<body>
				...
				<xsl:if test="rda:CustomsPerformingAudit or rda:ConnectCaseCustomsControl or rda:BasedArticle or rda:AttachedFile">
					<div class="page">
						<table>
							<tbody align="left" class="graphMain">
								<tr align="center" class="graphHeader">
