								...
								<xsl:if test="catESAD_cu:IdentificationMeansDetails">
									<xsl:for-each select="catESAD_cu:IdentificationMeansDetails">
										...
										<xsl:for-each select="catESAD_cu:IdentificationMeansListDetails">
											<xsl:for-each select="catESAD_cu:IdentificationMeansItemDetails/catESAD_cu:IdentificationMeansDataUnitDetails[position() &lt; 11]">
											...
											<xsl:if test="count(catESAD_cu:IdentificationMeansItemDetails/catESAD_cu:IdentificationMeansDataUnitDetails) &gt; 10">
