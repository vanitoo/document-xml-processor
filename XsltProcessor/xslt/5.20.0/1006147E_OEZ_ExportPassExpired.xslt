...
<xsl:stylesheet exclude-result-prefixes="  cat_ru expex" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:expex="urn:customs.ru:Information:CustomsDocuments:OEZ_ExportPassExpired:5.19.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
