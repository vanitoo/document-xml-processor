                  ...
                  <tbody>
                     ...
                     <tr>
                        <td align="center" class="graph" colspan="3" style="width:90mm;border-bottom:solid 0.8pt #000000;">
                           <xsl:apply-templates select="soa:DocumentInfo/soa:OrganizationName"/>
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                        </td>
                     ...
                     <tr>
                        <td align="center" class="graph" colspan="2" style="width:50mm;border-bottom:solid 0.8pt #000000;">
                           <xsl:apply-templates select="soa:DocumentInfo/soa:CreationDate" mode="russian_date"/>
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                           <xsl:apply-templates select="soa:DocumentInfo/soa:CreationTime"/>
                        </td>
                     ...
                     <tr>
                        ...
                        <td align="center" class="graph" style="width:40mm;border-bottom:solid 0.8pt #000000;">
                           <xsl:apply-templates select="soa:AccountHolder/catComFin_ru:Bank/catComFin_ru:BIC"/>
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                        </td>
                     ...
                     <tr>
                        <td align="center" class="graph" colspan="3" style="width:90mm;border-bottom:solid 0.8pt #000000;">
                           <xsl:apply-templates select="soa:AccountHolder/catComFin_ru:Bank/catComFin_ru:BankName"/>
                        </td>
                     </tr>
                     <tr>
                        <td align="center" class="graphLittle" colspan="3" style="width:90mm;">
                     ...
                     <tr>
                        <td align="center" class="graph" colspan="3" style="width:110mm;border-bottom:solid 0.8pt #000000;">
                           <xsl:apply-templates select="soa:AccountHolder/catComFin_ru:OrganizationName"/>
                        </td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        ...
                        <td align="center" class="graph" style="width:50mm;border-bottom:solid 0.8pt #000000;">
                           <xsl:apply-templates select="soa:TransInfo[1]/soa:TransDate" mode="russian_date"/>
                        </td>
                        ...
                        <td align="center" class="graph" colspan="2" style="width:47mm;border-bottom:solid 0.8pt #000000;">
                           <xsl:apply-templates select="soa:LastMovementDate" mode="russian_date"/>
                        </td>
                     </tr>
                     <tr>
                        <td class="graph" style="width:30mm;">
                     ...
                     <tr>
                        ...
                        <td align="center" class="graph" style="width:35mm;border-bottom:solid 0.8pt #000000;">
                           <xsl:apply-templates select="soa:AccountHolder/catComFin_ru:Bank/catComFin_ru:PersonalAccount"/>
                        </td>
                              ...
                              <tbody>
                                 ...
                                 <xsl:for-each select="soa:TransInfo">
                                    <tr>
                                       ...
                                       <td align="center" class="graph" style="width:10mm;">
                                          <xsl:apply-templates select="soa:AccDocNo"/>
                                       </td>
                                       <td align="center" class="graph" style="width:10mm;">
                                          <xsl:apply-templates select="soa:TransKind"/>
                                       </td>
                                       <td align="center" class="graph" style="width:20mm;">
                                          <xsl:apply-templates select="soa:BICCorr"/>
                                       </td>
                                       <td align="center" class="graph" style="width:30mm;">
                                          <xsl:apply-templates select="soa:CorrAccBrf"/>
                                          <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                       </td>
                                       <td align="center" class="graph" style="width:40mm;">
                                          <xsl:apply-templates select="soa:PayerPersonalAccount"/>
                                          <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                       </td>
                                       <td align="center" class="graph" style="width:40mm;">
                                          <xsl:apply-templates select="soa:PayeePersonalAccount"/>
                                          <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                       </td>
                                       <td align="center" class="graph" style="width:20mm;">
                                          <xsl:apply-templates select="soa:TurnoverKind"/>
                                       </td>
                                       <td align="center" class="graph" style="width:30mm;">
                     ...
                     <tr>
                        ...
                        <td align="center" class="graph" style="width:20mm;">
                           <xsl:apply-templates select="soa:DebetAmount"/>
                        </td>
                        <td align="right" class="graph" style="width:15mm;">
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                        </td>
                        <td align="left" class="graph" style="width:32mm;">
                           <xsl:apply-templates select="soa:CreditAmount"/>
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td class="graph" style="width:32mm;">
                           <xsl:apply-templates select="soa:OutBal"/>
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td align="center" class="graph" colspan="2" style="width:35mm;border-bottom:solid 0.8pt #000000;">
                           <xsl:apply-templates select="soa:AbstractDate" mode="russian_date"/>
                        </td>
