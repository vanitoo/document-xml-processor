						...
						<tbody>
							...
							<tr>
								<td class="graph" style="width:100%">
									Начат: 
									<xsl:value-of select="substring(aib:BeginInspectionTime, 1, 2)"/>
									<xsl:text> час. </xsl:text>
									<xsl:value-of select="substring(aib:BeginInspectionTime, 4, 2)"/>
									<xsl:text> мин. </xsl:text>
									<xsl:apply-templates mode="russian_date" select="aib:BeginInspectionDate"/>
									<br/>
									<br/>
								</td>
							</tr>
...
декларанта, лица, обладающего полномочиями в отношении товаров (транспортных средств), либо их представителей:<br/>
							...
							<tr>
								<td class="graph" style="width:100%">
									...
									, номер рейса - <xsl:value-of select="aib:VoyageNumber"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td class="graph" align="center" style="width:100%">
									Окончен: 
									<xsl:value-of select="substring(aib:EndInspectionTime, 1, 2)"/>
									<xsl:text> час. </xsl:text>
									<xsl:value-of select="substring(aib:EndInspectionTime, 4, 2)"/>
									<xsl:text> мин. </xsl:text>
									<xsl:apply-templates mode="russian_date" select="aib:EndInspectionDate"/>
									<br/>
									<br/>
								</td>
							</tr>
