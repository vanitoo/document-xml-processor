	...
	<xsl:template match="ear:ReportInfo">
		...
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<tr>
				...
				<td class="graphMain bordered">
					<xsl:apply-templates select="ear:ExciseRate" mode="translate_number"/>
				</td>
				<td class="graphMain bordered">
