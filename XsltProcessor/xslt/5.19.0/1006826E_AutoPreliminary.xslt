...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:autop="urn:customs.ru:Information:CustomsDocuments:AutoPreliminary:5.17.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:RUSclt_ru="urn:customs.ru:RUSCommonLeafTypes:5.14.3" xmlns:catpi_ru="urn:customs.ru:Information:PriorInformation:PriorCommonAggregateTypes:5.17.0">
	...
	<xsl:template match="autop:MainConsignmentDetails">
		...
		<tr>
			...
			<td class="bordered">
				...
				<xsl:apply-templates select="autop:LoadingListsQuantity"/>
			</td>
		</tr>
		<tr>
			<td class="bordered">
				Кол-во листов отгр. сп-ций<br/>
				<xsl:apply-templates select="autop:LoadingListsPageQuantity"/>
			</td>
			<td class="bordered">
	...
	<xsl:template match="autop:TransitGuaranteeDetails">
		...
		<tr>
			<td class="bordered">
				...
				<xsl:apply-templates select="catpi_ru:MeasureCode"/>
			</td>
			<td class="bordered">
	...
	<xsl:template match="catpi_ru:PackagePalleteInformation">
		<tr>
				<td class="bordered">
					<xsl:apply-templates select="catpi_ru:InfoKindCode"/>
					<xsl:if test="catpi_ru:InfoKindCode and catpi_ru:PalleteCode">
						<xsl:text> / </xsl:text>
					</xsl:if>
					<xsl:apply-templates select="catpi_ru:PalleteCode"/>
				</td>
				<td class="bordered">
					<xsl:apply-templates select="catpi_ru:PalleteQuantity"/>
				</td>
				<td class="bordered" colspan="2">
	...
	<xsl:template match="catpi_ru:TransportMeansRegistrationId">
		<tr>
			<td class="bordered">
				<xsl:apply-templates select="catpi_ru:TransportIdentifier"/>
			...
			<td class="bordered">
				<xsl:apply-templates select="catpi_ru:TransportMeansNationalityCode"/>
			</td>
			<td class="bordered">
				<xsl:apply-templates select="catpi_ru:VINID"/>
			</td>
			<td class="bordered">
				<xsl:apply-templates select="catpi_ru:TransportModeCode"/>
			</td>
			<td class="bordered">
				<xsl:apply-templates select="catpi_ru:TransportMarkCode"/>
			</td>
			<td class="bordered">
				<xsl:apply-templates select="catpi_ru:DocID"/>
			</td>
		</tr>
	</xsl:template>
			...
			<tr>
				...
				<td class="bordered" colspan="2">
					<xsl:variable name="xpath_EqualIndicator">
						<xsl:call-template name="get_xpath">
							<xsl:with-param name="node" select="catpi_ru:EqualIndicator"/>
						</xsl:call-template>
					</xsl:variable>
