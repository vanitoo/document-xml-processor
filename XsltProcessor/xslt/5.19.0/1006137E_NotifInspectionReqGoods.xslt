...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:ntfin="urn:customs.ru:Information:CustomsDocuments:NotifInspectionReqGoods:5.19.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
							...
							<xsl:if test="ntfin:DocumentKind='0' or ntfin:DocumentKind='7'">
								...
								<tr>
									<td style="text-align: justify" class="bordered">
										<xsl:for-each select="ntfin:DocID/ntfin:DTRegNum/ntfin:DocNumberDT">
											<xsl:apply-templates select="ntfin:GoodsNumber"/>
											<xsl:if test="ntfin:GoodsDesc"> - <xsl:apply-templates select="ntfin:GoodsDesc"/>
											</xsl:if>
										...
										<table width="100%">
											<tbody>
												<tr>
													...
													<td width="40%" align="center" valign="bottom" class="bordered">
