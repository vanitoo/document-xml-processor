               ...
               <table cellpadding="0" cellspacing="0" style="width:100%;border:solid 0.8pt #000000;">
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                           ...
                           <xsl:if test="TMCout:ESADTransportMeanCard/cat_ru:VINID">
                              <xsl:apply-templates select="TMCout:ESADTransportMeanCard/cat_ru:VINID"/>
                           </xsl:if>
                        </td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        ...
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                           <xsl:apply-templates select="TMCout:ESADTransportMeanCard/cat_ru:MarkCode"/>
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                           <xsl:apply-templates select="TMCout:ESADTransportMeanCard/cat_ru:Mark"/>
                        </td>
                     </tr>
                     <tr>
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                        ...
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                           <xsl:apply-templates select="TMCout:ESADTransportMeanCard/cat_ru:Model"/>
                        </td>
                     </tr>
                     <tr>
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                     ...
                     <tr>
                        ...
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                           <xsl:apply-templates select="TMCout:ESADTransportMeanCard/cat_ru:OfftakeYear"/>
                        </td>
                     </tr>
                     <tr>
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                        ...
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                           <xsl:apply-templates select="TMCout:ESADTransportMeanCard/catESAD_ru:EngineModel"/>
                        </td>
                     </tr>
                     <tr>
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                        ...
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                           <xsl:apply-templates select="TMCout:ESADTransportMeanCard/cat_ru:EngineID"/>
                        </td>
                     </tr>
                     <tr>
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                     ...
                     <tr>
                        ...
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                           <xsl:apply-templates select="TMCout:ESADTransportMeanCard/cat_ru:ChassisID"/>
                        </td>
                     </tr>
                     <tr>
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                        ...
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                           <xsl:apply-templates select="TMCout:ESADTransportMeanCard/cat_ru:BodyID"/>
                        </td>
                     </tr>
                     <tr>
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
					...
					<tr>
						...
						<td class="graph" style="width:90mm;border:solid 0.5pt #000000;">
							<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
							<xsl:apply-templates select="TMCout:ESADTransportMeanCard/cat_ru:EngineVolumeQuanity"/>
						</td>
					</tr>
					<tr>
						<td class="graph" style="width:90mm;border:solid 0.5pt #000000;">
                     ...
                     <tr>
                        ...
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                           <xsl:apply-templates select="TMCout:ESADTransportMeanCard/cat_ru:EmergencyDeviceID"/>
                        </td>
                     </tr>
