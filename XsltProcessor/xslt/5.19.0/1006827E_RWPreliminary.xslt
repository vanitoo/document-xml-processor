...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:rwp="urn:customs.ru:Information:CustomsDocuments:RWPreliminary:5.17.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:RUSclt_ru="urn:customs.ru:RUSCommonLeafTypes:5.14.3" xmlns:catpi_ru="urn:customs.ru:Information:PriorInformation:PriorCommonAggregateTypes:5.17.0">
					...
					<table>
						<tbody>
							...
							<xsl:if test="rwp:PICarrierInfo">
								...
								<xsl:apply-templates select="rwp:PICarrierInfo" mode="org"/>
							</xsl:if>
							
							<xsl:apply-templates select="rwp:StoresInfo"/>
							
							<xsl:apply-templates select="rwp:SparePartsInfo"/>
							...
							<xsl:if test="rwp:ControlledItemsDetails">
								...
								<xsl:apply-templates select="rwp:ControlledItemsDetails" mode="org"/>
							</xsl:if>
	...
	<xsl:template match="rwp:ConsignmentDetails">
		...
		<tr>
			<td class="bordered">
				...
				<xsl:value-of select="rwp:LoadingListsQuantity"/>
			</td>
			<td class="bordered">
				Кол-во листов отгр.спецификаций<br/>
				<xsl:value-of select="rwp:LoadingListsPageQuantity"/>
			</td>
			<td class="bordered">
		...
		<tr>
			<td class="bordered">
				...
				<xsl:apply-templates select="rwp:DispatchCountry" mode="spaced"/>
			</td>
			<td class="bordered">
				Страна назначения<br/>
				<xsl:apply-templates select="rwp:DestinationCountry" mode="spaced"/>
			</td>
			<td class="bordered">
				Общая стоимость товаров<br/>
				<xsl:apply-templates select="rwp:CAInvoiceValueAmount" mode="spaced"/>
			</td>
			<td class="bordered">
		...
		<tr>
			<td class="bordered" colspan="2">
				Станция отправления: 
				<xsl:apply-templates select="rwp:LoadingLocationDetails" mode="comma"/>
			</td>
			<td class="bordered" colspan="2">
				Станция назначения: 
				<xsl:apply-templates select="rwp:UnLoadingLocationDetails" mode="comma"/>
			</td>
		</tr>
		<tr>
			<td class="bordered" colspan="4">
				ТО назначения: 
				<xsl:apply-templates select="rwp:DestinationCustomsOfficeDetails" mode="comma"/>
			</td>
		</tr>
		<tr>
			<td class="bordered" colspan="4">
		...
		<xsl:if test="rwp:UnionCarrierDetails">
			...
			<xsl:apply-templates select="rwp:UnionCarrierDetails" mode="org"/>
		</xsl:if>
	...
	<xsl:template match="rwp:SealDetails">
		<tr>
			<td class="bordered">
				Количество:<br/>
	...
	<xsl:template match="rwp:TransportMeansDetails">
		<tr>
			...
			<td class="bordered">
				<xsl:value-of select="rwp:CountryCode"/>
			</td>
			<td class="bordered">
