								...
								операций с товарами, помещенными под  таможенную  процедуру  таможенного  склада  по  декларации на товары N
									<table style="display:inline-block; width:60mm;">
										<tbody>
											...
											<tr>
												<td class="graphLittle" align="center">(указывается номер декларации на товары)</td>
											</tr>
										</tbody>
									</table>
								</td>
					...
					<table>
						<tbody width="100%" align="center" class="graphMain">
							<tr valign="top">
								...
								<td class="bordered" width="25%">Код товара в соответствии с ТН ВЭД ЕАЭС<sup>5</sup></td>
								<td class="bordered" width="25%">Совершаемые операции<sup>6</sup></td>
							</tr>
