							...
							<xsl:for-each select="mrec:PayTNVED">
								<tr valign="top">
									<td class="graphMain bordered">
										...
										<xsl:if test="mpco:GoodDescription and mpco:GoodDescriptionForeign">
											<xsl:text> / </xsl:text>
										</xsl:if>
					...
					<xsl:for-each select="mrec:PayTNVED">
						<table class="w190">
							<tr>
								...
								<td class="value graphMain" style="width:50%">
									<b>
										<xsl:value-of select="mpco:ListNumeric"/>
									</b>
								</td>
							</tr>
						</table>
