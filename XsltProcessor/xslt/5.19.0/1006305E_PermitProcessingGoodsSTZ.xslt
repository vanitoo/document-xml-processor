...
<xsl:stylesheet version="1.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.17.0" xmlns:ppg_stz="urn:customs.ru:Information:CustomsDocuments:PermitProcessingGoodsSTZ:5.19.0" xmlns:catProc_ru="urn:customs.ru:Information:ProcessingDocuments:ProcessingCommonAggregateTypes:5.18.0">
	...
	<xsl:template match="ppg_stz:PermitProcessingGoodsSTZ">
		<html>
			<head>
				<style>
                  body {
							...
							<tr>
								<td>
									<table class="graphMain" width="100%">
										<tbody>
											<tr>
												<td align="left" width="45%" valign="bottom">№ <xsl:apply-templates select="ppg_stz:PermissionRegNumber" mode="doc_num"/>
												</td>
												<td align="center" width="55%" class="value">
													<xsl:for-each select="ppg_stz:Resident">
...
пункта 4 статьи 205 Таможенного кодекса Евразийского экономического союза </xsl:text>
							...
							<tr>
								<td>
									<table>
										<tbody>
											<tr>
												<td width="38%">Настоящее разрешение выдано</td>
												<td width="62%" class="value">
													<xsl:apply-templates mode="organization" select="ppg_stz:Resident"/>
												</td>
											</tr>
											<tr>
												<td/>
							...
							<tr>
								<td style="text-align: justify">
									<xsl:text>и свидетельствует о возможности вывоза с территории Арктической зоны Российской Федерации, на которой применяется таможенная процедура свободной таможенной зоны, на остальную часть таможенной территории Евразийского экономического союза без завершения действия таможенной процедуры свободной таможенной зоны товаров по заявлению №</xsl:text>
									<xsl:apply-templates mode="doc_num" select="ppg_stz:AppInfo/ppg_stz:AppRegNumber"/>(далее - вывозимые товары) на основании части 2 статьи 20 Федерального закона от 13 июля 2020 г. N 193-ФЗ "О государственной поддержке предпринимательской деятельности в Арктической зоне Российской Федерации" для целей совершения в отношении товаров операций, предусмотренных подпунктом 5 пункта 4 статьи 205 Таможенного кодекса Евразийского экономического союза (далее - операции по переработке).</td>
							</tr>
							<tr>
								<td class="delim_3">
									<br/>
							...
							<tr>
								<td class="value">
									<xsl:for-each select="ppg_stz:ProcessingPerson">
							...
							<tr>
								<td style="text-align: justify">
									<xsl:text>2. Документы, подтверждающие передачу товаров лицу (лицам), которое(ые) будет(ут) непосредственно совершать операции по переработке</xsl:text>
								</td>
							</tr>
							<tr>
								<td class="delim_3"/>
							...
							<tr>
								<td class="value">
									<xsl:for-each select="ppg_stz:ConfirmTransferDoc">
							...
							<tr>
								<td style="text-align: justify">
									<xsl:text>3. Адрес места нахождения производственных мощностей, с использованием которых будут совершаться операции по переработке</xsl:text>
								</td>
							</tr>
							<tr>
								<td class="delim_3"/>
							...
							<tr>
								<td class="value">
									<xsl:for-each select="ppg_stz:ProcessingAddress">
							...
							<tr>
								<td style="text-align: justify">
									<xsl:text>4. Срок ввоза товаров, изготовленных (полученных) из вывезенных товаров, при совершении операций по переработке (далее - получаемые товары), или вывезенных товаров (если операции по переработке не совершались по объективным причинам) на территорию Арктической зоны Российской Федерации, на которой применяется таможенная процедура свободной таможенной зоны</xsl:text>
								</td>
							</tr>
							<tr>
								<td class="delim_3"/>
							...
							<tr>
								<td class="value">
									<xsl:apply-templates mode="russian_date" select="ppg_stz:EntryGoodsTerm"/>
								</td>
							</tr>
							<tr>
								<td class="delim_3">
							...
							<tr>
								<td style="text-align: justify">
									<xsl:text>5. Продление срока ввоза получаемых товаров на территорию Арктической зоны Российской Федерации, на которой применяется таможенная процедура свободной таможенной зоны (в случае продления срока)</xsl:text>
								</td>
							</tr>
							<tr>
								<td class="delim_3"/>
							...
							<tr>
								<td class="value">
									<xsl:apply-templates mode="russian_date" select="ppg_stz:ProlongTerm"/>
									<xsl:if test="ppg_stz:DecisionProlongTerm">
										<xsl:text> Решение о продлении срока переработки товаров № </xsl:text>
										<xsl:apply-templates select="ppg_stz:DecisionProlongTerm" mode="doc_num"/>
									</xsl:if>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td style="text-align: justify">
									<xsl:text>6. Операции по переработке, которые являются составной частью производственного процесса и которые будут совершаться за пределами территории Арктической зоны Российской Федерации, на которой применяется таможенная процедура свободной таможенной зоны</xsl:text>
								</td>
							</tr>
							<tr>
								<td class="delim_3"/>
							...
							<tr>
								<td class="value">
									<xsl:for-each select="ppg_stz:ProcessingOperations">
										<xsl:for-each select="ppg_stz:Operation">
											<xsl:apply-templates select="."/>
										</xsl:for-each>
										<xsl:text> </xsl:text>
										<xsl:for-each select="ppg_stz:TechnologicalProcess">
											<xsl:apply-templates select="."/>
										</xsl:for-each>
										<br/>
									</xsl:for-each>
							...
							<tr>
								<td style="text-align: justify">
									<xsl:text>7. Способ идентификации вывозимых товаров в получаемых товарах при их последующем ввозе на территорию Арктической зоны Российской Федерации, на которой применяется таможенная процедура свободной таможенной зоны</xsl:text>
								</td>
							</tr>
							<tr>
								<td class="delim_3"/>
							...
							<tr>
								<td class="value">
									<xsl:for-each select="ppg_stz:MethodIdentify">
										<xsl:apply-templates select="."/>
									</xsl:for-each>
								</td>
							</tr>
							...
							<tr>
								<td style="text-align: justify">
									<xsl:text>8. Нормы расхода вывозимых товаров на единицу получаемых товаров (нормы расхода) или нормы выхода получаемых товаров (нормы выхода) с учетом использования товаров Евразийского экономического союза, не помещенных под таможенную процедуру свободной таможенной зоны</xsl:text>
								</td>
							</tr>
							<tr>
								<td class="delim_3"/>
							...
							<tr>
								<td class="value">
									<xsl:for-each select="ppg_stz:YieldNorm">
										<xsl:apply-templates select="."/>
									</xsl:for-each>
								</td>
							</tr>
							...
							<tr>
								<td style="text-align: justify">
									<xsl:text>9. Товары, помещенные под таможенную процедуру свободной таможенной зоны, и (или) товары, изготовленные (полученные) из товаров, помещенных под таможенную процедуру свободной таможенной зоны, которые вывозятся для совершения операций по переработке.</xsl:text>
								</td>
							</tr>
							<tr>
								<td class="delim_3"/>
								...
								<td>
									<table class="graphMain" width="100%">
										<tbody>
											...
											<xsl:for-each select="ppg_stz:GoodsInfo/ppg_stz:PlacedGoods">
												<xsl:variable name="countGoods" select="count(ppg_stz:GoodsDeclaration/ppg_stz:GoodsDeclnfo)"/>
												<tr valign="top">
													<td class="bordered" rowspan="{$countGoods}">
														<xsl:apply-templates select="ppg_stz:Position"/>
													</td>
													<td class="bordered " rowspan="{$countGoods}">
														<xsl:apply-templates select="ppg_stz:GoodsDescription"/>
													</td>
													<td class="bordered" rowspan="{$countGoods}">
														<xsl:apply-templates select="ppg_stz:GoodsTNVEDCode"/>
													</td>
													<td class="bordered" rowspan="{$countGoods}">
														<xsl:apply-templates mode="goods_group" select="ppg_stz:GoodsGroupInformation"/>
													</td>
													<xsl:variable name="goodsPerDT" select="count(ppg_stz:GoodsDeclaration[1]/ppg_stz:GoodsDeclnfo)"/>
													<td class="bordered" rowspan="{$goodsPerDT}">
														<xsl:apply-templates mode="decl" select="ppg_stz:GoodsDeclaration[1]"/>
													</td>
													<td class="bordered">
														<xsl:apply-templates select="ppg_stz:GoodsDeclaration[1]/ppg_stz:GoodsDeclnfo[1]/ppg_stz:GoodsNumber"/>
													</td>
													<td class="bordered" rowspan="{$countGoods}">
														<xsl:for-each select="ppg_stz:GoodsQuantity">
												...
												<xsl:for-each select="ppg_stz:GoodsDeclaration[1]/ppg_stz:GoodsDeclnfo[position() &gt; 1]">
													<tr valign="top">
														<td class="bordered">
															<xsl:apply-templates select="ppg_stz:GoodsNumber"/>
														</td>
													</tr>
												</xsl:for-each>
												<xsl:for-each select="ppg_stz:GoodsDeclaration[position() &gt; 1]">
													<xsl:variable name="goodsPerDT2" select="count(ppg_stz:GoodsDeclnfo)"/>
													<tr valign="top">
														<td class="bordered" rowspan="{$goodsPerDT2}">
															<xsl:apply-templates mode="decl" select="."/>
														</td>
														<td class="bordered">
															<xsl:apply-templates select="ppg_stz:GoodsDeclnfo[1]/ppg_stz:GoodsNumber"/>
														</td>
													</tr>
													<xsl:for-each select="ppg_stz:GoodsDeclnfo[position() &gt; 1]">
														<tr valign="top">
															<td class="bordered">
																<xsl:apply-templates select="ppg_stz:GoodsNumber"/>
															</td>
									...
									<table class="graphMain" width="100%">
										<tbody>
											...
											<tr>
												...
												<td class="bordered" align="center" rowspan="2">Реквизиты документа бухгалтерского учета, согласно которому товары учтены резидентом Арктической зоны </td>
												<td class="bordered" align="center" rowspan="2">Количество товара </td>
												<td class="bordered" align="center" rowspan="2">Единица измерения количества </td>
											</tr>
											<tr>
											...
											<xsl:for-each select="ppg_stz:GoodsInfo/ppg_stz:ManufacturedGoods">
												<tr valign="top">
													<td class="bordered">
														<xsl:apply-templates select="ppg_stz:Position"/>
													</td>
													...
													<td class="bordered">
														<xsl:for-each select="ppg_stz:AccountDoc">
							...
							<tr>
								<td style="text-align: justify">
									<xsl:text>10. Получаемые товары, которые будут ввозиться на территорию Арктической зоны Российской Федерации, на которой применяется таможенная процедура свободной таможенной зоны</xsl:text>
								</td>
							</tr>
							<tr>
								<td class="delim_3"/>
								...
								<td>
									<table class="graphMain" width="100%">
										<tbody>
											...
											<xsl:for-each select="ppg_stz:GoodsResult">
												<tr valign="top">
													<td class="bordered">
														<xsl:apply-templates select="ppg_stz:Position"/>
													</td>
								...
								<td>
									<table class="graphMain" width="100%">
										<tbody>
											...
											<xsl:for-each select="ppg_stz:Heels">
												<xsl:variable name="countGoods" select="count(ppg_stz:GoodsDeclaration/ppg_stz:GoodsDeclnfo)"/>
												<tr valign="top">
													<td class="bordered" rowspan="{$countGoods}">
														<xsl:apply-templates select="ppg_stz:Position"/>
										...
										<tbody>
											<tr valign="bottom">
												<td class="value" width="25%">
													<xsl:for-each select="ppg_stz:CustomsSignature">
	...
	<xsl:template match="*" mode="doc_num">
		<u>
			<xsl:apply-templates select="ppg_stz:CustomsCode"/>
		</u>
		<xsl:text>/</xsl:text>
		<u>
			<xsl:apply-templates select="ppg_stz:RegistrationDate" mode="gtd_date"/>
		</u>
		<xsl:text>/</xsl:text>
		<u>
			<xsl:apply-templates select="ppg_stz:Number"/>
		</u>
		<xsl:text>/</xsl:text>
		<xsl:apply-templates select="ppg_stz:AddNumber"/>
	</xsl:template>
	...
	<xsl:template mode="organization" match="*">
		...
		<xsl:if test="ppg_stz:ResidentCertificate">
			<xsl:text> свидетельство  </xsl:text>
			<xsl:for-each select="ppg_stz:ResidentCertificate">
