					...
					<table>
							<tbody>
								...
								<tr align="center" valign="top">
									...
									<td class="bordered annot">Сведения о постановке оборудования на баланс (принятие оборудования к бухгалтерскому учету в качестве основных средств) Заявителя</td>
									<td class="bordered annot">Сведения о вводе оборудования в эксплуатацию</td>
								...
								<xsl:for-each select="ac_stz:GoodsInfo/ac_stz:Equipment">
									...
									<xsl:for-each select="ac_stz:EquipmentGoods[position() &gt; 1]">
										<tr>
											<xsl:variable name="goodsCountIn" select="count(descendant::ac_stz:GoodsDeclnfo)"/>
											<td class="bordered annot" rowspan="{$goodsCountIn}">
