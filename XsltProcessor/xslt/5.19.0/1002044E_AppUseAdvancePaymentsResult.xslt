...
<xsl:stylesheet exclude-result-prefixes="cat_ru auapr" version="1.0" xmlns:auapr="urn:customs.ru:Information:CommercialFinanceDocuments:AppUseAdvancePaymentsResult:5.19.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
