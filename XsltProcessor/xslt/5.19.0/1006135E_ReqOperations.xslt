...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:reqop="urn:customs.ru:Information:CustomsDocuments:ReqOperations:5.18.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
					...
					<table>
						<tbody>
											...
											<tbody>
												<tr>
													<td class="bordered" style="width:100mm">
														...
														<xsl:if test="reqop:CustomsPerson/cat_ru:LNP"> (ЛНП: <xsl:value-of select="reqop:CustomsPerson/cat_ru:LNP"/>)</xsl:if>
													</td>
													<td style="width:10mm"/>
												...
												<tr>
													...
													<td/>
													<td class="graphLittle">(дата и время направления уведомления)</td>
													<td/>
							...
							<xsl:if test="reqop:DocSign='0'">
								...
								<tr>
									<td align="left">При направлении уведомления по почте или иным способом</td>
								</tr>
								<tr>
									<td>
										<table align="left" style="width:210mm">
											<tbody>
												...
												<tr>
													<td class="uplined" style="width:100mm">(сведения о месте, куда направлено уведомление, и способе его направления)</td>
													<td style="width:10mm">
														<xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;&amp;nbsp;</xsl:text>
													</td>
													<td class="uplined" style="width:20mm">(дата направления уведомления)</td>
													<td style="width:10mm">
														<xsl:text disable-output-escaping="yes">&amp;nbsp;&amp;nbsp;&amp;nbsp;</xsl:text>
													</td>
													<td class="uplined" style="width:40mm">(инициалы, фамилия и подпись должностного лица таможенного органа, направившего уведомление)</td>
												</tr>
											</tbody>
										</table>
									</td>
