...
-->
	...
	<xsl:template match="RUDECLcat:BrokerRegistryDocDetails">
		...
		<br/>
		<span class="normal">2. <xsl:apply-templates select="RUDECLcat:RegisterDocumentDetails/RUScat_ru:RegistrationNumberId"/>
		</span>
