...
<xsl:stylesheet version="1.0" xmlns:DTSout="urn:customs.ru:Information:CustomsDocuments:DTSout:5.17.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.17.0" xmlns:cat_EDTS_cu="urn:customs.ru:CUESADDTSCommonAggregateTypes:5.17.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:RUDECLcat="urn:customs.ru:RUDeclCommonAggregateTypesCust:5.17.0" xmlns:cat_EDTS_ru="urn:customs.ru:RUESADDTSCommonAggregateTypes:5.17.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
										...
										<table cellpadding="0" cellspacing="0" style="width:100%;border:solid 0.8pt #000000;">
											<tbody>
												...
												<tr>
													...
													<td align="center" class="graph" style="width:70mm;border:solid 0.8pt #000000;" valign="middle">
														<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
														<xsl:apply-templates select="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS4Method236/cat_EDTS_ru:Method2Basis/cat_EDTS_cu:IdenticalDealNationalAmount"/>
													</td>
												</tr>
												<tr>
													<td class="graph" style="width:90mm;border:solid 0.8pt #000000;" valign="top">
													...
													<td align="center" class="graph" style="width:70mm;border:solid 0.8pt #000000;" valign="middle">
														<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
														<xsl:apply-templates select="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS4Method56/cat_EDTS_ru:TotalBasisSum"/>
													</td>
												</tr>
												<tr>
													<td class="graph" style="width:90mm;border:solid 0.8pt #000000;" valign="top">
													...
													<td align="center" class="graph" style="width:70mm;border:solid 0.8pt #000000;" valign="middle">
														<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
														<xsl:if test="cat_EDTS_ru:SheetGoodsSerialNumber">
															<xsl:apply-templates select="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS4Method56/cat_EDTS_ru:ProductionStoreExpense"/>
														</xsl:if>
													</td>
												</tr>
												<tr>
													...
													<td align="center" class="graph" style="width:70mm;border:solid 0.8pt #000000;" valign="middle">
														<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
														<xsl:if test="cat_EDTS_ru:SheetGoodsSerialNumber">
															<xsl:apply-templates select="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS4Method56/cat_EDTS_ru:CommerceExpense"/>
														</xsl:if>
													</td>
												</tr>
												<tr>
													...
													<td align="center" class="graph" style="width:70mm;border:solid 0.8pt #000000;" valign="middle">
														<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
														<xsl:apply-templates select="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS4Method236/cat_EDTS_ru:Method2DealCorrect/cat_EDTS_ru:QuantityCorrect"/>
													</td>
												</tr>
												<tr>
													<td class="graph" style="width:90mm;border:solid 0.8pt #000000;" valign="top">
													...
													<td align="center" class="graph" style="width:70mm;border:solid 0.8pt #000000;" valign="middle">
														<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
														<xsl:apply-templates select="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS4Method236/cat_EDTS_ru:Method2DealCorrect/cat_EDTS_ru:CommerceCorrect"/>
													</td>
												</tr>
												<tr>
													<td class="graph" style="width:90mm;border:solid 0.8pt #000000;" valign="top">
													...
													<td align="center" class="graph" style="width:70mm;border:solid 0.8pt #000000;" valign="middle">
														<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
														<xsl:apply-templates select="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS4Method236/cat_EDTS_ru:Method2DealCorrect/cat_EDTS_ru:TotalSum"/>
													</td>
												</tr>
												<tr>
													<td class="graph" style="width:90mm;border:solid 0.8pt #000000;" valign="top">
													...
													<td align="center" class="graph" style="width:70mm;border:solid 0.8pt #000000;" valign="middle">
														<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
														<xsl:apply-templates select="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS4Method236/cat_EDTS_ru:Method2DealCorrect/cat_EDTS_ru:TotalDealCorrect"/>
													</td>
												</tr>
												<tr>
