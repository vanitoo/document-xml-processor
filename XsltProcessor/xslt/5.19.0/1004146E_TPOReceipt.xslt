...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:tpo_rcp="urn:customs.ru:Information:ExchangeDocuments:TPOReceipt:5.19.0">
				...
				<div class="page">
					...
					<table class="w190 border mb">
						...
						<xsl:for-each select="tpo_rcp:Payments">
							...
							<tr>
								...
								<td class="graphMain right">
									<xsl:value-of select="translate(translate(format-number(tpo_rcp:Amount, '#,###.00'), ',', ' '), '.', ',')"/>
								</td>
								<td class="graphMain center">
						...
						<tr>
							...
							<td class="graphMain"/>
							<td class="graphMain right">
								<xsl:value-of select="translate(translate(format-number(tpo_rcp:TotalAmount, '#,###.00'), ',', ' '), '.', ',')"/>
							</td>
							<td class="graphMain center">
								<xsl:value-of select="tpo_rcp:CurrencyName"/>
							</td>
