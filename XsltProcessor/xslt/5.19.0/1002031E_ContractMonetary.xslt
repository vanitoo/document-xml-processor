					...
					<td align="right">
						...
						<table style="display:inline-table; border-collapse: collapse;">
							<tbody>
								<tr align="center">
									<td style="border:1px solid black;width:4mm;">
										<xsl:apply-templates select="cmo:ResidentInfo/RUScat_ru:RFOrganizationFeatures/cat_ru:OGRN"/>
									</td>
								</tr>
							</tbody>
						</table>
					...
					<td align="right">
						...
						<table style="display:inline-table; border-collapse: collapse;">
							<tbody>
								<tr align="center">
									<td style="border:1px solid black;width:4mm;">
										<xsl:apply-templates select="cmo:ResidentInfo/cmo:ORGNDate" mode="date"/>
									</td>
								</tr>
							</tbody>
						</table>
					...
					<td align="right">
						<table style="display:inline-table; border-collapse: collapse;">
							<tbody>
								<tr align="center">
									<td style="border:1px solid black;width:4mm;">
										<xsl:apply-templates select="cmo:ResidentInfo/RUScat_ru:RFOrganizationFeatures/cat_ru:INN"/>
									</td>
									<td style="border:1px solid black;width:4mm;">/</td>
									<td style="border:1px solid black;width:4mm;">
										<xsl:apply-templates select="cmo:ResidentInfo/RUScat_ru:RFOrganizationFeatures/cat_ru:KPP"/>
									</td>
								</tr>
							</tbody>
						</table>
