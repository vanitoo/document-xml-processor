...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:nad="urn:customs.ru:Information:CommercialFinanceDocuments:NotifAdvDep:5.14.5" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.3">
											...
											<table width="100%">
												<tbody>
													...
													<tr>
														...
														<td class="bordered" align="right">
															<div class="cellwidener">
																<xsl:value-of select="translate(translate(format-number(nad:DocumentInfo/nad:ReceiptCustDocumentInfo/nad:TotalSPaymentAmount, '#,###.00'),',',' '),'.',',')"/>
															</div>
														</td>
													</tr>
												</tbody>
										...
										<tbody>
											...
											<xsl:for-each select="nad:DocumentInfo/nad:CorrDeclDocumentInfo/nad:CorrDeclDocument">
												<tr>
													...
													<td class="bordered" align="center">
														<xsl:value-of select="nad:PrDocumentNumber"/>
													</td>
													<td class="bordered" align="center">
														<xsl:apply-templates select="nad:PrDocumentDate" mode="russian_date"/>
													</td>
													<td class="bordered" align="center">
														<xsl:value-of select="nad:Paytype"/>
													</td>
													<td class="bordered" align="right">
	...
	<xsl:template match="nad:DocumentInfo/nad:CustomsOffice">
