...
<xsl:stylesheet version="1.0" xmlns:actco="urn:customs.ru:Information:CustomsDocuments:ActCustomsObservation:5.14.5" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
								...
								<td colspan="2" align="center" class="title">
									<font size="4">
										<b>
											...
											<u>
												<xsl:text>&#160;&#160;</xsl:text>
												<xsl:apply-templates mode="gtd_number" select="actco:ActNumber"/>
												<xsl:text>&#160;&#160;</xsl:text>
											</u>
										</b>
									</font>
							...
							<tr>
								<td class="value">
									...
									<xsl:for-each select="actco:Goods">
										<xsl:text> № </xsl:text>
										<xsl:value-of select="actco:GoodsNumber"/>
										<xsl:text>&#160;</xsl:text>
								...
								<td class="value">
									<span>
										<xsl:for-each select="actco:ApplicationTMCC">
											<xsl:value-of select="actco:KindCod"/> <xsl:value-of select="actco:Kind"/> <xsl:value-of select="actco:Number"/> </xsl:for-each>
									</span>
								</td>
							</tr>
							<tr>
