...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:minprl="urn:customs.ru:Information:SQDocuments:MinPromLicence:5.14.3" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
						...
						<tr valign="top">
							...
							<td class="bordered" colspan="3">
								...
								<xsl:if test="minprl:IsCanceled">
									<br/>
									<xsl:choose>
									  <xsl:when test="minprl:IsCanceled='true' or minprl:IsCanceled=1"><b><span class="arial" style="color: green;">действителен</span></b></xsl:when>
									  <xsl:when test="minprl:IsCanceled='false' or minprl:IsCanceled=0"><b><span class="arial" style="color: red;">не действителен</span></b></xsl:when>
									</xsl:choose>
								</xsl:if>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td class="bordered" colspan="2" style="border-top:0; width:30%" align="center">
								<span class="arial">
									...
									<xsl:if test="minprl:AddQuantity">
										<br/><xsl:value-of select="minprl:AddQuantity/RUScat_ru:MeasureUnitQualifierName"/>
									</xsl:if>
								</span>
							</td>
						</tr>
							...
							<xsl:for-each select="minprl:Addendum">
								...
								<tr valign="top">
									...
									<td class="bordered" rowspan="3" style="border-top:0; width:20%" align="center">
										<xsl:for-each select="minprl:LicAddendumMeasureItem">
											<span class="arial"><xsl:value-of select="RUScat_ru:MeasureUnitQualifierName"/></span>
											<xsl:if test="position()!=last()"><br/></xsl:if>
										</xsl:for-each>	
									</td>
								</tr>
