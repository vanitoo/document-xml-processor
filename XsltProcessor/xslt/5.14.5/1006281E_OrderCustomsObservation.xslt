						...
						<tbody>
							...
							<tr>
								...
								<td width="25%" align="center" class="value">
									<xsl:apply-templates select="ordco:OrderNumber" mode="gtd_number"/>
								</td>
							</tr>
						</tbody>
					</table>
...
аэропорта:</xsl:text>
							...
							<tr>
								<td class="value">
									<xsl:choose>
										<xsl:when test="ordco:ObjectsControl | ordco:Goods">
