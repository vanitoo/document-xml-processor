...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:catpi_ru="urn:customs.ru:Information:PriorInformation:PriorCommonAggregateTypes:5.14.3" xmlns:npir="urn:customs.ru:Information:PriorInformation:Notif_PIResult:5.14.3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
