...
Ответ на заявление лица, внесшего авансовые платежи, об использовании авансовых плетежей в связи с получением уведомления (уточнения к уведомлению) о не уплаченных в установленный срок суммах таможенных платежей, специальных, антидемпинговых, компенсационных пошлин, процентов и пеней -->
<xsl:stylesheet exclude-result-prefixes="cat_ru auapr" version="1.0" xmlns:auapr="urn:customs.ru:Information:CommercialFinanceDocuments:AppUseAdvancePaymentsResult:5.14.5" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
				...
				<div class="page">
					<table class="grahpMain" width="100%">
						<tbody>
							...
							<xsl:choose>
								<xsl:when test="auapr:AppStatus='true' or auapr:AppStatus='t' or auapr:AppStatus='1'">
									<tr>
								...
								<xsl:when test="auapr:AppStatus='false' or auapr:AppStatus='f' or auapr:AppStatus='0'">
									<tr>
										<td style="text-indent: 5%; text-align:justify">
