...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:dcd="urn:customs.ru:Information:CustomsDocuments:DeclChangeDecision:5.14.3">
		...
		<html>
			...
			<body>
				...
				<xsl:if test="dcd:ProjectDate or dcd:coordinationDate or dcd:ProcedureID or dcd:DecisionNum or dcd:DocSign or dcd:ProcedureID or
									...
									dcd:Declarant/RUScat_ru:SubjectAddressDetails or dcd:Declarant/RUScat_ru:IdentityCard or dcd:Declarant/RUScat_ru:SubjectAddressDetails or dcd:KDTCustoms or dcd:ProjectDate or dcd:coordinationDate">
					<div class="page">
