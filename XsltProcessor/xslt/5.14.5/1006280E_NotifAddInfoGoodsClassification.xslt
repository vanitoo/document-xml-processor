					...
					<xsl:if test="naigc:DocType=1">
						...
						<table>
							<tbody>
								<tr valign="bottom">
									<td width="45%">
										<span style="width:40%; display: inline-block; text-align:center;" class="value"><xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="naigc:NotifDate"/></xsl:call-template></span>
										<xsl:text> № </xsl:text>
										<span style="width:40%; display: inline-block; text-align:center;" class="value"><xsl:value-of select="naigc:NotifNumber"/></span>
										<br/>
										<br/>
										<xsl:text>На </xsl:text>
										<span style="width:40%; display: inline-block; text-align:center;" class="value"><xsl:value-of select="naigc:ApplicationRegistration/cat_ru:PrDocumentNumber"/></span>
										<xsl:text> от </xsl:text>
										<span style="width:40%; display: inline-block; text-align:center;" class="value"><xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="naigc:ApplicationRegistration/cat_ru:PrDocumentDate"/></xsl:call-template></span>
										<br/>
										<br/>
										<xsl:text>О предоставлении дополнительной информации</xsl:text>
									</td>
									<td width="10%"></td>
									<td width="45%">
								...
								<tr>
									<td>
										...
										<xsl:call-template name="inlinetable">
											...
											<xsl:with-param name="description" select="'запрашиваемые сведения'"/>
											<xsl:with-param name="width" select="'100%'"/>
										</xsl:call-template>
										<br/>
										<br/>
										<xsl:text>Информируем, что в соответствии с частью 13 статьи 16 Федерального закона вышеуказанная дополнительная информация представляется в течение 60 (шестидесяти) календарных дней со дня уведомления заявителя.</xsl:text>
										<br/>
										<br/>
							...
							<tbody>
								<tr valign="top">
									<td width="50%" class="bordered">
										...
										<br/><br/>
										<i><xsl:apply-templates mode="spaced" select="naigc:Customs"/></i>
									</td>
									<td width="50%" class="bordered">
										<xsl:text>2. Сведения о заявителе</xsl:text>
										<br/><br/>
										<i><xsl:apply-templates select="naigc:Declarant"/></i>
									</td>
								</tr>
								<tr>
									<td colspan="2" class="bordered">
										...
										<br/><br/>
										<i><xsl:value-of select="naigc:NotifNumber"/></i>
									</td>
								</tr>
								<tr valign="top">
									<td class="bordered">
										...
										<br/><br/>
										<i><xsl:value-of select="naigc:ApplicationRegistration/cat_ru:PrDocumentNumber"/></i>
									</td>
									<td class="bordered">
										...
										<br/><br/>
										<i><xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="naigc:ApplicationRegistration/cat_ru:PrDocumentDate"/></xsl:call-template></i>
									</td>
								</tr>
								<tr>
