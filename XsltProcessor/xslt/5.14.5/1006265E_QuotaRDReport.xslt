...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.14.3" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.3" xmlns:qrdr="urn:customs.ru:Information:CustomsDocuments:QuotaRDReport:5.14.3" xmlns:xs="http://www.w3.org/2001/XMLSchema">
						...
						<table>
							...
							<thead>
								...
								<tr align="center" valign="top">
									...
									<th>Условное обозначение единицы измерения</th>
										...
										<xsl:otherwise>
											<xsl:for-each select="qrdr:BalanceQuantity">
												<tr>
													...
													<td align="center"><xsl:value-of select="cat_ru:GoodsQuantity"/></td>
													<td align="center"><xsl:value-of select="cat_ru:MeasureUnitQualifierName"/></td>
													<td align="center"><xsl:value-of select="cat_ru:MeasureUnitQualifierCode"/></td>
												</tr>
											</xsl:for-each>
										</xsl:otherwise>
									</xsl:choose>
