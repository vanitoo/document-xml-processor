				...
				<div class="page" style="width: {$w}mm;">
						...
						<tbody>
							...
							<tr align="center">
								<td>
									...
									<xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="nrot:Date"/></xsl:call-template>
								</td>
							</tr>
							<tr>
					...
					<table>
						<tbody>
							...
							<tr>
								<td>
									<xsl:text>о возврате (зачете) излишне уплаченных или излишне взысканных сумм таможенных пошлин, налогов и иных платежей, взимание которых возложено на таможенные органы, исчисленых</xsl:text>
									<xsl:call-template name="inlinetable">
										<xsl:with-param name="data">
									...
									<xsl:call-template name="inlinetable">
										<xsl:with-param name="data">
											<xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="nrot:RegistrationDate"/></xsl:call-template>
										</xsl:with-param>
										<xsl:with-param name="data_align" select="'center'"/>
									...
									<xsl:call-template name="inlinetable">
										<xsl:with-param name="data">
											<xsl:value-of select="nrot:Amount"/>
											<xsl:text> (</xsl:text>
									...
									<xsl:text>.</xsl:text>
									<br/>
									<xsl:text>Информируем, что в связи с неправомерным взысканием таможенных пошлин, налогов и иных платежей, взимание которых вызложено на налоговые органы</xsl:text>
									<xsl:call-template name="inlinetable">
										<xsl:with-param name="data">
											<xsl:choose>
												<xsl:when test="nrot:RefundOrganization/nrot:DeclarantEqualFlag = 1 or nrot:RefundOrganization/nrot:DeclarantEqualFlag='true'">
									...
									<xsl:text>,</xsl:text>
									<br/>
									<xsl:text>выплате подлежат проценты в сумме</xsl:text>
									<xsl:call-template name="inlinetable">
										<xsl:with-param name="data">
											<xsl:value-of select="nrot:PercentAmount"/>
											<xsl:text> (</xsl:text>
						...
						<tbody>
							...
							<tr align="center">
								<td width="25%" class="value">
									<xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="nrot:CustomsChief/cat_ru:IssueDate"/></xsl:call-template>
								</td>
								<td width="25%"></td>
					...
					<p align="left" style="font-size: 8pt;">
						...
						<br/>
						<sup>***</sup> Указывается лицо, на лицевой счет которого был произведет зачет денежных средств.
						<br/>
