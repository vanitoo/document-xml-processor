									...
									<table>
										<tbody>
											<tr>
												<td>серия</td>
												<td width="30%">
													<xsl:value-of select="pcd_bd:DeclarantPerson/cat_pcd:PersonIdCard/RUScat_ru:IdentityCardSeries"/>
												</td>
												<td>№</td>
												<td width="50%">
													<xsl:value-of select="pcd_bd:DeclarantPerson/cat_pcd:PersonIdCard/RUScat_ru:IdentityCardNumber"/>
												</td>
											</tr>
										</tbody>
									</table>
