	...
	<xsl:template match="diac:DebtIncashANDCommission">
		<html>
			...
			<body>
				<div class="page">
					<xsl:choose>
						<xsl:when test="(diac:DocumentInfo/diac:DocumentType = 0 and diac:DocumentInfo/diac:OrderType = 0) or (diac:DocumentInfo/diac:DocumentType = 0 and diac:DocumentInfo/diac:OrderType = 2)">
							<table width="100%" class="graphMain">
								<tbody>
									...
									<tr>
										<td class="value bordered" colspan="3">
											<sup>2</sup>
										...
										<td class="value bordered" colspan="2">
											<sup>3</sup>
											<br/>
