...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:statf="urn:customs.ru:Information:CustomsDocuments:StaticForm:5.14.3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.3">
                     ...
                     <tr>
                        <td class="brbb" style="width:60mm">
                           ...
                           <xsl:value-of select="statf:Consignor/cat_ru:OrganizationName"/> 
									...
									<xsl:if test="statf:Consignor/RUScat_ru:SubjectAddressDetails">
										<xsl:for-each select="statf:Consignor/RUScat_ru:SubjectAddressDetails">
                     ...
                     <tr>
                        <td class="brbb" rowspan="2" style="width:60mm">
                           ...
                           <xsl:value-of select="statf:Consignee/cat_ru:OrganizationName"/> 
									...
									<xsl:if test="statf:Consignee/RUScat_ru:SubjectAddressDetails">
										<xsl:for-each select="statf:Consignee/RUScat_ru:SubjectAddressDetails">
											<xsl:apply-templates select="."/>
											<xsl:if test="position()!=last()">; </xsl:if>
										</xsl:for-each>
									</xsl:if>
									
                           <!--xsl:value-of select="statf:Consignee/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardCode"/>
										<xsl:value-of select="statf:Consignee/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardName"/>
											<xsl:value-of select="statf:Consignee/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardSeries"/>
											<xsl:value-of select="statf:Consignee/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardNumber"/>
									<xsl:value-of select="statf:Consignee/RUScat_ru:IdentityCard/cat_ru:RBIdentificationNumber"/>
										<xsl:value-of select="statf:Consignee/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardDate"/>
											<xsl:value-of select="statf:Consignee/RUScat_ru:IdentityCard/RUScat_ru:OrganizationName"/-->
									,<span class="graphMain"> N</span>
                     ...
                     <tr>
                        <td class="br">
                           ...
                           <xsl:value-of select="statf:FinancialAdjustingResponsiblePerson/cat_ru:OrganizationName"/> 
									...
									<xsl:if test="statf:FinancialAdjustingResponsiblePerson/RUScat_ru:SubjectAddressDetails">
										<xsl:for-each select="statf:FinancialAdjustingResponsiblePerson/RUScat_ru:SubjectAddressDetails">
											<xsl:apply-templates select="."/>
											<xsl:if test="position()!=last()">; </xsl:if>
										</xsl:for-each>
									</xsl:if>
                           <!--Данные по документу, удостоверяющему личность-->
                           <xsl:if test="statf:FinancialAdjustingResponsiblePerson/RUScat_ru:IdentityCard">
							   <br/>
							   <xsl:value-of select="statf:FinancialAdjustingResponsiblePerson/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardCode"/> 
									<xsl:value-of select="statf:FinancialAdjustingResponsiblePerson/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardName"/> 
									<xsl:value-of select="statf:FinancialAdjustingResponsiblePerson/RUScat_ru:IdentityCard/RUScat_ru:FullIdentityCardName"/> 
									<xsl:value-of select="statf:FinancialAdjustingResponsiblePerson/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardSeries"/> 
									<xsl:value-of select="statf:FinancialAdjustingResponsiblePerson/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardNumber"/>
									...
									<xsl:call-template name="russian_date2">
									  <xsl:with-param name="dateIn2" select="statf:FinancialAdjustingResponsiblePerson/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardDate"/>
									</xsl:call-template> 
									<xsl:value-of select="statf:FinancialAdjustingResponsiblePerson/RUScat_ru:IdentityCard/RUScat_ru:OrganizationName"/> 
							</xsl:if>		
