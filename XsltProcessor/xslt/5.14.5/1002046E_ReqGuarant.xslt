...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:req_gr="urn:customs.ru:Information:CommercialFinanceDocuments:ReqGuarant:5.14.5" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.14.3">
									...
									<b>
										<xsl:choose>
											...
											<xsl:when test="req_gr:DocumentInfo/req_gr:PaymentType=1">
												<xsl:text>Требование об уплате денежных средств гарантирующим объединением</xsl:text>
												<xsl:text> (ассоциацией)</xsl:text>
												<br/>
											</xsl:when>
										</xsl:choose>
										<br/>
