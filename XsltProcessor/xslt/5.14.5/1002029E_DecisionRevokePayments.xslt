					...
					<table>
						<tbody align="center" class="graphMain">
							...
							<tr>
								<td class="border_bottom">
									<span class="normal">
										<xsl:value-of select="drp:BankAndAccountInfo/cat_ru:BankName"/>
									</span>
									<xsl:if test="drp:BankAndAccountInfo/cat_ru:BICID">
										<span class="normal">, БИК </span>
									</xsl:if>
									<span class="normal">
										<xsl:value-of select="drp:BankAndAccountInfo/cat_ru:BICID"/>
									</span>
								</td>
							</tr>
							<tr class="graphLittle">
							...
							<xsl:if test="drp:DocType = 'РОИ'">
								<tr>
									...
									<xsl:call-template name="inlinetable">
												...
												&#160;№&#160;<xsl:value-of select="drp:DRP_Demand/cat_ru:PrDocumentNumber"/>
													</xsl:if>&#160;
										</xsl:with-param>
