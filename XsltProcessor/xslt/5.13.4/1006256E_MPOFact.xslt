...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:mpco="urn:customs.ru:Information:CustomsDocuments:MPOCommon:5.13.3" xmlns:mpf="urn:customs.ru:Information:CustomsDocuments:MPOFact:5.13.3" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.3">
			...
			<table border="2" height="150mm" style="border-color: black" width="210mm">
				<span class="graph">
					...
					<tr>
						...
						<td colspan="5" style="padding:0pt 5pt">
							<span class="graph">Улица<br/>
								<xsl:if test="mpco:Consignor/cat_ru:Address/cat_ru:StreetHouse">
									<xsl:value-of select="mpco:Consignor/cat_ru:Address/cat_ru:StreetHouse"/>
								</xsl:if>
								<xsl:if test="mpco:Consignor/cat_ru:Address/cat_ru:StreetHouse and mpco:ConsignorRUS/cat_ru:Address/cat_ru:StreetHouse">
									<xsl:text> / </xsl:text>
									<xsl:value-of select="mpco:ConsignorRUS/cat_ru:Address/cat_ru:StreetHouse"/>
								</xsl:if>
							</span>
						</td>
					</tr>
								...
								<tr>
									<td style="border:solid 0pt">
										<span class="graph">Почтовый индекс<br/>
											<xsl:value-of select="mpco:Consignor/cat_ru:Address/cat_ru:PostalCode|mpco:ConsignorRUS/cat_ru:Address/cat_ru:PostalCode"/>
										</span>
									</td>
									<td style="border:solid 0pt">
										<span class="graph">Город<br/>
											<xsl:if test="mpco:Consignor/cat_ru:Address/cat_ru:City">
												<xsl:value-of select="mpco:Consignor/cat_ru:Address/cat_ru:City"/>
											</xsl:if>
											<xsl:if test="mpco:Consignor/cat_ru:Address/cat_ru:City and mpco:ConsignorRUS/cat_ru:Address/cat_ru:City">
												<xsl:text> / </xsl:text>
												<xsl:value-of select="mpco:ConsignorRUS/cat_ru:Address/cat_ru:City"/>
											</xsl:if>
										</span>
									</td>
								</tr>
					...
					<tr>
						<td colspan="5" style="padding:0pt 5pt">
							<span class="graph">Страна<br/>
								<xsl:if test="mpco:Consignor/cat_ru:Address/cat_ru:CountryCode">
									<xsl:value-of select="mpco:Consignor/cat_ru:Address/cat_ru:CountryCode"/> 
							</xsl:if>
								<xsl:if test="mpco:Consignor/cat_ru:Address/cat_ru:CounryName">
									<xsl:value-of select="mpco:Consignor/cat_ru:Address/cat_ru:CounryName"/>
								</xsl:if>
								<xsl:if test="mpco:Consignor/cat_ru:Address/cat_ru:CounryName and mpco:ConsignorRUS/cat_ru:Address/cat_ru:CounryName">
									<xsl:text> / </xsl:text>
								</xsl:if>
								<xsl:if test="mpco:ConsignorRUS/cat_ru:Address/cat_ru:CounryName">
									<xsl:value-of select="mpco:ConsignorRUS/cat_ru:Address/cat_ru:CounryName"/>
								</xsl:if>
							</span>
						</td>
					</tr>
					...
					<tr>
						<td colspan="5" style="padding:0pt 5pt">
							<span class="graph">Улица<br/>
								<xsl:if test="mpco:Consignee/mpco:FullAddress">
									<xsl:value-of select="mpco:Consignee/mpco:FullAddress"/>
								</xsl:if>
							</span>
						</td>
						...
						<td colspan="5">
							<table cellspacing="6">
								<tr>
									<td style="border:solid 0pt">
										<span class="graph">Почтовый индекс<br/>
											<xsl:if test="mpco:Consignee/cat_ru:Address/cat_ru:PostalCode">
												<xsl:value-of select="mpco:Consignee/cat_ru:Address/cat_ru:PostalCode"/>
											</xsl:if>
										</span>
									</td>
									<td style="border:solid 0pt">
										<span class="graph">Город<br/>
											<xsl:if test="mpco:Consignee/cat_ru:Address/cat_ru:City">
												<xsl:value-of select="mpco:Consignee/cat_ru:Address/cat_ru:City"/>
											</xsl:if>
										</span>
									</td>
								</tr>
					...
					<tr>
						<td colspan="5" style="padding:0pt 5pt">
							<span class="graph">Страна<br/>
								<xsl:if test="mpco:Consignee/cat_ru:Address/cat_ru:CountryCode">
									<xsl:value-of select="mpco:Consignee/cat_ru:Address/cat_ru:CountryCode"/> 
							</xsl:if>
								<xsl:if test="mpco:Consignee/cat_ru:Address/cat_ru:CounryName">
									<xsl:value-of select="mpco:Consignee/cat_ru:Address/cat_ru:CounryName"/>
								</xsl:if>
							</span>
						</td>
					</tr>
						...
						<tr>
							<td colspan="2" style="padding:0pt 5pt">
								<span class="graph">
									...
									<xsl:if test="mpco:GoodDescriptionForeign">
										<xsl:text> / </xsl:text>
									</xsl:if>
									<xsl:for-each select="mpco:GoodDescriptionForeign">
										<xsl:value-of select="."/>
									</xsl:for-each>
									<xsl:if test="mpco:TradeMark">
										<xsl:text> (</xsl:text>
