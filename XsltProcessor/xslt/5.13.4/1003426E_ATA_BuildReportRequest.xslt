				...
				<div class="page">
						...
						<tbody>
							<tr>
								<td align="center" class="graphMain">
									<font size="4">
										<b>Запрос на построение отчета</b>
									</font>
								</td>
							</tr>
						</tbody>
					...
					<table class="w190">
						<tr>
							...
							<td class="value graphMain" style="width:50%">
								<xsl:value-of select="ata_buildr:ReportType"/>
							</td>
						</tr>
						<tr>
							<td class="annot graphMain" style="width:50%">Формат представления отчета</td>
							<td class="value graphMain" style="width:50%">
								<xsl:value-of select="ata_buildr:ViewType"/>
							</td>
						</tr>
						<tr>
							...
							<td class="value graphMain" style="width:50%">
								<xsl:choose>
									<xsl:when test="ata_buildr:Compressed='true' or ata_buildr:Compressed=1">сжатый</xsl:when>
									<xsl:when test="ata_buildr:Compressed='false' or ata_buildr:Compressed=0">несжатый</xsl:when>
								</xsl:choose>
							</td>
						</tr>
					</table>
					<div class="title marg-top">Параметры запроса</div>
					<xsl:apply-templates select="ata_buildr:RequestParams"/>
				</div>
			</body>
		</html>
	</xsl:template>
	<!-- Шаблон для типа ata_ct:RequestParamsType -->
	<xsl:template match="ata_buildr:RequestParams">
		<table class="w190">
			<tr>
