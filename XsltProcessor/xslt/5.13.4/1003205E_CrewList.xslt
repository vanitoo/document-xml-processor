               ...
               <xsl:for-each select="cl:CockpitPersonnel">
                  <tr>
                     ...
                     <td colspan="2" style="width:32.5mm;">
                        <xsl:value-of select="cl:Document/cat_ru:IdentityCardName"/>
                        <xsl:text> (</xsl:text>
                        <xsl:value-of select="cl:Document/cat_ru:IdentityCardCode"/>
                        <xsl:text>) </xsl:text>
                        <xsl:value-of select="cl:Document/cat_ru:IdentityCardSeries"/>
                        <xsl:text> </xsl:text>
                        <xsl:value-of select="cl:Document/cat_ru:IdentityCardNumber"/>
                     </td>
                  </tr>
               </xsl:for-each>
            </tbody>
