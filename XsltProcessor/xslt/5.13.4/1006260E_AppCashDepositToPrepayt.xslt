...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"  xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.3" xmlns:acdp="urn:customs.ru:Information:CustomsDocuments:AppCashDepositToPrepayt:5.13.3">
<!-- проект
		...
		<div class="page">
			<table>
				<tbody align="center" class="graphHeader">
					<tr>
						<td>Заявление о зачете денежного залога в счёт авансовых платежей, оформленное в виде электронного документа</td>
					</tr>
				</tbody>
			</table>
			<br/>
					...
					<tr>
						<td class="bordered">
							...
							<span class="normal">
								<br/>
								<br/>
								<xsl:if test="RUScat_ru:IdentityCard/cat_ru:IdentityCardCode">
									<xsl:value-of select="RUScat_ru:IdentityCard/cat_ru:IdentityCardCode" /> 
								</xsl:if>
								<xsl:if test="RUScat_ru:IdentityCard/cat_ru:IdentityCardName">
									<xsl:value-of select="RUScat_ru:IdentityCard/cat_ru:IdentityCardName" /> 
								</xsl:if>
							</span>
						</td>
						<td class="bordered">
							...
							<span class="normal">
								<br/>
								<br/>
								<xsl:value-of select="RUScat_ru:IdentityCard/cat_ru:IdentityCardSeries" />
							</span>
						</td>
						<td class="bordered">
							...
							<span class="normal">
								<br/>
								<br/>
								<xsl:value-of select="RUScat_ru:IdentityCard/cat_ru:IdentityCardNumber" />
							</span>
						</td>
					</tr>
					<tr>
