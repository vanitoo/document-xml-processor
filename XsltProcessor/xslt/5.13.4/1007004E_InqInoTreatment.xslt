...
<xsl:stylesheet exclude-result-prefixes="iit cat_ru catTreat_ru" version="1.0" xmlns:catTreat_ru="urn:customs.ru:Information:TreatmentDocuments:TreatmentCommonAggregateTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:iit="urn:customs.ru:Information:TreatmentDocuments:InqInoTreatment:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
                        ...
                        <td class="graph" style="width:180mm;">
                           ...
                           <span class="graph">
                              <xsl:if test="iit:Applicant/iit:IdentityCard">
                                 ...
                                 <xsl:value-of select="iit:Applicant/iit:IdentityCard/cat_ru:IdentityCardCode"/>
                                 <xsl:text>,  </xsl:text> 
										наименование документа
										<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                 <xsl:value-of select="iit:Applicant/iit:IdentityCard/cat_ru:IdentityCardName"/>
                                 <xsl:if test="iit:Applicant/iit:IdentityCard/cat_ru:IdentityCardSeries">
                                    <xsl:text>,  </xsl:text>												
										 серия 
										<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                    <xsl:value-of select="iit:Applicant/iit:IdentityCard/cat_ru:IdentityCardSeries"/>
                                    <xsl:text>,  </xsl:text>
                                 </xsl:if>
											
										 номер <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                 <xsl:value-of select="iit:Applicant/iit:IdentityCard/cat_ru:IdentityCardNumber"/>
                                 <xsl:text>,  </xsl:text>
										 дата выдачи
										<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                                 <xsl:value-of select="iit:Applicant/iit:IdentityCard/cat_ru:IdentityCardDate"/>
