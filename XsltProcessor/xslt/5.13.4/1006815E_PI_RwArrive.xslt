...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:catpi_ru="urn:customs.ru:Information:PriorInformation:PriorCommonAggregateTypes:5.13.4" xmlns:pirwa="urn:customs.ru:Information:PriorInformation:PI_RwArrive:5.13.4" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.3">
                           ...
                           <td>
                              ...
                              <span class="text">
                                 <xsl:choose>
                                    ...
                                    <xsl:otherwise><xsl:value-of select="pirwa:EmptyIndicator"/></xsl:otherwise>
                                 </xsl:choose>
                              </span>
                           </td>
                           <td>
