			...
			<table class="bordered w190">
				<tbody>
					<tr class="title">
						...
						<td class="graphMain bordered">Сортимента</td>
						<td class="graphMain bordered">Порода</td>
