...
<!-- бланк 1: 	Указ президента РФ от 10.09.2005 № 1062-ч7 Приложение №1 к Положению о порядке лицензирования в РФ ввоза  вывоза продукции военного назначения; 
					Письмо ФТС №14-153/46547 от 14.09.2016 Приложение №6 -->
<!-- бланк 2: 	Постановление правительства РФ от 15.09.2008 № 691 Приложение №2 к Положению о лицензировании внешнеэкономических операций с товарами, информацией, работами, услугами, результатами интеллектуальной деятельности (правами на них), в отношении которых установлен экспортный контроль;
					Письмо ФТС №14-153/46547 от 14.09.2016 Приложение №3 -->
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:vtstek="urn:customs.ru:Information:SQDocuments:FsVtsTekLicense:5.13.3" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
											...
											<tbody>
												...
												<tr>
													<td colspan="3" style="border-left:0;border-top:0;border-right:1px solid; border-bottom:1px solid;">
														...
														<br/>
														<xsl:value-of select="vtstek:GoodsDescription/vtstek:Quantity/cat_ru:MeasureUnitQualifierName"/>
														<xsl:if test="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName">														
															<xsl:choose>
																<xsl:when test="not (vtstek:GoodsDescription/vtstek:Quantity/cat_ru:MeasureUnitQualifierName)">
																	<br/><xsl:value-of select="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName"/>
																</xsl:when>
																<xsl:when test="(vtstek:GoodsDescription/vtstek:Quantity/cat_ru:MeasureUnitQualifierName) and 
																						 (vtstek:GoodsDescription/vtstek:Quantity/cat_ru:MeasureUnitQualifierName!=vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName)">
																	<br/><xsl:value-of select="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName"/>
																</xsl:when>
																<xsl:when test="(vtstek:GoodsDescription/vtstek:Quantity/cat_ru:GoodsQuantity) and (vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity)
																						 and (vtstek:GoodsDescription/vtstek:Quantity/cat_ru:GoodsQuantity!=vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity)">
																	<br/><xsl:value-of select="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName"/>
																</xsl:when>
																<xsl:when test="(vtstek:GoodsDescription/vtstek:Quantity/cat_ru:GoodsQuantity) and
																                         not(vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity)">
																	<br/><xsl:value-of select="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName"/>
																</xsl:when>
																<xsl:when test="not(vtstek:GoodsDescription/vtstek:Quantity/cat_ru:GoodsQuantity) and
																                         (vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity)">
																	<br/><xsl:value-of select="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName"/>
																</xsl:when>
															</xsl:choose>
														</xsl:if>
													...
													<td colspan="3" style="border-left:0;border-top:0;border-right:0; border-bottom:1px solid;">
														17. Количество
														<br/>
														<xsl:value-of select="vtstek:GoodsDescription/vtstek:Quantity/cat_ru:GoodsQuantity"/>
														<xsl:if test="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity">														
															<xsl:choose>
																<xsl:when test="not (vtstek:GoodsDescription/vtstek:Quantity/cat_ru:GoodsQuantity)">
																	<br/><xsl:value-of select="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity"/>
																</xsl:when>
																<xsl:when test="(vtstek:GoodsDescription/vtstek:Quantity/cat_ru:GoodsQuantity) and 
																						 (vtstek:GoodsDescription/vtstek:Quantity/cat_ru:GoodsQuantity!=vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity)">
																	<br/><xsl:value-of select="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity"/>
																</xsl:when>
																<xsl:when test="(vtstek:GoodsDescription/vtstek:Quantity/cat_ru:MeasureUnitQualifierName) and (vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName)
																						 and (vtstek:GoodsDescription/vtstek:Quantity/cat_ru:MeasureUnitQualifierName!=vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName)">
																	<br/><xsl:value-of select="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity"/>
																</xsl:when>
																<xsl:when test="(vtstek:GoodsDescription/vtstek:Quantity/cat_ru:MeasureUnitQualifierName) and
																                         not(vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName)">
																	<br/><xsl:value-of select="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity"/>
																</xsl:when>
																<xsl:when test="not(vtstek:GoodsDescription/vtstek:Quantity/cat_ru:MeasureUnitQualifierName) and
																                         (vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName)">
																	<br/><xsl:value-of select="vtstek:GoodsDescription/vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity"/>
																</xsl:when>
															</xsl:choose>
														</xsl:if>
									...
									<td>
										<table width="100%">
											<tr>
												...
												<td style="width:80mm;border-bottom:1px solid;">&#160;</td>
							...
							<tbody>
								...
								<xsl:for-each select="vtstek:GoodsDescription">
									<tr>
										...
										<td align="center">
											<xsl:value-of select="vtstek:SupplementaryQuantity/cat_ru:MeasureUnitQualifierName"/>
										</td>
										<td align="center">
											<xsl:value-of select="vtstek:SupplementaryQuantity/cat_ru:GoodsQuantity"/>
										</td>
									</tr>
								</xsl:for-each>
							</tbody>
