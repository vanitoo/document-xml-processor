...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:prmap="urn:customs.ru:Information:CustomsDocuments:OEZ_PermitApplication:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
         ...
         <body>
            <div class="page">
               <table>
                ...
                <xsl:if test="prmap:Applicant/cat_ru:Address">
                           <xsl:apply-templates select="prmap:Applicant/cat_ru:Address"/>
                        </xsl:if>
                        <xsl:if test="prmap:Applicant/cat_ru:IdentityCard"> <xsl:apply-templates select="prmap:Applicant/cat_ru:IdentityCard"/>
                        </xsl:if>
                     </td>
                  </tr>
                  <tr>
