...
<xsl:stylesheet exclude-result-prefixes="catWH_ru cat_ru do3r" version="1.0" xmlns:catWH_ru="urn:customs.ru:Information:WarehouseDocuments:WarehouseCommonAggregateTypesCust:5.13.1" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:do3r="urn:customs.ru:Information:WarehouseDocuments:DO3Report:5.13.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template name="DO3R">
      <table border="1" style="width:250mm">
         <tr>
            ...
            <td align="center" colspan="13" style="width:177mm">
               <b>Приход</b>
            </td>
            <td align="center" colspan="5" style="width:70mm">
               <b>Расход</b>
            </td>
         </tr>
         <tr>
            ...
            <!--14-->
            <td class="graph" style="width:12mm">Дата истечения срока временного хранения</td>
            <!--15-->
         ...
         <tr>
            ...
            <td align="center" style="width:17mm">19</td>
         </tr>
         <xsl:for-each select="do3r:Goods">
            <xsl:variable name="Output">
				<xsl:if test="count(do3r:Output) &lt; 1">1</xsl:if>
				<xsl:if test="count(do3r:Output) &gt;= 1"><xsl:value-of select="count(do3r:Output)"/></xsl:if>
            </xsl:variable>
               ...
               <tr>
                        ...
                        <td class="graph" style="width:3mm">
                           ...
                           <xsl:value-of select="do3r:Input/catWH_ru:GoodsNumber"/>
                        </td>
                        ...
                        <td class="graph" style="width:11mm">
                           ...
                           <xsl:call-template name="russian_date">
                              <!--xsl:with-param name="dateIn" select="do3r:Input/do3r:DO1GoodLink/do3r:DO1Date"/-->
                              <xsl:with-param name="dateIn" select="do3r:Input/do3r:KeepingLimit/do3r:AcceptDate"/>
                           </xsl:call-template>
                           <br/>
                           <xsl:value-of select="do3r:Input/do3r:KeepingLimit/do3r:AcceptTime"/>
                        </td>
                        ...
                        <td class="graph" style="width:8mm">
                           ...
                           <xsl:value-of select="do3r:Input/do3r:DO1GoodLink/do3r:DO1Number"/>
                           от 
                           <xsl:call-template name="russian_date">
                              <xsl:with-param name="dateIn" select="do3r:Input/do3r:DO1GoodLink/do3r:DO1Date"/>
                           </xsl:call-template>
                        ...
                        <td class="graph" style="width:10mm">
                           ...
                           <xsl:value-of select="do3r:Input/do3r:DO1GoodLink/do3r:DO1GoodNumber"/>
                        </td>
                        ...
                        <td class="graph" style="width:18mm">
                           ...
                           <xsl:value-of select="do3r:Input/catWH_ru:GoodsDescription"/>
                        </td>
                        ...
                        <td class="graph" style="width:15mm">
                           ...
                           <xsl:value-of select="do3r:Input/do3r:TransportDocument/cat_ru:PrDocumentName"/>
										№<xsl:value-of select="do3r:Input/do3r:TransportDocument/cat_ru:PrDocumentNumber"/>
										от<xsl:call-template name="russian_date">
                              <xsl:with-param name="dateIn" select="do3r:Input/do3r:TransportDocument/cat_ru:PrDocumentDate"/>
                           </xsl:call-template>
                        </td>
                        <!--7 складской номер-->
                        <td class="graph" style="width:11mm">
                           ...
                           <xsl:value-of select="do3r:Input/do3r:GoodsWHNumber"/>
                        </td>
                        ...
                        <td class="graph" style="width:7mm">
                           ...
                           <xsl:value-of select="do3r:Input/catWH_ru:CargoPlace/catWH_ru:PlaceNumber"/>
                        </td>
                        ...
                        <td class="graph" style="width:16mm">
                           ...
                           <xsl:value-of select="do3r:Input/catWH_ru:BruttoVolQuant/catWH_ru:GoodsQuantity"/> 
						<xsl:value-of select="do3r:Input/catWH_ru:BruttoVolQuant/catWH_ru:MeasureUnitQualifierName"/> 
						<xsl:value-of select="do3r:Input/catWH_ru:BruttoVolQuant/catWH_ru:MeasureUnitQualifierCode"/>
                           <br/>
                           <xsl:value-of select="do3r:Input/catWH_ru:MeasureQuantity/catWH_ru:GoodsQuantity"/> 
						<xsl:value-of select="do3r:Input/catWH_ru:MeasureQuantity/catWH_ru:MeasureUnitQualifierName"/> 
						<xsl:value-of select="do3r:Input/catWH_ru:MeasureQuantity/catWH_ru:MeasureUnitQualifierCode"/>
                        </td>
                        ...
                        <td class="graph" style="width:15mm">
                           ...
                           <xsl:value-of select="do3r:Input/catWH_ru:GoodsTNVEDCode"/>
                        </td>
                        ...
                        <td class="graph" style="width:17mm">
                           ...
                           <xsl:value-of select="do3r:Input/catWH_ru:InvoiceCost"/>
                        </td>
                        ...
                        <td class="graph" style="width:10mm">
                           ...
                           <xsl:value-of select="do3r:Input/catWH_ru:CurrencyCode"/>
                        </td>
                        ...
                        <td class="graph" style="width:12mm">
                           ...
                           <xsl:value-of select="do3r:Input/do3r:Recipient/cat_ru:OrganizationName"/>
                        </td>
                        ...
                        <!-- Вызов шаблона для расхода гр.15-гр.19-->
   ...
   <xsl:template name="DO3_Output">
	   ...
	   <!--15 Дата и время выдачи товара со склада-->
		  <td class="graph" style="width:12mm">
			 <xsl:call-template name="russian_date">
				<xsl:with-param name="dateIn" select="$outputNode/do3r:OutputDate"/>
			 </xsl:call-template>
			 <br/>
			 <xsl:value-of select="$outputNode/do3r:OutputTime"/>
		  </td>
		  <!--16 Количество грузовых мест -->
		  <td class="graph" style="width:17mm">
			 <xsl:value-of select="$outputNode/do3r:CargoPlace/catWH_ru:PlaceNumber"/>
		  </td>
		  <!--17 Вес товара брутто (в кг) или объем товара (в куб.м) (либо в доп. единицах измерения)-->
		  <td class="graph" style="width:16mm">
			 <xsl:value-of select="$outputNode/do3r:BruttoVolQuant/catWH_ru:GoodsQuantity"/> 
				<xsl:value-of select="$outputNode/do3r:BruttoVolQuant/catWH_ru:MeasureUnitQualifierName"/> 
				<xsl:value-of select="$outputNode/do3r:BruttoVolQuant/catWH_ru:MeasureUnitQualifierCode"/>
			 <br/>
			 <xsl:value-of select="$outputNode/do3r:MeasureQuantity/catWH_ru:GoodsQuantity"/> 
				<xsl:value-of select="$outputNode/do3r:MeasureQuantity/catWH_ru:MeasureUnitQualifierName"/> 
				<xsl:value-of select="$outputNode/do3r:MeasureQuantity/catWH_ru:MeasureUnitQualifierCode"/>
		  </td>
		  <!--18  Стоимость товара в валюте указанной в транспортных или коммерческих документах-->
		  <td class="graph" style="width:17mm">
			 <xsl:value-of select="$outputNode/do3r:Cost"/> 
				<xsl:value-of select="$outputNode/do3r:CurrencyCode"/>
		  </td>
		  <!--19 Вид,дата и номер документа, по которому разрешена выдача товаров со склада-->
		  <td class="graph" style="width:17mm">
			 <xsl:value-of select="$outputNode/do3r:OrderCustDoc/cat_ru:PrDocumentName"/>
			 <br/>
			 <xsl:value-of select="$outputNode/do3r:OrderCustDoc/cat_ru:PrDocumentNumber"/>
			 <br/>
			 <xsl:call-template name="russian_date">
				<xsl:with-param name="dateIn" select="$outputNode/do3r:OrderCustDoc/cat_ru:PrDocumentDate"/>
			 </xsl:call-template>
		  </td>
   </xsl:template>
         ...
         <tbody>
            <tr align="center">
               <td>
                  ...
                  <u>
                     <xsl:call-template name="russian_date">
                        <xsl:with-param name="dateIn" select="do3r:ReportDate"/>
                     </xsl:call-template>
                  </u>
                  <b> № </b>
                  <u>
                     <xsl:value-of select="do3r:ReportNumber"/> </u>
                  ...
                  <b>c</b> <u>
                     <xsl:call-template name="russian_date">
                        <xsl:with-param name="dateIn" select="do3r:ReportBegingDate"/>
                     </xsl:call-template> </u>
                  <b>по</b>
					 <u>
                     <xsl:call-template name="russian_date">
                        <xsl:with-param name="dateIn" select="do3r:ReportEndDate"/>
                     </xsl:call-template>
                  </u>
               </td>
            </tr>
   ...
   <xsl:template name="DO3Radd">
      <tr>
         <td align="center">
            <b>Добавочный лист №</b>
            <u>
               <xsl:value-of select="do3r:AddedListNumber"/>
               <xsl:text> </xsl:text>
            </u>
                  ...
                  <tr>
                     <td>
						...
						<xsl:value-of select="do3r:Input/catWH_ru:MeasureQuantity/catWH_ru:MeasureUnitQualifierCode"/>
                                 ...
                                 <td>
                                    <xsl:call-template name="russian_date">
                                       <xsl:with-param name="dateIn" select="do3r:Output/do3r:OutputDate"/>
                                    </xsl:call-template>
                                    <br/>
                                    <xsl:value-of select="do3r:Output/do3r:OutputTime"/>
                                 </td>
                                 <!--16 Количество грузовых мест -->
                                 <td>
                                    <xsl:value-of select="do3r:Output/do3r:CargoPlace/catWH_ru:PlaceNumber"/>
                                 </td>
                                 <!--17 Вес товара брутто (в кг) или объем товара (в куб.м) (либо в доп. единицах измерения)-->
                                 <td>
                                    <xsl:value-of select="do3r:Output/do3r:BruttoVolQuant/catWH_ru:GoodsQuantity"/> 
						<xsl:value-of select="do3r:Output/do3r:BruttoVolQuant/catWH_ru:MeasureUnitQualifierName"/> 
						<xsl:value-of select="do3r:Output/do3r:BruttoVolQuant/catWH_ru:MeasureUnitQualifierCode"/>
                                    <br/>
                                    <xsl:value-of select="do3r:Output/do3r:MeasureQuantity/catWH_ru:GoodsQuantity"/> 
						<xsl:value-of select="do3r:Output/do3r:MeasureQuantity/catWH_ru:MeasureUnitQualifierName"/> 
						<xsl:value-of select="do3r:Output/do3r:MeasureQuantity/catWH_ru:MeasureUnitQualifierCode"/>
                                 </td>
                                 <!--18  Стоимость товара в валюте указанной в транспортных или коммерческих документах-->
                                 <td>
                                    <xsl:value-of select="do3r:Output/do3r:Cost"/> 
						<xsl:value-of select="do3r:Output/do3r:CurrencyCode"/>
                                 </td>
                                 <!--19 Вид,дата и номер документа, по которому разрешена выдача товаров со склада-->
                                 <td>
                                    <xsl:value-of select="do3r:Output/do3r:OrderCustDoc/cat_ru:PrDocumentName"/>
                                    <br/>
                                    <xsl:value-of select="do3r:Output/do3r:OrderCustDoc/cat_ru:PrDocumentNumber"/>
                                    <br/>
                                    <xsl:call-template name="russian_date">
                                       <xsl:with-param name="dateIn" select="do3r:Output/do3r:OrderCustDoc/cat_ru:PrDocumentDate"/>
                                    </xsl:call-template>
                                 </td>
                              </tr>
                           </xsl:for-each>
      ...
      <table width="250mm">
         <tr>
            <td style="width:135mm">Количество добавочных листов отчета
					<xsl:value-of select="do3r:AddedListsCount"/>
            </td>
            <td>
               <xsl:call-template name="russian_date">
      ...
      <table width="250mm">
         ...
         <tbody>
            <tr>
               ...
               <td align="center" class="underlined">
                  <xsl:value-of select="do3r:WarehouseOwner/catWH_ru:WarehousePerson/cat_ru:PersonName"/>
                  <xsl:text> </xsl:text> 
						<xsl:value-of select="do3r:WarehouseOwner/catWH_ru:WarehousePerson/cat_ru:PersonMiddleName"/>
                  <xsl:text> </xsl:text> 
						<xsl:value-of select="do3r:WarehouseOwner/catWH_ru:WarehousePerson/cat_ru:PersonSurname"/> 
						<xsl:if test="do3r:WarehouseOwner/catWH_ru:WarehousePerson/cat_ru:PersonPost">
                     <xsl:value-of select="do3r:WarehouseOwner/catWH_ru:WarehousePerson/cat_ru:PersonPost"/> 
						</xsl:if>
               </td>
            </tr>
            <tr>
      ...
      <html>
         <head>
            ...
            <style type="text/css">
					...
					div.page { width: 297mm; /*height: 210mm;*/ margin-top: 6pt; margin-bottom: 6pt; padding:	5mm; /*padding-left:	20mm;*/ background: #ffffff; border: solid 1pt #000000; }
                                    ...
                                    <table border="0" cellpadding="3" cellspacing="0" style="width:297mm">
                                       <tr>
                                          <td align="center" height="30mm" rowspan="3" style="width:160mm;border:solid 1pt #000000;">
                                             <b>СВХ </b>
                                             <u>
                                                <xsl:value-of select="do3r:WarehouseOwner/cat_ru:OrganizationName"/>
                                             </u>
                                             <br/>
                                             ...
                                             <u>
                                                <xsl:if test="do3r:WarehouseOwner/catWH_ru:WarehouseLicense/catWH_ru:CertificateDate">
                                                   <xsl:call-template name="russian_date">
                                                      <xsl:with-param name="dateIn" select="do3r:WarehouseOwner/catWH_ru:WarehouseLicense/catWH_ru:CertificateDate"/>
                                                   </xsl:call-template>
                                                </xsl:if>
                                             </u>
                                             <b> № </b>
                                             <u>
                                                <xsl:value-of select="do3r:WarehouseOwner/catWH_ru:WarehouseLicense/catWH_ru:CertificateNumber"/>
                                             </u>
                                             <br/>
