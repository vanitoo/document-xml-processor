		...
		<div class="page">
				...
				<tbody align="center" class="graphMain">
					...
					<tr>
						...
						<td width="80%" class="border_bottom">
							<span class="normal"><xsl:value-of select="aac:Customs/cat_ru:OfficeName"/></span>
							<xsl:if test="aac:Customs/cat_ru:OfficeName">
								<span class="normal"> (</span>
							</xsl:if>
							<span class="normal"><xsl:value-of select="aac:Customs/cat_ru:Code"/></span>
							<xsl:if test="aac:Customs/cat_ru:OfficeName">
								<span class="normal">)</span>
							</xsl:if>
						</td>
				...
				<tbody align="left" class="graphMain">
					...
					<tr>
						...
						<td width="50%">
							<table>
								<tr align="center">
									<td width="34%" class="border_bottom"> </td>
									<td width="3%"> </td>
									<td width="63%" class="border_bottom">
					...
					<tr>
						...
						<td align="center" width="50%">
							<xsl:call-template name="Date">
								<xsl:with-param name="date" select="null"/>
							</xsl:call-template>
						</td>
					</tr>
				</tbody>
			...
			<table>
				<tbody align="left" class="graphMain">
					...
					<tr align="center">
						<td>
							<xsl:choose>
								...
								<xsl:otherwise><u>&#160;&#160;&#160;&#160;&#160;</u> таможенной проверки</xsl:otherwise>
							</xsl:choose>
						</td>
					</tr>
					...
					<tr align="center">
						<td>
							№&#160;<u>&#160;<xsl:value-of select="aac:ActNumber/adt_cat:Number"/>&#160;</u>
						</td>
					</tr>
					<tr class="delim_3"><td> </td></tr>
				</tbody>
			...
			<table>
				<tbody align="center" class="graphMain">
					<tr>
						...
						<td width="15%"> </td>
						<td width="40%" class="border_bottom"><xsl:value-of select="aac:ActPlace"/></td>
					</tr>
					<tr class="graphLittle">
						<td width="45%">(дата)</td>
						<td  width="10%"> </td>
							...
							<table>
								<tbody align="left" class="graphMain">
									<xsl:for-each select="aac:ListCommission">
										<tr>
											<td width="3%" align="right" valign="bottom"><xsl:value-of select="position()"/>.&#160;</td>
											<td width="97%" class="border_bottom"><xsl:apply-templates select="."/></td>
										</tr>
										<xsl:if test="position()=1">
											<tr class="graphLittle" align="center">
												<td width="3%"> </td>
												<td width="97%">(должности, структурные подразделения, фамилии, имена, отчества (отчества указываются при наличии)<br/>
												должностных лиц таможенного органа, проводивших проверку)</td>
											</tr>
										</xsl:if>
									</xsl:for-each>
								</tbody>
							...
							<table>
								<tbody align="left" class="graphMain">
									<xsl:choose>
										<xsl:when test="aac:ListAttractedPersons">
											<xsl:for-each select="aac:ListAttractedPersons">
												...
												<xsl:if test="position()=1">
													<tr class="graphLittle" align="center">
														<td width="3%"> </td>
														<td width="97%">(должности, фамилии, имена, отчества (отчества указываются при наличии) должностных лиц)</td>
													</tr>
												</xsl:if>
											</xsl:for-each>
										</xsl:when>
										<xsl:otherwise>
											<tr>
												<td width="5%" align="right" valign="bottom"><xsl:value-of select="position()"/>.&#160;</td>
												<td width="95%" class="border_bottom">&#160;&#160;&#8212;</td>
											</tr>
											<tr class="graphLittle" align="center">
												<td width="5%"> </td>
					...
					<tbody align="left" class="graphMain">
						...
						<tr>
							<td>
								<table>
										<tr>
											<td width="99%" class="border_bottom"><xsl:apply-templates select="aac:Article"/></td>
											<td width="1%" >,</td>
										</tr>
								</table>
							</td>
						...
						<tr>
							<td>
								<table>
										<tr>
											<td width="1%" >№</td>
											<td width="99%" class="border_bottom">&#160;<xsl:value-of select="aac:DecisionPerformAudit/adt_cat:Number"/><br/></td>
										</tr>
								</table>
							</td>
						</tr>
							...
							<td>
								<table>
										<tr>
											...
											<td width="2%" ></td>
											<td width="48%" >выездная таможенная проверка</td>
										</tr>
										<tr class="graphLittle" align="center">
											<td width="13%" > </td>
											<td width="2%" ></td>
											<td width="45%">(плановая/внеплановая/встречная плановая)</td>
											<td width="2%" ></td>
											<td width="48%" > </td>
										</tr>
								</table>
			...
			<table>
				<tbody align="left" class="graphMain">
					...
					<tr class="graphLittle" align="center">
						<td>
							<xsl:choose>
								<xsl:when test="aac:IdentKindAudit = 1">(наименование, ОГРН, ИНН, КПП юридического лица/фамилия, имя, отчество (отчество указывается при наличии), ОГРНИП, ИНН индивидуального предпринимателя; место нахождения, место фактического осуществления деятельности)</xsl:when>
								<xsl:when test="aac:IdentKindAudit = 2">(наименование, ОГРН, ИНН, КПП юридического лица/фамилия, имя, отчество (отчество указывается при наличии), ОГРНИП, ИНН индивидуального предпринимателя/ фамилия, имя, отчество (отчество указывается при наличии), ИНН физического лица; место нахождения, место фактического осуществления деятельности, место жительства)</xsl:when>
							</xsl:choose>
						 </td>
					</tr>
					<tr class="delim"><td> </td></tr>
					...
					<tr>
						<td  class="border_bottom">
							<xsl:for-each select="aac:Questions">
					...
					<tr class="graphLittle" align="center">
						<td>(указывается в соответствии с пунктом 6 статьи 331 Таможенного кодекса Евразийского экономического союза)
						 </td>
					</tr>
					<tr class="delim"><td> </td></tr>
				</tbody>
			...
			<table>
				<tbody align="left" class="graphMain">
					<tr>
						...
						<td width="74%" class="border_bottom">
						...
						<xsl:choose>
							<xsl:when test="aac:StopProlongAudit">
								<xsl:for-each select="aac:StopProlongAudit">
									<tr>
										...
										<td width="30%">
											<xsl:choose>
												<xsl:when test="aac:ActionKind=1"><u>приостановления</u>/<s>продления</s>:</xsl:when>
												<xsl:when test="aac:ActionKind=2"><s>приостановления</s>/<u>продления</u>:</xsl:when>
												<xsl:otherwise>приостановления/продления:</xsl:otherwise>
											</xsl:choose>
										</td>
										<td width="1%" class="border_bottom"> </td>
										<td width="59%" class="border_bottom">
											<span class="normal">
												<xsl:call-template name="russian_date">
							...
							<xsl:otherwise>
								<tr>
									...
									<td width="1%" class="border_bottom"> </td>
									<td width="59%" class="border_bottom"> </td>
								</tr>
							</xsl:otherwise>
						</xsl:choose>
					</tbody>
			...
			<table>
				<tbody align="left" class="graphMain">
					<tr>
						<td>В ходе проверки проведены следующие мероприятия:</td>
					</tr>
					<tr class="delim_3"><td> </td></tr>
					<tr>
						<td  class="border_bottom">
			...
			<table>
				<tbody align="left" class="graphMain">
					<tr>
						<td>В ходе проверки установлено:</td>
					</tr>
					<tr class="delim_3"><td> </td></tr>
					<tr>
						<td  class="border_bottom">
			...
			<table>
				<tbody align="left" class="graphMain">
					<tr>
						<td>Возбуждены дела об административных правонарушениях </td>
					</tr>
					<tr class="delim_3"><td> </td></tr>
					<tr>
						<td  class="border_bottom">
			...
			<table>
				<tbody align="left" class="graphMain">
					<tr>
						<td>Выводы<xsl:if test="aac:IdentKindAudit = '2'"> и предложения:</xsl:if></td>
					</tr>
					<tr class="delim_3"><td> </td></tr>
					<tr>
						<td  class="border_bottom">
			...
			<table>
				<tbody align="left" class="graphMain">
					<tr>
						<td>Реквизиты текущего (расчетного) и иных счетов проверяемого лица (при наличии)</td>
					</tr>
					<tr class="delim_3"><td> </td></tr>
					<tr>
						<td  class="border_bottom">
			...
			<table>
				<tbody class="graphMain">
					<tr>
						...
						<td width="25%" class="border_bottom" align="center">
					...
					<tr>
						<td width="28%"><br/></td>
						<td width="25%" class="graphLittle" align="center">(количество приложений)</td>
						<td width="2%"></td>
						<td width="45%"> </td>
					</tr>
				</tbody>
			...
			<table>
				<tbody class="graphMain">
					<tr>
						...
						<td width="20%" class="border_bottom" align="center">
...
<xsl:template match="aac:AuditActions">
	<span class="normal"> 
		<xsl:value-of select="aac:ActionDescription"/> 
	</span>
...
<!-- Шаблон для типа aac:QuestionsType -->
<xsl:template match="aac:Questions">
	<xsl:if test="aac:QuestionCode">
		<span class="normal"> 
			(<xsl:value-of select="aac:QuestionCode"/>) 
		</span>
	</xsl:if>
	<xsl:if test="aac:QuestionText">
		<span class="normal"> 
			<xsl:value-of select="aac:QuestionText"/>
		</span>
	</xsl:if>
	<xsl:if test="aac:Note">
		<span class="normal">, примечания: 
	...
	<xsl:choose>
		<xsl:when test="adt_cat:AKParts or adt_cat:LawArticle">
			...
			<xsl:if test="adt_cat:LawArticle">
				...
				<xsl:if test="adt_cat:LawArticle/cat_ru:PrDocumentName">
					<xsl:value-of select="adt_cat:LawArticle/cat_ru:PrDocumentName"/>
				</xsl:if>
				<xsl:if test="adt_cat:LawArticle/cat_ru:PrDocumentNumber">
					№ <xsl:value-of select="adt_cat:LawArticle/cat_ru:PrDocumentNumber"/>
				</xsl:if>
				<xsl:if test="adt_cat:LawArticle/cat_ru:PrDocumentDate">
					от 
					<xsl:call-template name="russian_date">
						<xsl:with-param name="dateIn" select="adt_cat:LawArticle/cat_ru:PrDocumentDate" />
					</xsl:call-template>
				</xsl:if>
			</xsl:if>
		</xsl:when>
