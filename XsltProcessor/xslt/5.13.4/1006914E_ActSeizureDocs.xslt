						...
						<tbody>
							...
							<tr>
								<td>
									...
									<xsl:text>руководствуясь подпунктом 5 пункта 2 статьи 335 Таможенного кодекса Евразийского экономического союза, а также статьей 233 Федерального закона от __________ № _________ «О таможенном регулировании» и на основании постановления об изъятии документов </xsl:text>
									<xsl:call-template name="inlinetable">
										<xsl:with-param name="data">
							...
							<tr>
								<td>
									...
									<br/>
									<xsl:text>произведено изъятие следующих документов:</xsl:text>
									<br/>
							...
							<tr>
								<td>
									<br/>
									Приложения на <span class="value">&#160;<xsl:value-of select="asd:AdditionalSheetNumber"/>&#160;</span> листах.
								</td>
							</tr>
							<tr>
								<td>
