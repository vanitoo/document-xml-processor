...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:ra="urn:customs.ru:Information:CustomsDocuments:ResidentApplication:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template match="ra:IdentityCard">
      <table style="width: 100%">
         <xsl:choose>
            <xsl:when test="(cat_ru:IdentityCardName) or (cat_ru:IdentityCardCode)">
               <tr>
                  <td class="graphUnderline">
