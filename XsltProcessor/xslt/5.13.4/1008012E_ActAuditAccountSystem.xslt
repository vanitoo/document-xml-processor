...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:adt_cat="urn:customs.ru:Information:CustomsAuditDocuments:AuditCommonAggregateTypesCust:5.13.3" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.13.3" xmlns:aaas="urn:customs.ru:Information:CustomsDocuments:ActAuditAccountSystem:5.13.4">
						...
						<tbody>
							...
							<tr>
								<td style="text-align: justify" class="graphMain">
									...
									</xsl:call-template>в соответствии с частью 6 статьи 244  Федерального закона от 3 августа 2018 г. № 289-ФЗ «О  таможенном регулировании в Российской Федерации и о внесении изменений в отдельные законодательные акты Российской Федерации» (официальный интернет-портал правовой информации http://www.pravo.gov.ru, 04.08.2018) проведена  проверка наличия системы учета товаров и ведения учета товаров у </td>
							</tr>
							<tr>
								<td class="delim_3"> </td>
							</tr>
	...
	<xsl:template match="*" mode="passport">
		...
		<xsl:if test="cat_ru:IdentityCardSeries">
			...
			<xsl:if test="string-length(cat_ru:IdentityCardNumber) &gt; 0">&#160;</xsl:if>
		</xsl:if>
