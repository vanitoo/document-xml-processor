...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:catpi_ru="urn:customs.ru:Information:PriorInformation:PriorCommonAggregateTypes:5.13.4" xmlns:npir="urn:customs.ru:Information:PriorInformation:Notif_PIResult:5.13.4" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="npir:PI_DocResult">
		...
		<p>
			<span>Регистрационный идентификатор предварительной информации: </span>
