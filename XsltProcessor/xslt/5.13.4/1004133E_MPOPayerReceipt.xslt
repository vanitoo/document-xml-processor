...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:catComFin_ru="urn:customs.ru:Information:CommercialFinanceDocuments:CommercialFinanceCommonAgregateTypesCust:5.10.0" xmlns:cltComFin_ru="urn:customs.ru:Information:CommercialFinanceDocuments:CommercialFinanceCommonLeafTypesCust:5.8.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:mrec="urn:customs.ru:Information:ExchangeDocuments:MPOPayerReceipt:5.13.3" xmlns:mpco="urn:customs.ru:Information:CustomsDocuments:MPOCommon:5.13.3" xmlns:xs="http://www.w3.org/2001/XMLSchema">
									...
									<table width="100%">
										<tbody>
											<tr valign="top">
												...
												<td class="graphMain" width="17%"><xsl:text> таможенный пост </xsl:text></td>
												<td class="graphMain value">
									...
									<td class="graphMain bordered">
										<xsl:choose>
											<xsl:when test="mrec:TaxBase/mpco:TaxBaseKind=0">
												<xsl:value-of select="mrec:TaxBase/mpco:TaxBaseEuro"/><xsl:text> евро</xsl:text>
											</xsl:when>
											<xsl:when test="mrec:TaxBase/mpco:TaxBaseKind=1">
												<xsl:value-of select="mrec:TaxBase/mpco:TaxBaseWeight"/><xsl:text> кг</xsl:text>
											</xsl:when>
										</xsl:choose>
									</td>
									<td class="graphMain bordered">
					...
					<xsl:for-each select="mrec:PayTNVED">
						<table class="w190">
							<tr>
								...
								<td class="value graphMain" style="width:50%">
									<b><xsl:value-of select="mpco:ListNumeric"/></b>
								</td>
							</tr>
						</table>
						<table class="bordered w190">
							<tbody>
								...
								<xsl:for-each select="mrec:PaymentModeCode">
	...
	<xsl:template match="mrec:PaymentModeCode">
		<tr>
			<td class="graphMain bordered">
	...
	<xsl:template match="cat_ru:IdentityCard">
		<xsl:for-each select="cat_ru:IdentityCardSeries|cat_ru:IdentityCardNumber|cat_ru:IdentityCardDate|cat_ru:OrganizationName">
			<xsl:choose>
