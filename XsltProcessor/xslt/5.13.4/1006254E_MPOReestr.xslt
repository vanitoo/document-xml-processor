...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:mpco="urn:customs.ru:Information:CustomsDocuments:MPOCommon:5.13.3" xmlns:mpre="urn:customs.ru:Information:CustomsDocuments:MPOReestr:5.13.3">
						...
						<tbody>
							...
							<xsl:for-each select="mpre:MPODetail">
								...
								<tr valign="top">
									...
									<td class="bordered" rowspan="{$cols}">
										<xsl:for-each select="mpre:MPODecl/mpco:Consignor/cat_ru:Address/*">
											<xsl:value-of select="."/>
									...
									<td class="bordered" rowspan="{$cols}">
										<xsl:for-each select="mpre:MPODecl/mpco:Consignee/cat_ru:Address/*">
											<xsl:value-of select="."/>
											<xsl:if test="position()!=last()">, </xsl:if>
										</xsl:for-each>
									</td>
									...
									<td class="bordered" rowspan="{$cols}">
										<xsl:for-each select="mpre:MPODecl/mpco:Consignee/cat_ru:IdentityCard/*">
											<xsl:choose>
