...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:tpex="urn:customs.ru:Information:CustomsDocuments:TransferPersonExplanation:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
               ...
               <table border="0" style="width:190mm">
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td align="left" class="bold" style="width:95mm">
                           <xsl:value-of select="tpex:ExplanationPerson/tpex:IdentityCard/cat_ru:IdentityCardName"/>
                           <xsl:text> </xsl:text>
                           <xsl:value-of select="tpex:ExplanationPerson/tpex:IdentityCard/cat_ru:IdentityCardSeries"/>
                           <xsl:text> </xsl:text>
                           <xsl:value-of select="tpex:ExplanationPerson/tpex:IdentityCard/cat_ru:IdentityCardNumber"/>
                           <xsl:text> </xsl:text>
                                    
                            от 
                                    <xsl:call-template name="russian_date2">
                              <xsl:with-param name="dateIn" select="tpex:ExplanationPerson/tpex:IdentityCard/cat_ru:IdentityCardDate"/>
                           </xsl:call-template>
                           <br/>
                        </td>
                     </tr>
