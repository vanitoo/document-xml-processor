...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:ntp="urn:customs.ru:Information:ExchangeDocuments:NotifTobaccoPrices:5.10.0">
	...
	<xsl:template match="ntp:TaxPayer">
		...
		<xsl:apply-templates select="cat_ru:Address">
			<xsl:with-param name="titleIn" select="'Адрес организации'" />
		</xsl:apply-templates>
	...
	<xsl:template match="cat_ru:Address|ntp:FactAddress">
