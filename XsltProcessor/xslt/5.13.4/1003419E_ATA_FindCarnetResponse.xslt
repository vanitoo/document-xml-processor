...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:ata_ct="urn:customs.ru:Information:TransportDocuments:ATA:ATA_CommonTypes:5.13.1" xmlns:ata_findcr="urn:customs.ru:Information:TransportDocuments:ATA:ATA_FindCarnetResponse:5.13.4">
	...
	<xsl:template match="ata_findcr:CarnetInfo">
		...
		<tr>
			...
			<td class="graphMain bordered" style="vertical-align: middle" rowspan="{$kol_vo}">
				...
				<xsl:if test="ata_findcr:SubmissionMode=3">сформирован в рамказ СМЭВ</xsl:if>
