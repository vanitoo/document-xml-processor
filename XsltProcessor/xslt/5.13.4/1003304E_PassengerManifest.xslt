...
<xsl:stylesheet version="1.0" xmlns:catTrans_ru="urn:customs.ru:Information:TransportDocuments:TransportCommonAgregateTypesCust:5.12.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:passm="urn:customs.ru:Information:TransportDocuments:Air:PassengerManifest:5.12.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
							...
							<tbody>
								...
								<xsl:for-each select="passm:PassengerInfo">
									<tr>
										...
										<td align="center">
											<xsl:value-of select="passm:IdentityCard/cat_ru:IdentityCardSeries"/>
											<xsl:text> </xsl:text>
											<xsl:value-of select="passm:IdentityCard/cat_ru:IdentityCardNumber"/>
										</td>
										<td>
