                              ...
                              <tbody>
                                 ...
                                 <tr class="graphMain">
                                    ...
                                    <td class="underlined" style="width:20mm">
                                       <xsl:if test="sum(bol:Goods/bol:GrossWeightQuantity) != 0 ">
                                          <xsl:value-of select="format-number(sum(bol:Goods/bol:GrossWeightQuantity),'#.000000')"/> кг
												</xsl:if>
                                    </td>
