...
<xsl:stylesheet exclude-result-prefixes="pcnf cat_ru" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:pcnf="urn:customs.ru:Information:CommercialFinanceDocuments:PaymentConfirmation:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
                     ...
                     <tr>
                        <td>
                           ...
                           <xsl:if test="pcnf:PayerInfo/pcnf:IdentityCard">
                              <xsl:value-of select="pcnf:PayerInfo/pcnf:IdentityCard/cat_ru:IdentityCardName"/>: <xsl:value-of select="pcnf:PayerInfo/pcnf:IdentityCard/cat_ru:IdentityCardSeries"/> № <xsl:value-of select="pcnf:PayerInfo/pcnf:IdentityCard/cat_ru:IdentityCardSeries"/>
                              <br/>
                              <xsl:value-of select="pcnf:PayerInfo/pcnf:IdentityCard/cat_ru:IdentityCardNumber"/>
                              <br/>
									ВЫДАН <xsl:call-template name="russian_date">
                                 <xsl:with-param name="dateIn" select="pcnf:PayerInfo/pcnf:IdentityCard/cat_ru:IdentityCardDate"/>
                              </xsl:call-template>
                           </xsl:if>
                           <br/>
                           <br/>
