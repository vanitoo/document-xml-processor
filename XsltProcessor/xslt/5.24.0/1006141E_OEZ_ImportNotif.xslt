...
<xsl:stylesheet version="1.0" 
	...
	xmlns:impn="urn:customs.ru:Information:CustomsDocuments:OEZ_ImportNotif:5.24.0" 
	xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.24.0"
	xmlns:oeznr="urn:customs.ru:Information:CustomsDocuments:OEZ_NotifReg:5.24.0">
   ...
   <xsl:template match="impn:OEZ_ImportNotif">
      <html>
         <head>
            <title>Уведомление о ввозе товаров на территорию ОЭЗ и въезде средства транспорта / Уведомление о ввозе товаров на территорию ОЭЗ (ПОЭЗ), на участок территории опережающего развития, на земельный участок, предоставленный резиденту свободного порта Владивосток, на участок резидента Арктической зоны РФ</title>
            <style type="text/css">
					body
					{text-align: center;
					background: #cccccc;}
         ...
         <body>
            <div class="page">
               <xsl:if test="impn:DocSign='0'">
					  ...
					  <tbody>
						 <tr>
							...
							<td align="left" style="width:167mm" valign="top">
								...
								<br/>о ввозе товаров на территорию особой экономической зоны
								<br/>и въезде средства транспорта
							</td>
							<td>
								  ...
								  <tbody>
									 ...
									 <tr>
										<td align="center" class="graphLittle">
											(наименование/адрес резидента ОЭЗ (нерезидента ОЭЗ ОГРН, ИНН, КПП) или фамилия, имя, отчество (для физических лиц, ИНН, ОГРНИП))
										</td>
									 </tr>
								  </tbody>
							   </table>
				   ...
				   <table style="width:297mm">
					  <tbody>
						 ...
						 <xsl:if test="impn:TransportMeans/impn:TransportRegNumber">
							<tr>
							   <td align="left">Регистрационный номер прицепа/полуприцепа <u>
								  ...
								  <!--xsl:if test="impn:TransportMeans/impn:EmptyTransportRegNumber">, порожнего прицепа/полуприцепа <u>
               ...
               <xsl:if test="impn:DocSign='1' or impn:DocSign='2' or impn:DocSign='3'">
				   <table border="0" style="width:297mm">
					  <tbody>
						 <xsl:if test="impn:DocSign='1'">
							 <tr>
								...
								<td align="center" style="width:297mm" valign="top" colspan="2">
								   <b>Уведомление<br/>о ввозе товаров на территорию особой экономической зоны, на участок территории опережающего развития, на земельный участок, предоставленный резиденту свободного порта Владивосток, на участок резидента Арктической зоны Российской Федерации, на которых применяется таможенная процедура свободной таможенной зоны (за исключением портовой особой экономической зоны, отдельных участков морских портов, открытых для международного сообщения и захода иностранных морских судов, включая акваторию морского порта, и (или) отдельных участков территории аэропорта, открытого для приема и отправки воздушных судов, выполняющих международные воздушные перевозки, находящиеся на территории свободного порта Владивосток, в Арктической зоне Российской Федерации, на которых применяется таможенная процедура свободной таможенной зоны, установленная для портовой особой экономической зоны, земельного участка, прилегающего к автомобильному или железнодорожному пункту пропуска свободного порта Владивосток, Арктической зоны Российской Федерации, на котором применяется таможенная процедура свободной таможенной зоны, установленная для логистической особой экономической зоны)</b><br/><br/>
								</td>
							 </tr>
						 </xsl:if>
						 <xsl:if test="impn:DocSign='2'">
							 <tr>
								<!--Head-->
								<td align="center" style="width:297mm" valign="top" colspan="2">
								   <b>Уведомление<br/>о ввозе товаров на территорию портовой особой экономической зоны</b><br/><br/>
								</td>
							 </tr>
						 </xsl:if>
							   ...
							   <table style="width:130mm">
								  <tbody>
									 ...
									 <tr>
										<td align="center" class="graphLittle">
											<xsl:if test="impn:DocSign='1'">
												(резидент особой экономической зоны, резидент территории опережающего развития, резидент свободного порта Владивосток, резидент Арктической зоны Российской Федерации (далее - резидент) или лицо, им уполномоченное)
											</xsl:if>
											<xsl:if test="impn:DocSign='2'">
												(резидент портовой особой экономической зоны (далее - резидент) или лицо, им уполномоченное)
											</xsl:if>
											<xsl:if test="impn:DocSign='3'">
												(резидент портового, логистического участка Арктической зоны Российской Федерации (далее - резидент) или лицо, им уполномоченное)
											</xsl:if>
										</td>
									 </tr>
								  </tbody>
						 ...
						 <tr>
							<td align="left">
								...
								<xsl:call-template name="inlinetable">
									...
									<xsl:with-param name="data_align" select="'center'"/>
									<xsl:with-param name="description" select="'(место нахождения (адрес))'"/>
									<xsl:with-param name="width" select="'120mm'"/>
								</xsl:call-template> согласно следующим сведениям:
							</td>
						 </tr>
					  </tbody>
				    </table>
					  ...
					  <tbody>
						 ...
						 <tr align="left">
							<td align="left" style="width:50%" valign="top" colspan="2">
								...
								<u><xsl:if test="impn:TransportMeans/impn:TransportRegNumber">  
									<xsl:for-each select="impn:TransportMeans/impn:TransportRegNumber">
										<xsl:apply-templates select="."/> 
									</xsl:for-each>
								</xsl:if>
								<xsl:if test="impn:TransportMeans/impn:EmptyTransportRegNumber">, порожнего прицепа/полуприцепа 
									<xsl:for-each select="impn:TransportMeans/impn:EmptyTransportRegNumber">
										<xsl:apply-templates select="."/> 
									</xsl:for-each>
								</xsl:if>
								<xsl:if test="not(impn:TransportMeans/impn:TransportRegNumber) and not(impn:TransportMeans/impn:TransportRegNumber)">-</xsl:if></u>
							</td>
						 </tr>
						 <tr align="left">
							<td align="left" style="width:50%" valign="top" colspan="2">
								Без транспортного средства (багаж) 
								<u><xsl:if test="impn:TransportMeans/impn:PersonDetails">
									<xsl:apply-templates select="impn:TransportMeans/impn:PersonDetails/cat_ru:PersonSurname"/> 
									<xsl:apply-templates select="impn:TransportMeans/impn:PersonDetails/cat_ru:PersonName"/> 
									<xsl:apply-templates select="impn:TransportMeans/impn:PersonDetails/cat_ru:PersonMiddleName"/>
								</xsl:if>
								<xsl:if test="impn:TransportMeans/impn:PersonID">, <xsl:apply-templates select="impn:TransportMeans/impn:PersonID"/></xsl:if>
								<xsl:if test="not(impn:TransportMeans/impn:PersonDetails) and not(impn:TransportMeans/impn:PersonID)">-</xsl:if></u>
							</td>
						 </tr>
						 <tr align="left">
							<td align="left" style="width:50%" valign="top" colspan="2">
								Сборный груз 
								<u><xsl:choose>
									<xsl:when test="impn:CombinedCargo='1'">ввоз товаров в составе сборного груза</xsl:when>
                   ...
                   <table style="width:297mm">
                     <tbody>
                        <tr>
                           ...
                           <td class="tdBorder" width="25%">Примечание (при наличии)</td>
                        </tr>
                        <tr align="center">
                           <td class="tdBorder">1</td>
                           <td class="tdBorder">2</td>
				   ...
				   <table style="width:297mm">
					 <tbody>
						<tr>
						   <td align="left"><br/>Прошу провести идентификацию в отношении следующих товаров при их ввозе на территорию участка 
								<xsl:call-template name="inlinetable">
									<xsl:with-param name="data">
										<xsl:for-each select="impn:GoodsInfo[impn:IdentificationSign='1' or impn:IdentificationSign='true' or impn:IdentificationSign='t']">
											<xsl:number value="position()"/>
											<xsl:if test="position()!=last()">, </xsl:if>
										</xsl:for-each>
									</xsl:with-param>
									<xsl:with-param name="data_align" select="'center'"/>
									<xsl:with-param name="description" select="'(номер товара из графы № 1 Таблицы Сведения о ввозимых товарах)'"/>
									<xsl:with-param name="width" select="'100mm'"/>
								</xsl:call-template>
								<br/><br/>
						   </td>
							...
							<table>
								 <tbody>
									<tr>
									   ...
									   <td class="tdBorder" width="40%">Номер, дата документа</td>
									   <td class="tdBorder" width="40%">Количество листов документа</td>
									</tr>
									<tr align="center">
									   <td class="tdBorder">1</td>
									   <td class="tdBorder">2</td>
									...
									<xsl:for-each select="impn:DocList">
									   ...
									   <tr>
										  ...
										  <td class="tdBorder">
											 <xsl:apply-templates select="impn:Pages"/>
										  </td>
									   </tr>
									</xsl:for-each>
								 </tbody>
   ...
   <xsl:template match="RUScat_ru:IdentityCard | impn:TransportMeans/impn:PersonID">
