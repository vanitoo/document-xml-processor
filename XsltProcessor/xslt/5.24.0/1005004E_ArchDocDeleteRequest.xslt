...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ct="urn:customs.ru:Information:EArchDocuments:EADCommonTypes:5.22.0" xmlns:addel="urn:customs.ru:Information:EArchDocuments:ArchDocDeleteRequest:5.22.0">
	<!-- Шаблон для типа ArchDocDeleteRequestType -->
	<xsl:template match="addel:ArchDocDeleteRequest">
		<html>
			<head>
				<style>
									body {
						...
						<tbody>
							<tr>
								<td align="center" class="graphMain">
									<font size="4">
										<b>Запрос на удаление документа из архива</b>
									</font>
								</td>
							</tr>
						</tbody>
