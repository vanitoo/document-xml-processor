				...
				<div class="page">
					...
					<table>
						<tbody align="left" class="graphMain">
							...
							<tr align="center" class="graphHeader">
								<td>таможенного органа о результатах проведения мониторинга сведений, имеющихся в его распоряжении и полученных от лиц, участвующих в эксперименте по мониторингу таких сведений, из систем учета товаров</td>
							</tr>
						...
						<tbody class="graphMain">
							<tr align="center">
								<td width="40%" class="value">
									<xsl:if test="cmc:CustomsConclusionHeadPerson/cat_ru:PersonPost">
										<xsl:apply-templates select="cmc:CustomsConclusionHeadPerson/cat_ru:PersonPost"/>
										<xsl:text>, </xsl:text>
									</xsl:if>
									<xsl:apply-templates select="cmc:CustomsConclusionHeadPerson" mode="signature"/>
								</td>
								<td width="5%"> </td>
