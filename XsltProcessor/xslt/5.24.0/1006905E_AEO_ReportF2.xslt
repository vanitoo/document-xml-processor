...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" 
                xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.24.0" 
                xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" 
                xmlns:AEO_rf2="urn:customs.ru:Information:AEO_ReportF2:5.24.0" 
                xmlns:RUDECLcat="urn:customs.ru:RUDeclCommonAggregateTypesCust:5.24.0" 
...
veE8sJYUeSvgSXRbUqTU9n38A+DPVw6P+zXcAAAAAElFTkSuQmCC'"/>
                    ...
                    <xsl:choose>
                      <xsl:when test="(AEO_rf2:TableF2_2/AEO_rf2:ColumnIndicators/AEO_rf2:NetAssets &lt; 0)">
                        (<xsl:value-of select="translate(translate(format-number(translate(AEO_rf2:TableF2_2/AEO_rf2:ColumnIndicators/AEO_rf2:NetAssets, '-', '') * 1000000,'#,###'), ',', ' '), '.', ',')"/>)
                      </xsl:when>
                      <xsl:otherwise>
                        <xsl:value-of select="translate(translate(format-number(translate(AEO_rf2:TableF2_2/AEO_rf2:ColumnIndicators/AEO_rf2:NetAssets, '-', '') * 1000000,'#,###'), ',', ' '), '.', ',')"/>
                      </xsl:otherwise>
                    ...
                    <xsl:value-of select="translate(translate(format-number(AEO_rf2:TableF2_2/AEO_rf2:MinColumnIndicators/AEO_rf2:NetAssets * 1000000,'#,###'), ',', ' '), '.', ',')"/>
									</xsl:if>
								</td>
                    ...
                    <xsl:choose>
                      <xsl:when test="(AEO_rf2:TableF2_2/AEO_rf2:ColumnIndicators/AEO_rf2:ShareCapital &lt; 0)">
                        (<xsl:value-of select="translate(translate(format-number(translate(AEO_rf2:TableF2_2/AEO_rf2:ColumnIndicators/AEO_rf2:ShareCapital, '-', '') * 1000000,'#,###'), ',', ' '), '.', ',')"/>)
                      </xsl:when>
                      <xsl:otherwise>
                        <xsl:value-of select="translate(translate(format-number(translate(AEO_rf2:TableF2_2/AEO_rf2:ColumnIndicators/AEO_rf2:ShareCapital, '-', '') * 1000000,'#,###'), ',', ' '), '.', ',')"/>
                      </xsl:otherwise>
                    ...
                    <xsl:value-of select="translate(translate(format-number(AEO_rf2:TableF2_2/AEO_rf2:MinColumnIndicators/AEO_rf2:ShareCapital * 1000000,'#,###'), ',', ' '), '.', ',')"/>
									</xsl:if>
								</td>
                    ...
                    <xsl:choose>
                      <xsl:when test="( AEO_rf2:TableF2_2/AEO_rf2:ColumnIndicators/AEO_rf2:BasicToolsRest &lt; 0)">
                        (<xsl:value-of select="translate(translate(format-number(translate(AEO_rf2:TableF2_2/AEO_rf2:ColumnIndicators/AEO_rf2:BasicToolsRest, '-', '') * 1000000,'#,###'), ',', ' '), '.', ',')"/>)
                      </xsl:when>
                      <xsl:otherwise>
                        <xsl:value-of select="translate(translate(format-number(translate(AEO_rf2:TableF2_2/AEO_rf2:ColumnIndicators/AEO_rf2:BasicToolsRest, '-', '') * 1000000,'#,###'), ',', ' '), '.', ',')"/>
                      </xsl:otherwise>
                    ...
                    <xsl:value-of select="translate(translate(format-number(AEO_rf2:TableF2_2/AEO_rf2:MinColumnIndicators/AEO_rf2:BasicToolsRest * 1000000,'#,###'), ',', ' '), '.', ',')"/>
									</xsl:if>
								</td>
