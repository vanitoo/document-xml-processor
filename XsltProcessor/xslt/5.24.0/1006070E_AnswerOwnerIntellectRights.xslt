							...
							<table>
								<tbody>
									...
									<tr align="center">
										...
										<td class="graphMain bordered">Номер партии товаров / накладной реестра ЭГ</td>
									...
									<xsl:for-each select="aoir:GoodsWithSignOfViolation">
										<tr>
											...
											<td class="graphMain bordered">
												<xsl:apply-templates select="aoir:Consigment"/>
											</td>
											<td class="graphMain bordered">
