				...
				<div class="page">
					...
					<table width="100%">
						<tbody>
							...
							<xsl:for-each select="npu:PrevConsignment/npu:PrevGoods[npu:GoodsDate]">
								<xsl:sort select="npu:GoodsDate" order="descending"/>
								<xsl:if test="position() &lt;= 5">
									<tr>
										<td class="value">
											<xsl:apply-templates select="npu:GoodsDate" mode="PrevGoods"/>
										</td>
									</tr>
									<tr>
										<td class="delim_3"/>
