...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:mpco="urn:customs.ru:Information:CustomsDocuments:MPOCommon:5.24.0" xmlns:mpf="urn:customs.ru:Information:CustomsDocuments:MPOFact:5.24.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.24.0">
		...
		<html>
			...
			<body>
				<div class="page">
					...
					<xsl:if test="mpf:RepeatSign">
						<table class="w190">
							<tr>
								<td class="annot graphMain" style="width:50%">Признак повторной подачи</td>
								<td class="value graphMain" style="width:50%">
									<xsl:choose>
										<xsl:when test="mpf:RepeatSign = 1 or translate(substring(mpf:RepeatSign, 1, 1), 't', 'T') = 'T'">есть</xsl:when>
										<xsl:when test="mpf:RepeatSign = 0 or translate(substring(mpf:RepeatSign, 1, 1), 'f', 'F') = 'F'">нет</xsl:when>
									</xsl:choose>
								</td>
							</tr>
						</table>
