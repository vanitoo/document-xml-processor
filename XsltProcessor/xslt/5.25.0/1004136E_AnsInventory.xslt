...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:ani="urn:customs.ru:Information:ExchangeDocuments:AnsInventory:5.24.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
						...
						<tbody>
							...
							<xsl:for-each select="ani:CustomsCostInf">
								...
								<tr valign="top">
									...
									<td class="bordered">
										<xsl:for-each select="ani:DocSign">
					...
					<xsl:if test="ani:Documents">
						...
						<table width="100%">
							<tbody>
								<tr valign="top" align="center">
									<td class="bordered" width="5%">№ п/п</td>
									<td class="bordered">Направление ТК</td>
	...
	<xsl:template match="ani:DocSign">
		<xsl:choose>
