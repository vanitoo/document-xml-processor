							...
							<tbody>
								...
								<tr>
									<table align="center" border="1" cellpadding="0" cellspacing="0" style="width:245mm;table-layout: fixed;word-break: break-all;">
										<tbody>
											<tr>
												<td align="center" class="graph" style="width:10%">Кодовое<br/>обозначение<br/>вида грузовой<br/>операции</td>
												<td align="center" class="graph" style="width:9%">Порядковый<br/>номер<br/>перевозчика</td>
												<td align="center" class="graph" style="width:11%">Признак<br/>перегрузки<br/>товаров из<br/>одного<br/>контейнера<br/>в другой</td>
												<td align="center" class="graph" style="width:6%">Код<br/>страны</td>
												<td align="center" class="graph" style="width:10%">Наименование<br/>населенного<br/>пункта</td>
												<td align="center" class="graph" style="width:10%">Кодовое<br/>обозначение<br/>таможенного<br/>органа</td>
												<td align="center" class="graph" style="width:12%">Кодовое<br/>обозначение<br/>железнодорожной<br/>станции</td>
												<td align="center" class="graph" style="width:22%">Сведения о транспортном<br/>средстве, с использованием<br/>которого продолжается<br/>перевозка (транспортировка)<br/>товаров</td>
												<td align="center" class="graph" style="width:10%">Описание<br/>грузовой<br/>операции</td>
											</tr>
									...
									<table align="center" border="1" cellpadding="0" cellspacing="0" style="width:245mm;table-layout: fixed;word-break: break-all;">
										<tbody>
											<tr>
												...
												<td align="center" class="graph" style="width:10%mm">Наименование</td>
												...
												<td align="center" class="graph" style="width:6%">Номера<br/>контей-<br/>неров</td>
												...
												<td align="center" class="graph" style="width:6%">Признак<br/>свободы<br/>от<br/>прим-я<br/>запр.<br/>и огр-й</td>
											</tr>
