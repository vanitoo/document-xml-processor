					...
					<xsl:if test="stz_new:ProducedGoods">
						<tr align="left" valign="top">
							<td class="graphMain bordered" colspan="7">
								...
								<xsl:text> </xsl:text>
								<xsl:text>Товары, изгтовленные (полученные) на территории свободной экономической зоны</xsl:text>
							</td>
						</tr>
					...
					<td align="center" class="title">
						<font size="4">
							<b>
								...
								<xsl:text>территории свободной экономической зоны на территориях Донецкой Народной Республики, Луганской Народной Республики, Запорожской области и Херсонской области, и товарах, изготовленных (полученных) из товаров, помещенных под таможеную процедуру свободной таможенной зоны</xsl:text>
							</b>
						</font>
					</td>
				</tr>
