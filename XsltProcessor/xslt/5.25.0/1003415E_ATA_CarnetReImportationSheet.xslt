						...
						<tr>
							...
							<td class="graphMain bordered" style="width:30%">
								<font size="3">
									...
									<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:CarnetNumber"/>
								</font>
							</td>
						</tr>
						<tr>
							<td class="graphMain" style="width:100%" colspan="2">
								<font size="3">
									...
									<u>
										<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:VoucherNumber"/>
									</u>
									<b> КНИЖКА АТА № </b>
									<u>
										<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:CarnetNumber"/>
						...
						<tr>
							<td class="graphMain bordered" style="width:3mm; vertical-align: middle; word-break: break-all" rowspan="2" bgcolor="#e3e3e3" align="center">
								<font size="2">
									<b>
										<xsl:choose>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='importation'">IMPORTATION</xsl:when>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='reexportation'">REEXPORTATION</xsl:when>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='exportation'">EXPORTAT ION</xsl:when>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='reimportation'">REIMPORTATION</xsl:when>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='transitOpen'">TRANSIT<br/><br/>OPEN</xsl:when>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='transitClose'">TRANSIT<br/><br/>CLOSE</xsl:when>
							...
							<td class="graphMain bordered" style="width:3mm; vertical-align: middle; word-break: break-all" rowspan="2" bgcolor="#e3e3e3" align="center">
								<b>
									<font size="2">
										<xsl:choose>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='importation'">ВВОЗ</xsl:when>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='reexportation' or //ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='exportation'">ВЫВОЗ</xsl:when>
											<xsl:when test="ata_cris:Sheet/ata_ct:TearSheetType='reimportation'">ОБРАТНЫЙ<br/><br/>ВВОЗ</xsl:when>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='transitOpen' or //ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='transitClose'">ТРАНЗИТ</xsl:when>
											<xsl:otherwise>ОБРАТНЫЙ<br/><br/>ВВОЗ</xsl:otherwise>
										</xsl:choose>
									</font>
									<font size="1">
										<xsl:if test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='reexportation'"><br/>(ранее<br/><br/>ввезенных<br/><br/>товаров)</xsl:if>
									</font>
								</b>
							</td>
								...
								<table class="w190">
									<tr>
										...
										<td class="value graphMain" style="width:72mm" colspan="2">
											<xsl:for-each select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_ct:GoodsNumbers">
									...
									<tr>
										<td class="annot graphMain" style="width:182mm" colspan="4">
											<br/>
										</td>
									</tr>
									<tr>
										...
										<td class="value graphMain" style="width:20mm" align="center">
											<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_cris:ReimportConfirmationDoc/ata_ct:VoucherNumbers"/>
										</td>
										<td class="annot graphMain" style="width:52mm">
											<b>of this Carnet have been re-imported /</b>
										</td>
									</tr>
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
										<td class="annot graphMain" style="width:107mm">
											<b>временно вывезенные в соответствии с отрывным(и) документом(ами) № </b>
										</td>
										<td class="annot graphMain" style="width:72mm" colspan="2" align="right">
											<b>данной Книжки, были обратно ввезены.</b>
										</td>
									</tr>
								</table>
							</td>
							...
							<td class="graphMain bordered" style="width:142mm" colspan="4" bgcolor="#e3e3e3">
								<table class="w190" cellspacing="5">
									...
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
										<td class="annot graphMain" style="width:139mm">
											<xsl:apply-templates select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:CustomsInfo/ata_ct:CustomsMark"/>
											<xsl:if test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:CustomsInfo/ata_ct:Type">
												<table class="w190">
													<tr>
														<td class="value graphMain">Date and Time of signing / Дата и время подписания:</td>
														<td class="value graphMain">
															<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:CustomsInfo/ata_ct:Type"/>
														</td>
													</tr>
												</table>
											</xsl:if>
								...
								<table class="w190">
									<tr>
										...
										<td class="value graphMain" style="width:49mm">
											<xsl:apply-templates select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:CustomsInfo/ata_ct:CustomsPersonRequisites/ata_ct:CustomsInfo"/>
										</td>
									</tr>
									<tr>
								...
								<table class="w190">
									<tr>
										...
										<td class="value graphMain" style="width:37mm">
											<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_ct:DeclarantSign/ata_ct:Place"/>
										</td>
									</tr>
									<tr>
								...
								<table class="w190">
									<tr>
										...
										<td class="value graphMain" style="width:47mm">
											<xsl:for-each select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:CustomsInfo/ata_ct:CustomsPersonRequisites/ata_ct:CustomsPersonSignature/ata_ct:IssueDate">
								...
								<table class="w190">
									<tr>
										...
										<td class="value graphMain" style="width:39mm">
											...
											<xsl:for-each select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:CustomsInfo/ata_ct:CustomsPersonRequisites/ata_ct:CustomsPersonSignature">
								...
								<b>
									<font size="2">
										<xsl:choose>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='importation'">ВВОЗ</xsl:when>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='reexportation' or //ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='exportation'">ВЫВОЗ</xsl:when>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='reimportation'">ОБРАТНЫЙ<br/><br/>ВВОЗ</xsl:when>
											<xsl:when test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='transitOpen' or //ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TearSheetType='transitClose'">ТРАНЗИТ</xsl:when>
											<xsl:otherwise>ОБРАТНЫЙ<br/><br/>ВВОЗ</xsl:otherwise>
										</xsl:choose>
									</font>
							...
							<td class="graphMain bordered" style="width:100mm" colspan="2">
								<table class="w190">
									<tr>
										...
										<td class="annot graphMain" style="width:97mm">
											<b>ISSUED BY / Кем выдано</b><br/><br/>
										</td>
									</tr>
									<tr>
										<td class="value graphMain" style="width:97mm">
								...
								<table class="w190">
									...
									<tr>
										...
										<td class="value graphMain" style="width:81mm">
											<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:TransportMeans"/>
										</td>
									</tr>
								</table>
							</td>
							<td class="graphMain bordered" style="width:100mm" rowspan="3" bgcolor="#e3e3e3">
								<table class="w190">
									...
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
										<td class="value graphMain" style="width:97mm">
											<xsl:for-each select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_cris:ExpVoucherNum">
									...
									<xsl:for-each select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:CustomsInfo">
							...
							<td class="graphMain bordered" style="width:84mm">
								<table class="w190">
									...
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
										<td class="value graphMain" style="width:81mm">
											<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:Sheet/ata_ct:PackingDetails"/>
										</td>
									</tr>
								</table>
							</td>
							...
							<td class="graphMain bordered" style="width:84mm; border-bottom:0">
								<table class="w190">
									...
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
										<td class="value graphMain" style="width:81mm">
											<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_cris:ExpVoucherNum"/>
										</td>
									</tr>
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
									...
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
										<td class="value graphMain" style="width:81mm">
											<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_cris:ProcessedGoodsNum"/>
										</td>
									</tr>
									<xsl:if test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_cris:PartiallyClosedGoodsNum">
										<tr>
											<td class="annot graphMain" style="width:3mm"/>
											<td class="value graphMain" style="width:81mm">
												partially closed goods / товары, снимаемые частично: <xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_cris:PartiallyClosedGoodsNum"/>
											</td>
										</tr>
									</xsl:if>
									<tr>
									...
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
										<td class="value graphMain" style="width:81mm">
											<xsl:for-each select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_cris:NonReimportingDtGoodsNum">
												<xsl:value-of select="ata_ct:ListNumber"/>
												<xsl:text> </xsl:text>
											</xsl:for-each>
										</td>
									...
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
										<td class="value graphMain" style="width:81mm">
											remain / остаток: <xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_cris:NonReimportingRemainGoodsNum"/>
										</td>
									</tr>
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
									...
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
										<td class="value graphMain" style="width:81mm">
											<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_cris:ReimportedGoodsNum"/>
										</td>
									</tr>
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
									...
									<tr>
										<td class="annot graphMain" style="width:3mm"/>
										<td class="value graphMain" style="width:81mm">
											<xsl:for-each select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:ReimportConfirmationDoc/ata_ct:DT">
												<xsl:apply-templates select="."/>
												<xsl:if test="position()!=last()">, </xsl:if>
											</xsl:for-each>
											<xsl:if test="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:ReimportConfirmationDoc/ata_ct:DT and //ata_cris:ATA_CarnetReImportationSheet/ata_cris:ReimportConfirmationDoc/ata_ct:VoucherNumbers">, </xsl:if>
											<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:ReimportConfirmationDoc/ata_ct:VoucherNumbers"/>
										</td>
									</tr>
									<tr>
										<td class="annot graphMain" style="width:84mm" colspan="2">
							...
							<td class="graphMain bordered" style="width:100mm; border-left:0; vertical-align:bottom">
								<table class="w190">
									<tr>
										...
										<td class="value graphMain" style="width:20mm" align="center">
											<xsl:for-each select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_ct:DeclarantSign/ata_ct:FillingDate">
												<xsl:value-of select="substring(.,1,4)"/>
												<xsl:text> / </xsl:text>
												<xsl:value-of select="substring(.,6,2)"/>
												<xsl:text> / </xsl:text>
								...
								<table class="w190">
									<tr>
										...
										<td class="value graphMain" style="width:90mm">
											<xsl:value-of select="//ata_cris:ATA_CarnetReImportationSheet/ata_cris:DeclarantInfo/ata_ct:DeclarantSign/ata_ct:DeclarantName"/>
										</td>
									</tr>
									<tr>
