			...
			<body>
				<div class="page" style="width: {$w}mm;">
					...
					<xsl:if test="notccz:Applicant">
						<div class="title marg-top">Сведения об инициаторе вывоза товаров ЕАЭС (назначенном операторе почтовой связи) </div>
						<div>
					...
					<xsl:if test="notccz:RegistrationNumber">
						<div class="title marg-top">Опись документов по которой принято решение</div>
						<div>
