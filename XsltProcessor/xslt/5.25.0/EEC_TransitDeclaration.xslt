...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:csdo="urn:EEC:M:SimpleDataObjects:v0.4.14" xmlns:ccdo="urn:EEC:M:ComplexDataObjects:v0.4.14" xmlns:casdo="urn:EEC:M:CA:SimpleDataObjects:v1.8.1" xmlns:cacdo="urn:EEC:M:CA:ComplexDataObjects:v1.8.1" xmlns:td="urn:EEC:R:048:TransitDeclaration:v1.0.0">
				...
				<td class="graph" colspan="6" style="width:{190*$k}mm;border:solid 0.8pt black;">
					<table cellpadding="0" cellspacing="0" style="width:100%;">
						<tr>
							...
							<td class="graph" valign="top" style="width:{86*$k}mm;background:#FFFFFF; border-bottom:1pt solid black; border-right: solid 0.8pt black;">
	...
	<xsl:template match="cacdo:TransitGuaranteeDocDetails">
		...
		<br/>
		<xsl:apply-templates select="casdo:GuaranteeAmount"/>
		<xsl:text> </xsl:text>
	...
	<xsl:template match="cacdo:RegisterDocumentIdDetails">
		...
		<xsl:text> </xsl:text>
		<xsl:apply-templates select="casdo:ReregistrationCode"/>
	</xsl:template>
			...
			<table cellpadding="0" cellspacing="0" style="width:100%;border:solid 0pt black;">
				...
				<tr valign="top">
					...
					<td class="graph" colspan="2" style="width:{122*$k}mm;border-bottom:solid 0.8pt black; background:#FFFFFF;word-break: break-all;">
						...
						<xsl:if test="cacdo:TDPresentedDocDetails"></xsl:if>
