...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:vtstek="urn:customs.ru:Information:SQDocuments:FsVtsTekLicense:5.25.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.24.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
						...
						<table style="border:1px solid;" class="w190 FsTek">
							<tbody>
								...
								<xsl:for-each select="vtstek:GoodsDescription">
									<xsl:sort select="vtstek:ListNumber" order="ascending" data-type="number"/>
									<xsl:sort select="vtstek:GoodsNumber" order="ascending" data-type="number"/>
									<tr>
										<td>
												...
												<tbody>
													...
													<tr>
														<td colspan="3" style="border-left:0;border-top:0;border-right:1px solid; border-bottom:1px solid;">
															...
															<br/>
															<xsl:value-of select="vtstek:Quantity/RUScat_ru:MeasureUnitQualifierName"/>
															<xsl:if test="vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName">
																<xsl:choose>
																	<xsl:when test="not (vtstek:Quantity/RUScat_ru:MeasureUnitQualifierName)">
																		<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName"/>
																	</xsl:when>
																	<xsl:when test="(vtstek:Quantity/RUScat_ru:MeasureUnitQualifierName) and (vtstek:Quantity/RUScat_ru:MeasureUnitQualifierName!=vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName)">
																		<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName"/>
																	</xsl:when>
																	<xsl:when test="(vtstek:Quantity/RUScat_ru:GoodsQuantity) and (vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity)
	and (vtstek:Quantity/RUScat_ru:GoodsQuantity!=vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity)">
																		<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName"/>
																	</xsl:when>
																	<xsl:when test="(vtstek:Quantity/RUScat_ru:GoodsQuantity) and not(vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity)">
																		<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName"/>
																	</xsl:when>
																	<xsl:when test="not(vtstek:Quantity/RUScat_ru:GoodsQuantity) and (vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity)">
																		<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName"/>
																	</xsl:when>
																</xsl:choose>
															</xsl:if>
															<xsl:if test="not(vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName) and not(vtstek:Quantity/RUScat_ru:MeasureUnitQualifierName)">	
																<xsl:value-of select="vtstek:Quantity/RUScat_ru:MeasureUnitQualifierCode"/>
																<xsl:if test="vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierCode">
																	<xsl:choose>
																		<xsl:when test="not (vtstek:Quantity/RUScat_ru:MeasureUnitQualifierCode)">
																			<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierCode"/>
																		</xsl:when>
																		<xsl:when test="(vtstek:Quantity/RUScat_ru:MeasureUnitQualifierCode) and (vtstek:Quantity/RUScat_ru:MeasureUnitQualifierCode!=vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierCode)">
																			<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierCode"/>
																		</xsl:when>
																		<xsl:when test="(vtstek:Quantity/RUScat_ru:GoodsQuantity) and (vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity) and (vtstek:Quantity/RUScat_ru:GoodsQuantity!=vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity)">
																			<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierCode"/>
																		</xsl:when>
																		<xsl:when test="(vtstek:Quantity/RUScat_ru:GoodsQuantity) and not(vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity)">
																			<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierCode"/>
														...
														<td colspan="3" style="border-left:0;border-top:0;border-right:0; border-bottom:1px solid;">
															17. Количество
															<br/>
															<xsl:value-of select="vtstek:Quantity/RUScat_ru:GoodsQuantity"/>
															<xsl:if test="vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity">														
																<xsl:choose>
																	<xsl:when test="not (vtstek:Quantity/RUScat_ru:GoodsQuantity)">
																		<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity"/>
																	</xsl:when>
																	<xsl:when test="(vtstek:Quantity/RUScat_ru:GoodsQuantity) and (vtstek:Quantity/RUScat_ru:GoodsQuantity!=vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity)">
																		<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity"/>
																	</xsl:when>
																	<xsl:when test="(vtstek:Quantity/RUScat_ru:MeasureUnitQualifierName) and (vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName) and (vtstek:Quantity/RUScat_ru:MeasureUnitQualifierName!=vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName)">
																		<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity"/>
																	</xsl:when>
																	<xsl:when test="(vtstek:Quantity/RUScat_ru:MeasureUnitQualifierName) and not(vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName)">
																		<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity"/>
																	</xsl:when>
																	<xsl:when test="not(vtstek:Quantity/RUScat_ru:MeasureUnitQualifierName) and (vtstek:SupplementaryQuantity/RUScat_ru:MeasureUnitQualifierName)">
																		<br/><xsl:value-of select="vtstek:SupplementaryQuantity/RUScat_ru:GoodsQuantity"/>
																	</xsl:when>
																</xsl:choose>
															</xsl:if>
													...
													<tr>
														...
														<td colspan="3" style="border-left:0;border-top:0;border-right:0; border-bottom:0;">
															...
															<br/>
															<xsl:value-of select="vtstek:StatisticalCost"/>
														</td>
													</tr>
												</tbody>
											</table>
									...
									<td>
										<table width="100%">
											<tr>
												...
												<td style="border-bottom:1px solid;">
													<xsl:value-of select="sum(vtstek:GoodsDescription/vtstek:CustomsCost)"/>
												</td>
											</tr>
										</table>
									</td>
					...
					<div class="page" style="font-family: Courier New;">
						...
						<table>
							<tr>
								...
								<td style="border-bottom:1px solid;">
									<xsl:value-of select="sum(vtstek:GoodsDescription/vtstek:StatisticalCost)"/> USD
								</td>
							</tr>
						</table>
						<table>	
