...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.22.0" xmlns:ngact="urn:customs.ru:Information:CustomsDocuments:NotifGoodsAcceptTime:5.22.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.22.0">
	...
	<xsl:template match="//*[local-name()='NotifGoodsAcceptTime']//*" priority="-1">
		<xsl:variable name="xpath">
		...
		<html>
			...
			<body>
				<div class="page">
					...
					<xsl:apply-templates select="ngact:Date" mode="russian_date"/>
					...
					<xsl:if test="ngact:PrecedingNotifNumber">
						...
						<xsl:apply-templates select="ngact:PrecedingNotifNumber"/>
						<br/>
						<br/>
					</xsl:if>
