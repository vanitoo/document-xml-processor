...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.22.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.22.0" xmlns:rd="urn:customs.ru:Information:CommercialFinanceDocuments:RecyclingDetails:5.22.0">
					...
					<div class="pageAlbum">
						...
						<table border="1" style="table-layout:fixed;word-wrap:break-word;width:297mm;">
							<tr>
								...
								<th width="7%">Номер бланка паспорта транс-<br/>портного средства (паспорта шасси транс-<br/>портного средства) или уни-<br/>кальный номер электрон-<br/>ного паспорта транс-<br/>портного средства (электрон-<br/>ного паспорта шасси транспорт-<br/>ного средства) (при наличии)</th>
							</tr>
							<tr>
							...
							<xsl:for-each select="rd:UtilCollDetails">
								<tr>
									...
									<td align="right">
										<xsl:apply-templates select="rd:UtilAmount|rd:PenaltiesAmount" mode="transl"/>
									</td>
									<td align="right">
										<xsl:apply-templates select="rd:UtilAmountPayable|rd:PenaltiesAmountPayable" mode="transl"/>
									</td>
									<td align="center">
							...
							<tr>
								...
								<td colspan="6" align="right">
									...
									<xsl:apply-templates select="rd:TotalUtilAmount|rd:TotalPenaltiesAmount" mode="transl"/>
								</td>
								<!--td align="center"></td>
									<td align="center"></td-->
							</tr>
							<tr>
								...
								<td colspan="6" align="right">
									<!--xsl:value-of select="sum(rd:UtilCollDetails/rd:UtilAmount)"/-->
									<xsl:apply-templates select="rd:TotalUtilAmountPayable|rd:TotalPenaltiesAmountPayable" mode="transl"/>
								</td>
								<!--td align="center"></td-->
							</tr>
						</table>
	...
	<xsl:template name="WheelPart1">
		...
		<xsl:variable name="payer" select="rd:Payer[rd:FactPayerIndicator = 1 or translate(substring(rd:FactPayerIndicator, 1, 1), 'T', 't') = 't'][1]"/>
		<table>
			<tr align="center">
		...
		<table>
			<tr align="left">
				...
				<td style="width: 57%;" class="border-bottom">
					<xsl:apply-templates select="rd:UtilCollDetails[1]/rd:BorderCrossingDate" mode="russian_date"/>
				</td>
			</tr>
		</table>
		<table>
			...
			<tr>
				<td>
					<xsl:apply-templates select="rd:UtilCollDetails[1]/rd:Vehicle/rd:PersonalUseIndicator" mode="yes_no"/>
				</td>
			</tr>
		</table>
		<table>
			...
			<tr>
				<td>
					<xsl:apply-templates select="rd:UtilCollDetails[1]/rd:ImportRBSign" mode="yes_no"/>
				</td>
			</tr>
		</table>
		<table>
		...
		<table>
			...
			<xsl:for-each select="rd:UtilCollDetails/*[local-name() = 'PresentedDocument' or local-name() = 'TransportDocument'][generate-id() = generate-id(key('typeKC_Docs', concat(cat_ru:PrDocumentNumber, cat_ru:PrDocumentDate, RUScat_ru:DocKindCode)))]">
				<tr>
					<td class="border-bottom">
		...
		<table>
			<tr align="left">
				<td>
					<xsl:choose>
						<xsl:when test="rd:DecisionNotificationMethod[(rd:MethodKind='2')]">
							<input type="checkbox" id="vehicle1" name="vehicle1" value="true" checked="checked" disabled="disabled"/>
						</xsl:when>
						<xsl:otherwise>
							<input type="checkbox" id="vehicle2" name="vehicle2" value="false" disabled="disabled"/>
				...
				<td style="width: 84%; vertical-align: baseline;" class="border-bottom">
					<xsl:value-of select="rd:DecisionNotificationMethod[(rd:MethodKind='2')]/rd:MethodID"/>
				</td>
			</tr>
		</table>
		<table>
			<tr align="left">
				<td>
					<xsl:choose>
						<xsl:when test="rd:DecisionNotificationMethod[(rd:MethodKind='3' or rd:MethodKind='4')]">
							<input type="checkbox" id="vehicle1" name="vehicle1" value="true" checked="checked" disabled="disabled"/>
						</xsl:when>
						<xsl:otherwise>
							<input type="checkbox" id="vehicle2" name="vehicle2" value="false" disabled="disabled"/>
		...
		<!--/td>
				<td style="width:270px;"-->
					<xsl:choose>
						<xsl:when test="string-length(rd:DecisionNotificationMethod[(rd:MethodKind='3' or rd:MethodKind='4')]/rd:MethodID) &gt; 3">
							(<u>
								<xsl:value-of select="substring(rd:DecisionNotificationMethod[(rd:MethodKind='3' or rd:MethodKind='4')]/rd:MethodID,1,3)"/>
							</u>)
							<u>
								<xsl:value-of select="substring(rd:DecisionNotificationMethod[(rd:MethodKind='3' or rd:MethodKind='4')]/rd:MethodID,4)"/>
							</u>
						</xsl:when>
						<xsl:otherwise>
				...
				<xsl:text> посредством </xsl:text><!--СМС
					...
					или -->Telegram
					<xsl:choose>
						<xsl:when test="rd:DecisionNotificationMethod[(rd:MethodKind='4')]">
							<input type="checkbox" id="vehicle1" name="vehicle1" value="true" checked="checked" disabled="disabled"/>
						</xsl:when>
						<xsl:otherwise>
							<input type="checkbox" id="vehicle2" name="vehicle2" value="false" disabled="disabled"/>
		...
		<table>
			<tr align="left">
				<td>
					<xsl:choose>
						<xsl:when test="rd:DecisionNotificationMethod[(rd:MethodKind='5')]">
							<input type="checkbox" id="vehicle1" name="vehicle1" value="true" checked="checked" disabled="disabled"/>
						</xsl:when>
						<xsl:otherwise>
							<input type="checkbox" id="vehicle2" name="vehicle2" value="false" disabled="disabled"/>
				...
				<td style="width: 80%; vertical-align: baseline;" class="border-bottom">
					<xsl:value-of select="rd:DecisionNotificationMethod[(rd:MethodKind='5')]/rd:MethodID"/>
				</td>
			</tr>
		</table>
		<table>
									...
									<table>
										<tbody>
											<tr align="center" valign="bottom">
												...
												<td width="5%"/>
												<td width="20%" style="border-bottom:1px solid black;">
													<xsl:apply-templates select="rd:ApproverPerson/*[local-name() = 'IssueDate']" mode="russian_date"/>
												</td>
											</tr>
	...
	<xsl:template name="WheelPart2">		
		<xsl:variable name="payer" select="rd:Payer[rd:DebtorPayerIndicator = 1 or translate(substring(rd:DebtorPayerIndicator, 1, 1), 'T', 't') = 't'][1]"/>
		<xsl:variable name="payer2" select="rd:Payer[. != $payer]"/>
		<br/>
		<br/>
		<table>
			<tr align="center">
...
-->				</td>
	...
	<xsl:template name="Part1">
		...
		<xsl:variable name="payer" select="$root/rd:Payer[rd:FactPayerIndicator = 1 or translate(substring(rd:FactPayerIndicator, 1, 1), 'T', 't') = 't'][1]"/>
		<table>
			<tr>
	...
	<xsl:template name="Part2">
		...
		<!-- рус -->
		<xsl:variable name="root" select="$person/.."/>
		<xsl:variable name="payer" select="$root/rd:Payer[rd:DebtorPayerIndicator = 1 or translate(substring(rd:DebtorPayerIndicator, 1, 1), 'T', 't') = 't'][1]"/>
		<xsl:variable name="payer2" select="$root/rd:Payer[. != $payer]"/>
		<table>
			<tr>
