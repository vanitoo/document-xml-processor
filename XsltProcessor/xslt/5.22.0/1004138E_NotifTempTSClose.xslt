...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.22.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:nttc="urn:customs.ru:Information:ExchangeDocuments:NotifTempTSClose:5.22.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
				...
				<div class="page" style="width: {$w}mm;">
					...
					<table>
						<tr>
							...
							<td class="value graphMain" style="width:50%">
								<xsl:apply-templates select="nttc:ProccessID"/>
							</td>
						</tr>
					</table>
					<xsl:if test="nttc:ParticipantID">
						<table>
							<tr>
								...
								<td class="value graphMain" style="width:50%">
									<xsl:apply-templates select="nttc:ParticipantID"/>
								</td>
							</tr>
						</table>
					</xsl:if>
					<table>
						<tr>
							...
							<td class="value graphMain" style="width:50%">
								<xsl:apply-templates select="nttc:CloseDate" mode="russian_date"/>
							</td>
						</tr>
					</table>
					<table>
						<tr>
							...
							<td class="graphMain value" style="width:50%">
								<xsl:for-each select="nttc:CustomsOpenVVRegNumber">
	...
	<!-- Шаблон для типа nttc:CustomsOpenVVRegNumberType -->
	<xsl:template match="nttc:CustomsOpenVVRegNumber">
		...
		<xsl:apply-templates select="cat_ru:CustomsCode"/>
					...
					<xsl:text> </xsl:text>
					<xsl:for-each select="nttc:TransportIdentifier">
	...
	<xsl:template match="//*[local-name()='NotifTempTSClose']//*" priority="-1">
