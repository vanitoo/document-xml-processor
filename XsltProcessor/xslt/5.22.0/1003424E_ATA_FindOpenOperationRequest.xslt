...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.22.0" xmlns:ata_ct="urn:customs.ru:Information:TransportDocuments:ATA:ATA_CommonTypes:5.22.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.22.0" xmlns:ata_findoo="urn:customs.ru:Information:TransportDocuments:ATA:ATA_FindOpenOperationRequest:5.22.0">
	<!-- Шаблон для типа ATA_FindOpenOperationRequestType -->
	<xsl:template match="ata_findoo:ATA_FindOpenOperationRequest">
		<html>
			<head>
				<style>
									body {
			...
			<body>
				<div class="page">
						...
						<tbody>
							<tr>
								<td align="center" class="graphMain">
									<font size="4">
										<b>Запрос незавершенных операций по карнетам АТА</b>
									</font>
								</td>
							</tr>
						</tbody>
					...
					<div class="title marg-top">Параметры запроса  незавершенных операций по карнетам АТА</div>
					<xsl:apply-templates select="ata_findoo:RequestParams"/>
				</div>
			</body>
		</html>
	</xsl:template>
	<!-- Шаблон для типа ata_ct:RequestParamsType -->
	<xsl:template match="ata_findoo:RequestParams">
		<table class="w190">
			<tr>
