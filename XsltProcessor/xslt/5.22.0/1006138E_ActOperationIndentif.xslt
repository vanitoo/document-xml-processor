						...
						<tbody>
							...
							<xsl:variable name="xpath_ActDate">
								<xsl:call-template name="get_xpath">
									<xsl:with-param name="node" select="aopin:ActNumber/cat_ru:RegistrationDate"/>
								</xsl:call-template>
							</xsl:variable>
							<tr>
								<td>
										...
										<tr>
											...
											<span class="bordered" style="width: 5mm; display: inline-block;">
												<element xml_node="{$xpath_ActDate}">
													<xsl:value-of select="substring(aopin:ActNumber/cat_ru:RegistrationDate,9,2)"/>
												</element>
											</span>
											<xsl:text>" </xsl:text>
											<span class="bordered" style="width: 30mm; display: inline-block; text-align: center;">
												<element xml_node="{$xpath_ActDate}">
													<xsl:choose>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='01'">января</xsl:when>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='02'">февраля</xsl:when>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='03'">марта</xsl:when>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='04'">апреля</xsl:when>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='05'">мая</xsl:when>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='06'">июня</xsl:when>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='07'">июля</xsl:when>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='08'">августа</xsl:when>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='09'">сентября</xsl:when>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='10'">октября</xsl:when>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='11'">ноября</xsl:when>
														<xsl:when test="substring(aopin:ActNumber/cat_ru:RegistrationDate,6,2)='12'">декабря</xsl:when>
													</xsl:choose> 
												</element>
											</span>
											...
											<span class="bordered" style="width: 5mm; display: inline-block;">
												<element xml_node="{$xpath_ActDate}">
													<xsl:value-of select="substring(aopin:ActNumber/cat_ru:RegistrationDate,3,2)"/>
												</element>
											</span>
											<xsl:text> г.</xsl:text>
											</td>
