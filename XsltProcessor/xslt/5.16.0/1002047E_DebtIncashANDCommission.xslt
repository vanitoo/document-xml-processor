	...
	<xsl:template match="diac:DebtIncashANDCommission">
		<html>
			...
			<body>
				<div class="page">
					<xsl:choose>
						<xsl:when test="(diac:DocumentInfo/diac:DocumentType = 0 and diac:DocumentInfo/diac:OrderType = 0) or (diac:DocumentInfo/diac:DocumentType = 0 and diac:DocumentInfo/diac:OrderType = 2) or (diac:DocumentInfo/diac:DocumentType = 0 and diac:DocumentInfo/diac:OrderType = 3)">
								...
								<tbody>
									...
									<tr>
										...
										<td valign="top" align="left" rowspan="2" colspan="2" class="bordered">
											...
											<span class="value">
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:ExtInformation/diac:Order2"/>
											</span>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="14" class="value underlined">
											<br/>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TotalAmount/diac:PaymentAmountText"/>
										</td>
									</tr>
									<tr>
										<td colspan="4" valign="bottom" class="underlined" style="border-right: solid 1px black;">
											...
											<span class="value">
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/cat_ru:RFOrganizationFeatures/cat_ru:INN"/>
											</span>
										</td>
										<td colspan="5" class="underlined">
											<xsl:text>КПП </xsl:text>
											<span class="value">
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/cat_ru:RFOrganizationFeatures/cat_ru:KPP"/>
											</span>
										</td>
										...
										<td rowspan="2" colspan="5" class="value underlined" valign="top">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TotalAmount/diac:PaymentAmount"/>
										</td>
									</tr>
									<tr>
										<td colspan="9" class="value">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/cat_ru:OrganizationName"/>
											<xsl:if test="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/cat_ru:ShortName">
												<xsl:if test="string-length(diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/cat_ru:OrganizationName) &gt; 0"> (</xsl:if>
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/cat_ru:ShortName"/>
												<xsl:if test="string-length(diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:Organization/cat_ru:OrganizationName) &gt; 0">)</xsl:if>
											</xsl:if>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
										</td>
									...
									<tr>
										<td class="value" colspan="9">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BankInfoPayer/cat_ru:OrganizationName"/>
											<xsl:if test="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BankInfoPayer/cat_ru:ShortName">
												<xsl:if test="string-length(diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BankInfoPayer/cat_ru:OrganizationName) &gt; 0"> (</xsl:if>
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BankInfoPayer/cat_ru:ShortName"/>
												<xsl:if test="string-length(diac:DocumentInfo/diac:DocumentPaymentReqs/diac:InfoPayer/diac:BankInfoPayer/cat_ru:OrganizationName) &gt; 0">)</xsl:if>
											</xsl:if>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
										</td>
									...
									<tr>
										...
										<td colspan="5" class="value underlined">
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:sKorAccountBankPayer"/>
										</td>
									</tr>
									<tr>
										<td class="value" colspan="9">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:BankInfoRecipient"/>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
										</td>
										<td class="bordered" colspan="2">
											<xsl:text>БИК</xsl:text>
										...
										<td colspan="5" class="value">
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:BICBankRecipient"/>
										</td>
									</tr>
									<tr>
										<td class="underlined" colspan="9">
									...
									<tr>
										<td colspan="4" class="underlined" style="border-right: solid 1px black;">
											<xsl:text>ИНН </xsl:text>
											<span class="value">
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:RecipientINN"/>
											</span>
										</td>
										<td colspan="5" class="underlined">
											<xsl:text>КПП </xsl:text>
											<span class="value">
												<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:RecipientKPP"/>
											</span>
										</td>
									...
									<tr>
										<td colspan="9" class="value">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:RecipientName"/>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="value">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:TypeOfOperation"/>
										</td>
										...
										<td rowspan="2" colspan="2" valign="top" class="value underlined">
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:PriorityPayment"/>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="value bordered" colspan="2" valign="top">
											<sup>3</sup>
											<br/>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:ExtInformation/diac:Order105"/>
										</td>
										<td class="value bordered" colspan="3" valign="top">
											<sup>4</sup>
											<br/>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:ExtInformation/diac:Order106"/>
										</td>
										<td class="value bordered" colspan="2" valign="top">
											<sup>5</sup>
											<br/>
										...
										<td class="value bordered" colspan="3" valign="top">
											<sup>6</sup>
											<br/>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:ExtInformation/diac:Order108"/>
										</td>
										<td class="value bordered" colspan="2" valign="top">
											<sup>7</sup>
											<br/>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											<xsl:value-of select="diac:DocumentInfo/diac:DocumentPaymentReqs/diac:TransFerfunds/diac:TransFerReqs/diac:ExtInformation/diac:Order109"/>
										</td>
										<td class="value bordered" colspan="2" valign="top">
											<sup>8</sup>
											<br/>
