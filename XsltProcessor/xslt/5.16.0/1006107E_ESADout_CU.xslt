			...
			<xsl:choose>
				...
				<xsl:otherwise>
                    ...
                    <br>
								...
								<xsl:apply-templates select="$GTDID/cat_ru:CustomsCode"/>
								<xsl:text>/</xsl:text>
								<xsl:apply-templates select="$GTDID/cat_ru:RegistrationDate" mode="russian_date_gtd"/>
								<!--xsl:call-template name="russian_date_gtd">
									<xsl:with-param name="dateIn" select="$GTDID/cat_ru:RegistrationDate"/>
								</xsl:call-template-->
								<xsl:text>/</xsl:text>
								<xsl:apply-templates select="$GTDID/cat_ru:GTDNumber"/>
							</br>
						</td>
					</tr>
					<tr>
