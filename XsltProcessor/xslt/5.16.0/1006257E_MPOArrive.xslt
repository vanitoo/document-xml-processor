...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:mpco="urn:customs.ru:Information:CustomsDocuments:MPOCommon:5.16.0" xmlns:mpoa="urn:customs.ru:Information:CustomsDocuments:MPOArrive:5.16.0">
					...
					<xsl:if test="mpoa:ZTKTime">
						<table>
							<tr>
								...
								<td class="value graphMain" style="width:50%">
									<xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="mpoa:ZTKTime"/></xsl:call-template>
									<xsl:text> </xsl:text>
					...
					<xsl:if test="mpoa:CustomsCode">
						<table>
							<tr>
								...
								<td class="value graphMain" style="width:50%">
									<xsl:value-of select="mpoa:CustomsCode"/>
								</td>
							</tr>
						</table>
					</xsl:if>
							...
							<tr>
								...
								<td class="value graphMain" style="width:50%">
									<xsl:choose>
										...
										<xsl:otherwise>
											<xsl:value-of select="mpoa:Return"/>
										</xsl:otherwise>
									</xsl:choose>
								</td>
							</tr>
		...
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			...
			<table>
				<tr>
					...
					<td class="value graphMain" style="width:50%">
						<xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="mpoa:InspectionTime"/></xsl:call-template>
						<xsl:text> </xsl:text>
			...
			<xsl:if test="mpoa:DisplayTime">
				<table>
					<tr>
						...
						<td class="value graphMain" style="width:50%">
							<xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="mpoa:DisplayTime"/></xsl:call-template>
							<xsl:text> </xsl:text>
					...
					<tr>
						...
						<td class="value graphMain" style="width:50%">
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:value-of select="mpoa:Prohibited"/>
								</xsl:otherwise>
							</xsl:choose>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="value graphMain" style="width:50%">
							<xsl:choose>
								...
								<xsl:otherwise>
									<xsl:value-of select="mpoa:Perquisition"/>
								</xsl:otherwise>
							</xsl:choose>
						</td>
					</tr>
			...
			<table>
				<tr>
					...
					<td class="value graphMain" style="width:50%">
						...
						<xsl:text>/</xsl:text>
						<xsl:call-template name="reestr_date">
							<xsl:with-param name="dateIn" select="mpoa:RegistrationDate"/>
						</xsl:call-template>
						<xsl:text>/</xsl:text>
						<xsl:value-of select="mpoa:MPO_Number"/>
					</td>
				</tr>
			</table>
		</div>
