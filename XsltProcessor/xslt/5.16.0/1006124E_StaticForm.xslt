						...
						<tbody>
							...
							<tr>
								<td colspan="4" rowspan="3" class="border_vertical" valign="top" align="left">
									<span class="value">
										<xsl:apply-templates select="statf:Сonsignee" mode="org"/>
										...
										<tbody>
											...
											<tr>
												<xsl:variable name="execDate">
													<xsl:apply-templates select="statf:ProvidePerson/RUScat_ru:SigningDate" mode="date"/>
