...
-->
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUDECLcat="urn:customs.ru:RUDeclCommonAggregateTypesCust:5.16.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.16.0" xmlns:gcd="urn:customs.ru:Information:CustomsDocuments:GoodsClassificationDecision:5.16.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
				...
				<tbody>
				   ...
				   <tr>
					...
					<tr>
						...
						<xsl:for-each select="gcd:ReasonsForDecision">
							<xsl:value-of select="gcd:Number"/><xsl:text> </xsl:text><xsl:apply-templates select="gcd:Text"/>
							<xsl:if test="position()!=last()"><br/></xsl:if>
						</xsl:for-each>
						</td>
					</tr>
