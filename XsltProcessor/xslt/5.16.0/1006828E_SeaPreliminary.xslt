...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sp="urn:customs.ru:Information:CustomsDocuments:SeaPreliminary:5.16.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:RUSclt_ru="urn:customs.ru:RUSCommonLeafTypes:5.14.3" xmlns:cltpi_ru="urn:customs.ru:Information:PriorInformation:PriorCommonLeafTypes:5.14.3" xmlns:catpi_ru="urn:customs.ru:Information:PriorInformation:PriorCommonAggregateTypes:5.16.0">
				...
				<div class="page" style="width: {$w}mm;">
					<table>
						<tbody>
							...
							<xsl:apply-templates select="sp:EpidemicControlDetails"/>
	...
	<xsl:template match="sp:EpidemicControlDetails">
		<tr class="title">
		...
		<tr>
			<td class="bordered" colspan="4">Противоэпидемическая готовность</td>
		</tr>
		<xsl:apply-templates select="sp:AntiepidemicReadyDetails"/>
		
		<xsl:apply-templates select="sp:PestControlDetails"/>
	</xsl:template>
