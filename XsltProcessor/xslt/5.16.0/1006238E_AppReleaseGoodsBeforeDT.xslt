								...
								<tr>
									...
									<td>
										...
										<xsl:for-each select="argb:GoodsGroupDescription">
											<xsl:apply-templates select="RUDECLcat:GoodsDescription"/>
											<xsl:if test="position()!=last()">
												<xsl:text>; </xsl:text>
											</xsl:if>
										</xsl:for-each>
