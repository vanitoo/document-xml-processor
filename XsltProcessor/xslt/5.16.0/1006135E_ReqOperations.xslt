               ...
               <table>
                  <tbody>
                     ...
                     <xsl:if test="reqop:DocSign='0'">
                        <tr>
                           <td style="text-align: justify;">  На основании п.9. ст.214 и в целях реализации пп.2. п. 3 ст. 109 Федерального закона от 3 августа 2018 года № 289-ФЗ "О таможенном регулировании в Российской Федерации и о внесении изменений в отдельные законодательные акты Российской Федерации" требуется проведение следующих операций в отношении товаров и транспортных средств, находящихся под таможенным контролем: 
