							...
							<tr>
								<td>
									...
									<xsl:choose>
										...
										<xsl:when test="rdrp:ResultCode='07'">07 - помещено в очередь неисполненных документов</xsl:when>
