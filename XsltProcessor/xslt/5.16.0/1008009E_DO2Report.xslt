				...
				<tr>
					<td>
						...
						<xsl:value-of select="../do2r:Output/do2r:MeasureQuantity/catWH_ru:MeasureUnitQualifierCode"/>
														...
														<td class="bordered" style="width:16mm">
															<xsl:attribute name="rowspan"><xsl:value-of select="$Input"/></xsl:attribute>
															<xsl:value-of select="../do2r:Output/do2r:BruttoVolQuant2/catWH_ru:GoodsQuantity"/> 
						<xsl:value-of select="../do2r:Output/do2r:BruttoVolQuant2/catWH_ru:MeasureUnitQualifierName"/> 
						<xsl:value-of select="../do2r:Output/do2r:BruttoVolQuant2/catWH_ru:MeasureUnitQualifierCode"/>
														</td>
						...
						<xsl:value-of select="../do2r:Result/do2r:CurrencyCode"/>
								...
								<table style="width:250mm">
									<tr>
										<td class="bordered" style="width:15mm" align="center"><xsl:value-of select="do2r:GoodsShipment/do2r:ReasonKind"/></td>
