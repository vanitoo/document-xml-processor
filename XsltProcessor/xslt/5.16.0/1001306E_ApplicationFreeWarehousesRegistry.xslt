...
<!--Приказ ФТС России от 25.03.2019 N 491 "Об утверждении Административного регламента Федеральной таможенной службы по предоставлению государственной услуги по ведению реестра владельцев свободных складов"
ApplicationType="ВК" - Приложение 1 (Заявление о включении в реестр владельцев свободных складов)
ApplicationType="ИЗ" - Приложение 2 (Заявление о внесении изменений в реестр владельцев свободных складов)
ApplicationType="ИС" - Приложение 3 (Заявление владельца свободного склада об исключении его из реестра владельцев свободных складов)
-->
				...
				<div class="page">
					<table class="graphMain" width="100%">
						<tbody>
										...
										<b>
											...
											<xsl:choose>
												<xsl:when test="RegFW:ApplicationType='ВК'">
													<xsl:text>о включении в реестр владельцев сводобных складов</xsl:text>
												</xsl:when>
							...
							<tr>
								<td class="value">
									<xsl:apply-templates mode="organizationBase" select="RegFW:AppOrganizationInfo/RegFW:OrganizationInfo"/>
								</td>
							</tr>
							<tr>
								<td class="graphLittle">
									<xsl:choose>
										<xsl:when test="RegFW:ApplicationType='ВК' or RegFW:ApplicationType='ИЗ'">
											<xsl:text>(наименование организции)</xsl:text>
										</xsl:when>
										<xsl:when test="RegFW:ApplicationType='ИС'">
											<xsl:text>(наименование организции - владельца свободного склада)</xsl:text>
										</xsl:when>
									</xsl:choose>
								</td>
							</tr>
										...
										<td>
											<table class="graphMain" width="100%">
												<tbody>
													<tr>
														<td width="60%">
															<xsl:text>просит рассмотрть возможность включения</xsl:text>
														</td>
														<td class="value" width="40%">
															<xsl:apply-templates select="RegFW:AppOrganizationInfo/RegFW:OrganizationInfo" mode="orgName"/>
														</td>
													</tr>
													<tr>
														<td/>
											...
											<table class="graphMain" width="100%">
												<tbody>
													...
													<tr>
														...
														<td class="bordered">
															<xsl:value-of select="RegFW:AppOrganizationInfo/RegFW:OrganizationInfo/cat_ru:OrganizationName"/>
														</td>
													</tr>
													<tr>
														<td class="bordered" align="center">
														...
														<td class="bordered">
															<xsl:value-of select="RegFW:AppOrganizationInfo/RegFW:OrganizationInfo/cat_ru:ShortName"/>
														</td>
													</tr>
													<tr>
														<td class="bordered" align="center">
														...
														<td class="bordered">
															<xsl:value-of select="RegFW:AppOrganizationOPF"/>
														</td>
													</tr>
													<tr>
														<td class="bordered" align="center">
														...
														<td class="bordered">
															<xsl:if test="RegFW:AppOrganizationInfo/RegFW:OrganizationInfo/cat_ru:Address">
																<xsl:apply-templates mode="addressStr" select="RegFW:AppOrganizationInfo/RegFW:OrganizationInfo/cat_ru:Address"/>
													...
													<tr>
														...
														<td class="bordered">
															<xsl:text>Средства связи (адрес электронной почты, телефон), сайт а информационно-телекоммуникационной сети "Интернет"</xsl:text>
														</td>
														<td class="bordered">
