						...
						<xsl:when test="arcc:CashType='1'">
							...
							<table width="100%">
								<tbody>
									<tr>
										<td class="underlined">
											<xsl:value-of select="arcc:ApplicantInfo/cat_ru:OrganizationName"/>
											<xsl:if test="not(arcc:ApplicantInfo/cat_ru:OrganizationName) and arcc:ApplicantInfo/cat_ru:ShortName">
												<xsl:value-of select="arcc:ApplicantInfo/cat_ru:ShortName"/>
											</xsl:if>
											<br/>
										</td>
									</tr>
								...
								<tbody>
									<tr valign="top">
										...
										<td width="25%" align="center" class="underlined">
											<xsl:value-of select="arcc:ApplicantInfo/cat_ru:RFOrganizationFeatures/cat_ru:INN"/>
										</td>
										<td width="5%"/>
										<td width="5%"><xsl:text>КПП**</xsl:text></td>
										<td width="25%" align="center" class="underlined">
											<xsl:value-of select="arcc:ApplicantInfo/cat_ru:RFOrganizationFeatures/cat_ru:KPP"/>
										</td>
										<td width="5%"/>
							...
							<table width="100%">
								<tbody>
									<tr>
										...
										<td class="underlined">
											<xsl:apply-templates select="arcc:ApplicantInfo/cat_ru:Address"/>
											<br/>
										</td>
									</tr>
									<tr align="center">
								...
								<tbody>
									<tr>
										...
										<td class="underlined" width="20%">
											<xsl:value-of select="arcc:BankInformation/arcc:OKTMO"/>
											<br/>
										</td>
									</tr>
									<tr>
								...
								<tbody>
									<tr>
										...
										<td class="underlined" width="10%" align="center">
											<xsl:choose>
												<xsl:when test="substring-after(arcc:AmountCash/arcc:Amount,'.')"><xsl:value-of select="substring-after(arcc:AmountCash/arcc:Amount,'.')"/></xsl:when>
											</xsl:choose>
										</td>
										<td width="1%"/>
										<td width="29%">
