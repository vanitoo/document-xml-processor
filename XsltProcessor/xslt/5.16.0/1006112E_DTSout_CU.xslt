								...
								<tbody>
												...
												<tr>
													...
													<td align="right" class="graph" width="50%">
														<xsl:if test="DTSout_CU:DTSoutDeclarant/RUDECLcat:AEORegistryIdDetails/catESAD_cu:DocId">
															<xsl:text>№ </xsl:text>
															<xsl:value-of select="DTSout_CU:DTSoutDeclarant/RUDECLcat:AEORegistryIdDetails/catESAD_cu:DocId"/>
														</xsl:if>
													</td>
												</tr>
											</table>
									...
									<tr>
										<td class="graph" style="width:80mm;border-left:solid 0.8pt #000000;border-right:solid 0.8pt #000000;" valign="top">
											...
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											<xsl:call-template name="russian_date">
												<xsl:with-param name="dateIn" select="DTSout_CU:DTSout_CUFilledPerson/RUDECLcat:SigningDetails/RUScat_ru:SigningDate"/>
