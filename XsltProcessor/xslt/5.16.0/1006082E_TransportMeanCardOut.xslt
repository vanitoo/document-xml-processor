                  ...
                  <tbody>
                     <tr>
                        ...
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
                           ...
                           <xsl:if test="TMCout:TransportOwner/catESAD_ru:OwnerModeCode='Ф'">
                              ...
                              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                              <xsl:value-of select="TMCout:TransportOwner/catESAD_ru:TransportOwnerPerson/catESAD_ru:IdentityCard/RUScat_ru:IdentityCardName"/>
                              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                              <xsl:value-of select="TMCout:TransportOwner/catESAD_ru:TransportOwnerPerson/catESAD_ru:IdentityCard/RUScat_ru:FullIdentityCardName"/>
                              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                              <xsl:value-of select="TMCout:TransportOwner/catESAD_ru:TransportOwnerPerson/catESAD_ru:IdentityCard/RUScat_ru:IdentityCardSeries"/>
                              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                              <xsl:value-of select="TMCout:TransportOwner/catESAD_ru:TransportOwnerPerson/catESAD_ru:IdentityCard/RUScat_ru:IdentityCardNumber"/>
                              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                              <xsl:call-template name="russian_date">
                                 <xsl:with-param name="dateIn" select="TMCout:TransportOwner/catESAD_ru:TransportOwnerPerson/catESAD_ru:IdentityCard/RUScat_ru:IdentityCardDate"/>
                              </xsl:call-template>
                              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
                              <xsl:value-of select="TMCout:TransportOwner/catESAD_ru:TransportOwnerPerson/catESAD_ru:IdentityCard/RUScat_ru:OrganizationName"/>
                              <br/>
                              <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
					 ...
					 <xsl:if test="TMCout:TransportCategoryCode3">
						 <tr>
							...
							<td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
							   <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
							   <xsl:value-of select="TMCout:TransportCategoryCode3"/>
							</td>
						 </tr>
					 </xsl:if>
                     <tr>
                     ...
                     <tr>
						...
						<td class="graph" style="width:90mm;border:solid 0.5pt #000000;">
							<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
							<xsl:value-of select="TMCout:ESADTransportMeanCard/catESAD_ru:Engine/catESAD_ru:EnginePowerHpQuanity"/>
						</td>
					</tr>
					<tr>
						<td class="graph" style="width:90mm;border:solid 0.5pt #000000;">
						...
						<td class="graph" style="width:90mm;border:solid 0.5pt #000000;">
							<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
							<xsl:value-of select="TMCout:ESADTransportMeanCard/catESAD_ru:Engine/catESAD_ru:EnginePowerKvtQuanity"/>
						</td>
					</tr>
					<tr>
						<td class="graph" style="width:90mm;border:solid 0.5pt #000000;">
						...
						<td class="graph" style="width:90mm;border:solid 0.5pt #000000;">
							<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
							<xsl:value-of select="TMCout:ESADTransportMeanCard/catESAD_ru:Engine/cat_ru:EngineVolumeQuanity"/>
						</td>
					</tr>
					<tr>
						<td class="graph" style="width:90mm;border:solid 0.5pt #000000;">
						...
						<td class="graph" style="width:90mm;border:solid 0.5pt #000000;">
							<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
							<xsl:value-of select="TMCout:ESADTransportMeanCard/catESAD_ru:Engine/catESAD_ru:EngineModeCode"/>
						</td>
					</tr>
                     <tr>
                        <td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
					 ...
					 <xsl:if test="TMCout:VehicleEPassportId">
						 <tr>
							...
							<td class="graph" style="width:90mm;border:solid 0.8pt #000000;">
							   <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
							   <xsl:value-of select="TMCout:VehicleEPassportId"/>
							</td>
						 </tr>
					 </xsl:if>
                     <!--tr>
