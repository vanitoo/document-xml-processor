...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:cbr="urn:customs.ru:ReportingCollection:CustomsBrokerReport:5.16.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.16.0" xmlns:cltESAD_cu="urn:customs.ru:CUESADCommonLeafTypes:5.15.0">
	...
	<xsl:template match="cbr:IdentityCard">
		<xsl:if test="RUScat_ru:IdentityCardCode">
			<!--xsl:value-of select="RUScat_ru:IdentityCardName"/><br/-->
