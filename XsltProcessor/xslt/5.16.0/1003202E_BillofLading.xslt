												...
												<tr valign="top">
													...
													<td style="width:20mm">
														<xsl:if test="bol:GrossWeightQuantity">
															<xsl:value-of select="format-number(bol:GrossWeightQuantity,$FmtGrossWeightQuantity)"/>
														</xsl:if>
														<xsl:if test="bol:WeightWithCont">
															<xsl:text> (с конт.: </xsl:text>
															<xsl:value-of select="format-number(bol:WeightWithCont,$FmtWeightWithCont)"/>
															<xsl:text>)</xsl:text>
														</xsl:if>
													...
													<td style="width:30mm">
														<xsl:if test="catTrans_ru:VolumeQuantity">
															<xsl:value-of select="format-number(catTrans_ru:VolumeQuantity,$FmtVolumeQuantity)"/>
														</xsl:if>
													</td>
													<xsl:if test="../bol:Goods/bol:ZTKNum or ../bol:Goods/bol:ZTKName">
														<td>
