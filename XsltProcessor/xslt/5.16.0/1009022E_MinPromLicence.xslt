...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:minprl="urn:customs.ru:Information:SQDocuments:MinPromLicence:5.16.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
					...
					<div class="page">
						...
						<table class="w190" cellpadding="3">
									...
									<span class="arial">
										<xsl:if test="minprl:License/minprl:StartDate">
											...
											<xsl:call-template name="russian_date">
												<xsl:with-param select="minprl:License/minprl:StartDate" name="dateIn"/>
											</xsl:call-template>
										</xsl:if>
										<xsl:if test="minprl:License/minprl:DateTo">
											<xsl:text> по </xsl:text>
											<xsl:call-template name="russian_date">
												<xsl:with-param select="minprl:License/minprl:DateTo" name="dateIn"/>
											</xsl:call-template>
										</xsl:if>
									</span>
									<xsl:if test="minprl:IsCanceled">
										...
										<xsl:choose>
											<xsl:when test="minprl:IsCanceled='true' or minprl:IsCanceled=1">
												<b>
													<span class="arial" style="color: green;">действителен</span>
												</b>
											</xsl:when>
											<xsl:when test="minprl:IsCanceled='false' or minprl:IsCanceled=0">
												<b>
													<span class="arial" style="color: red;">не действителен</span>
												</b>
											</xsl:when>
										</xsl:choose>
									</xsl:if>
									...
									<span class="arial">
										...
										<xsl:choose>
											<xsl:when test="minprl:Contract/cat_ru:PrDocumentNumber">
												<xsl:value-of select="minprl:Contract/cat_ru:PrDocumentNumber"/>
											</xsl:when>
										...
										<xsl:if test="minprl:Contract/cat_ru:PrDocumentDate">
											...
											<xsl:call-template name="russian_date">
												<xsl:with-param select="minprl:Contract/cat_ru:PrDocumentDate" name="dateIn"/>
											</xsl:call-template>
										</xsl:if>
									</span>
								</td>
							...
							<tr valign="top">
								...
								<td class="bordered" style="border-bottom:0; width:12%" align="center">
									<span class="arial">
										<xsl:value-of select="minprl:Country7Info/minprl:CountryAlpha2"/>
									</span>
								</td>
								<td class="bordered" colspan="2" style="border-bottom:0; width:38%">
									<xsl:choose>
							...
							<tr valign="top">
								<td class="bordered" colspan="3" style="border-top:0; width:50%">
									<span class="arial">
										<xsl:value-of select="minprl:Country7Info/minprl:CountryName"/>
									</span>
								</td>
								<td class="bordered" colspan="3" style="border-top:0; width:50%">
									<span class="arial">
							...
							<tr valign="top">
								...
								<td class="bordered" style="border-bottom:0; width:12%" align="center">
									<span class="arial">
										<xsl:value-of select="minprl:Cost/minprl:ContractCurrencyCode"/>
									</span>
								</td>
							...
							<tr valign="top">
								<td class="bordered" colspan="3" style="border-top:0; width:50%">
									<span class="arial">
										<xsl:value-of select="minprl:Cost/minprl:ContractCurrencyName"/>
									</span>
								</td>
								...
								<td class="bordered" style="border-bottom:0; width:12%" align="center">
									<span class="arial">
										<xsl:choose>
											...
											<xsl:otherwise>
												<xsl:value-of select="minprl:OriginCountry/minprl:CountryAlpha2"/>
											</xsl:otherwise>
										</xsl:choose>
									</span>
								</td>
							...
							<tr valign="top">
									...
									<span class="arial">
										<xsl:choose>
											<xsl:when test="minprl:OriginCountry/minprl:CountryName">
												<xsl:value-of select="minprl:OriginCountry/minprl:CountryName"/>
											</xsl:when>
								...
								<td class="bordered" colspan="2" style="border-top:0; width:30%" align="center">
									<span class="arial">
										<xsl:value-of select="minprl:Quantity/RUScat_ru:MeasureUnitQualifierName"/>
										<xsl:if test="minprl:AddQuantity">
											<br/>
											<xsl:value-of select="minprl:AddQuantity/RUScat_ru:MeasureUnitQualifierName"/>
										</xsl:if>
									</span>
								</td>
							</tr>
							...
							<table class="w190" cellpadding="3">
								...
								<tr valign="top">
									<td class="bordered" colspan="4" align="center">
										...
										&#160;ОТ <span class="arial">
											<xsl:call-template name="russian_date">
												<xsl:with-param select="minprl:License/minprl:SignPerson/cat_ru:IssueDate" name="dateIn"/>
											</xsl:call-template>
										</span>
									</td>
								</tr>
								<xsl:for-each select="minprl:Addendum">
									<tr valign="top">
										<td class="bordered" rowspan="4" style="width:5%" align="center">
											<xsl:value-of select="minprl:PositionNumber"/>
										</td>
				...
				<xsl:choose>
					<xsl:when test="local-name(.) = 'HolderPerson'">
						<tr>
							...
							<td colspan="2">
								<span class="arial">
									<xsl:value-of select="minprl:Phone"/>
								</span>
							</td>
						</tr>
					</xsl:when>
