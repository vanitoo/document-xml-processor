...
-->
<xsl:stylesheet exclude-result-prefixes="sst3 cat_ru catSert_ru" version="1.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.16.0" xmlns:catSert_ru="urn:customs.ru:Information:SertifDocuments:SertifCommonAggregateTypesCust:5.16.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:sst3="urn:customs.ru:Information:SertifDocuments:SertifST3Form:5.16.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
						...
						<tbody>
									...
									<xsl:choose>
										<xsl:when test="sst3:RegNumber">
											<span class="underlined value">
												<xsl:value-of select="sst3:RegNumber"/>
											</span>
										</xsl:when>
										<xsl:otherwise>
										...
										<tbody>
											<tr>
												...
												<td align="center" width="30%" valign="bottom" class="value underlined">
													<xsl:value-of select="sst3:IssueCountryName"/>
												</td>
											</tr>
											<tr>
												<td class="graph">
											...
											<tr>
												...
												<td align="center" valign="bottom" class="value underlined">
													<xsl:value-of select="sst3:DestinCountryName"/>
												</td>
											</tr>
											<tr>
												<td class="graph">
												...
												<xsl:choose>
													<xsl:when test="sst3:SertificatKindInfo/sst3:Number">
														<span class="value underlined">
															<xsl:value-of select="sst3:SertificatKindInfo/sst3:Number"/>
														</span>
													</xsl:when>
													<xsl:otherwise>
													...
													<xsl:when test="sst3:SertificatKindInfo/sst3:Date">
														<span class="value underlined">
															<xsl:call-template name="russian_date">
																<xsl:with-param select="sst3:SertificatKindInfo/sst3:Date" name="dateIn"/>
															</xsl:call-template>
														</span>
													</xsl:when>
													<xsl:otherwise>
							...
							<xsl:for-each select="sst3:Goods">
								<tr>
									<td align="center" class="graph bordered">
										<xsl:value-of select="sst3:GoodsNumeric"/>
										<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
									</td>
									...
									<td colspan="2" align="center" class="graph  bordered">
										<xsl:value-of select="sst3:OriginCriterionCode"/>
										<xsl:if test="sst3:PercentPart">
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											<xsl:value-of select="sst3:PercentPart"/>
											<xsl:text> %</xsl:text>
										</xsl:if>
										<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
									</td>
							...
							<tr>
								<td colspan="4" class="border_vertical graph" valign="top">
									...
									<br/>
									<br/>
									<xsl:value-of select="sst3:SertifInf/sst3:OrganizationName"/>
									<br/>
										...
										<tbody>
											...
											<tr>
												...
												<td align="center" class="value underlined" colspan="2">
													<xsl:value-of select="sst3:AppDeclaration/sst3:AppCountry"/>
													<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
												</td>
											</tr>
											<tr>
							...
							<tr>
								<td class="border_vertical graph" colspan="4">
									<br/>
									<br/>
									<xsl:value-of select="sst3:SertifInf/sst3:FIO"/>
									<br/>
									<br/>
								</td>
								<td class="border_vertical graph" colspan="5">
									<br/>
									<br/>
									<xsl:value-of select="sst3:AppDeclaration/sst3:FIO"/>
									<br/>
									<br/>
								</td>
							</tr>
							<tr valign="bottom">
								<td style="border-left: 1px solid black;" class="value underlined">
									<xsl:value-of select="sst3:SertifInf/sst3:SignPlace"/>
								</td>
								<td align="center" class="value underlined">
									<xsl:call-template name="russian_date">
										<xsl:with-param name="dateIn" select="sst3:SertifInf/sst3:DateInf"/>
									</xsl:call-template>
								</td>
								<td class="value underlined" style="border-right:solid 1px black;" colspan="2"/>
								<td class="value underlined" colspan="2">
									<xsl:value-of select="sst3:AppDeclaration/sst3:SignPlace"/>
								</td>
								<td align="center" class="value underlined">
									<xsl:call-template name="russian_date">
										<xsl:with-param name="dateIn" select="sst3:AppDeclaration/sst3:DateInf"/>
									</xsl:call-template>
								</td>
	...
	<xsl:template mode="TransportMeans" match="*">
		<xsl:if test="sst3:TransportModeCode|sst3:TransportName|sst3:TransportNumber|sst3:TransportMeansNationalityCode">
			<xsl:text/>
			<xsl:value-of select="sst3:TransportName"/>
			<xsl:if test="sst3:TransportModeCode">
				<xsl:if test="sst3:TransportName">
					<xsl:text> (</xsl:text>
				</xsl:if>
				<xsl:value-of select="sst3:TransportModeCode"/>
				<xsl:if test="sst3:TransportName">
					<xsl:text>)</xsl:text>
				</xsl:if>
			</xsl:if>
			<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
			<xsl:value-of select="sst3:TransportNumber"/>
			<xsl:if test="sst3:TransportModeCode">
			...
			<xsl:if test="sst3:DepartureDate">
				...
				<xsl:call-template name="russian_date">
					<xsl:with-param select="sst3:DepartureDate" name="dateIn"/>
				</xsl:call-template>
			</xsl:if>
			<xsl:if test="sst3:UnloadPlace">
				...
				<xsl:value-of select="sst3:UnloadPlace"/>
			</xsl:if>
			<xsl:if test="sst3:Note">
				<xsl:text> (</xsl:text>
				<xsl:value-of select="sst3:Note"/>
				<xsl:text>)</xsl:text>
			</xsl:if>
		</xsl:if>
	</xsl:template>
		...
		<xsl:if test="catESAD_cu:PakageTypeCode=1">
			<xsl:if test="catESAD_cu:PakageQuantity!=''">
				...
				<xsl:if test="catESAD_cu:PakagePartQuantity">
                                        (<xsl:value-of select="catESAD_cu:PakagePartQuantity"/>-часть
                                        места)
