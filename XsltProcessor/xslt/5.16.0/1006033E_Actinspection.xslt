								...
								<tr>
									<td align="center">
										...
										<xsl:if test="ain:ActNumber">
											<xsl:text> № </xsl:text>
											<u>
												<xsl:value-of select="ain:ActNumber"/>
											</u>
										</xsl:if>
									</td>
								</tr>
							...
							<table width="100%">
								<tbody>
									<tr>
										...
										<td class="graph underlined" width="50%">
											<xsl:value-of select="ain:CountryCode"/>
											<xsl:text> </xsl:text>
											<xsl:value-of select="ain:CountryName"/>
											<xsl:text> </xsl:text>
											<xsl:choose>
							...
							<table width="100%">
								<tbody>
									<tr>
										...
										<td class="graph underlined" width="50%">
											<xsl:value-of select="ain:DocBruttoWeight"/>
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table width="100%">
									<tbody>
										<tr>
											...
											<td class="graph underlined" width="50%">
												<xsl:choose>
													<xsl:when test="ain:GoodsViolationFlag='0'">пробы и образцы товара не отбирались</xsl:when>
													<xsl:when test="ain:GoodsViolationFlag='1'">пробы и образцы товара отбирались</xsl:when>
												</xsl:choose>
											</td>
										</tr>
									</tbody>
									...
									<table width="100%">
										<tbody>
											<tr>
												...
												<td class="graph underlined" width="50%">
													<xsl:value-of select="ain:GoodsNumericDT"/>
												</td>
											</tr>
										</tbody>
									</table>
