						...
						<tbody>
							...
							<xsl:if test="grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardName">
								<tr>
									...
									<td>
										<xsl:value-of select="grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardName"/>
									</td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:FullIdentityCardName">
								<tr>
									...
									<td style="vertical-align: bottom;">
										<xsl:value-of select="grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:FullIdentityCardName"/>
									</td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardSeries or grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardNumber">
								<tr>
									...
									<td>
										<xsl:value-of select="grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardSeries"/>
										<xsl:value-of select="grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardNumber"/>
									</td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardDate">
								<tr>
									...
									<td>
										<xsl:call-template name="russian_date">
											<xsl:with-param name="dateIn" select="grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardDate"/>
										</xsl:call-template>
									</td>
								</tr>
							</xsl:if>
							<xsl:if test="grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:OrganizationName">
								<tr>
									...
									<td>
										<xsl:value-of select="grn_bnk:Principal/RUScat_ru:IdentityCard/RUScat_ru:OrganizationName"/>
									</td>
								</tr>
							</xsl:if>
							<tr>
