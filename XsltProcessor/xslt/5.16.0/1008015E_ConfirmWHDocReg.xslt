										...
										<tbody>
											<tr>
												...
												<td width="40%" align="center" class="graph value">/<xsl:value-of select="condr:CustomsPerson/cat_ru:PersonSurname"/>
													...
													<xsl:text> </xsl:text>
											ЛНП: <xsl:value-of select="condr:CustomsPerson/catWH_ru:LNP"/>/</td>
											</tr>
											<tr>
