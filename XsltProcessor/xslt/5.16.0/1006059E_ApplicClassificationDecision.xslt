								...
								<tr>
									<td>
										...
										<xsl:choose>
											...
											<xsl:otherwise><xsl:value-of select="acd:CustomsModeCode"/></xsl:otherwise>
										</xsl:choose>
										<br/>
				...
				<xsl:if test="acd:IDDoc='КР'">
					<div class="page">
						...
						<table>
							<tbody>
								<tr align="center" valign="top">
									<td class="bordered">№ компо- нента товара</td>
									<td class="bordered">Наименование компонента товара</td>
									<td class="bordered">Код в соответствии с единой Товарной номенклатурой внешнеэкономической деятельности ЕАЭС</td>
									<td class="bordered">Коли- чество</td>
									<td class="bordered">Единица измерения</td>
									<td class="bordered">Вес нетто (килограмм)</td>
								</tr>
