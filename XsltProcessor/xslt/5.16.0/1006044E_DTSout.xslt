...
<xsl:stylesheet version="1.0" xmlns:DTSout="urn:customs.ru:Information:CustomsDocuments:DTSout:5.16.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.16.0" xmlns:cat_EDTS_cu="urn:customs.ru:CUESADDTSCommonAggregateTypes:5.16.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:RUDECLcat="urn:customs.ru:RUDeclCommonAggregateTypesCust:5.16.0" xmlns:cat_EDTS_ru="urn:customs.ru:RUESADDTSCommonAggregateTypes:5.16.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
								...
								<tbody>
									...
									<tr>
										<td class="graph" style="width:80mm;border-left:solid 0.8pt #000000;border-right:solid 0.8pt #000000;" valign="top">
											...
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
											<xsl:call-template name="russian_date">
												<xsl:with-param name="dateIn" select="DTSout:DTSoutFilledPerson/cat_EDTS_cu:FilledDate"/>
											...
											<xsl:if test="DTSout:DTSoutFilledPerson/catESAD_cu:IdentityCard">
												<xsl:value-of select="DTSout:DTSoutFilledPerson/catESAD_cu:IdentityCard/catESAD_cu:IdentityCardName"/>
												<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
												<xsl:value-of select="DTSout:DTSoutFilledPerson/catESAD_cu:IdentityCard/catESAD_cu:IdentityCardSeries"/>
												<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
												<xsl:value-of select="DTSout:DTSoutFilledPerson/catESAD_cu:IdentityCard/catESAD_cu:IdentityCardNumber"/>
												<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
												<xsl:call-template name="russian_date">
													<xsl:with-param name="dateIn" select="DTSout:DTSoutFilledPerson/catESAD_cu:IdentityCard/catESAD_cu:IdentityCardDate"/>
												</xsl:call-template>
												<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
												<xsl:value-of select="DTSout:DTSoutFilledPerson/catESAD_cu:IdentityCard/catESAD_cu:OrganizationName"/>
											</xsl:if>
												...
												<td class="graph" style="width:90mm;border:solid 0.8pt #000000;" valign="top">
													...
													<span class="graph">(курс пересчета 
														...
														<xsl:if test="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS3Method1/cat_EDTS_ru:Method1CalculationBasis/cat_EDTS_cu:DealCurrencyDate">
															, дата применения курса: <xsl:call-template name="russian_date">
																<xsl:with-param name="dateIn" select="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS3Method1/cat_EDTS_ru:Method1CalculationBasis/cat_EDTS_cu:DealCurrencyDate"/>
															</xsl:call-template>
														</xsl:if>
														<xsl:text>)</xsl:text>
													</span>
											...
											<td class="graph" style="width:90mm;border:solid 0.8pt #000000;" valign="top">
												...
												<span class="graph">(курс пересчета 
													...
													<xsl:if test="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS3Method1/cat_EDTS_ru:Method1CalculationBasis/cat_EDTS_cu:IndirectCurrencyDate">
														, дата применения курса: <xsl:call-template name="russian_date">
															<xsl:with-param name="dateIn" select="cat_EDTS_ru:CustomsCostCalculation/cat_EDTS_ru:DTS3Method1/cat_EDTS_ru:Method1CalculationBasis/cat_EDTS_cu:IndirectCurrencyDate"/>
														</xsl:call-template>
													</xsl:if>
													<xsl:text>)</xsl:text>
												</span>
														...
														<xsl:for-each select="cat_EDTS_ru:DTSCurrencyPayment">
															<tr>
																...
																<td class="graph" style="width:40mm;" valign="top">
																	<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
																	<xsl:call-template name="russian_date">
																		<xsl:with-param name="dateIn" select="cat_EDTS_cu:CurrencyDate"/>
																	</xsl:call-template>
																</td>
															</tr>
														</xsl:for-each>
														...
														<xsl:for-each select="cat_EDTS_ru:AdditionalData">
															...
															<xsl:if test="cat_EDTS_cu:CVDAdditionalInformationKindCode">
																...
																<xsl:choose>
																	...
																	<xsl:otherwise><xsl:value-of select="cat_EDTS_cu:CVDAdditionalInformationKindCode"/></xsl:otherwise>
																</xsl:choose>
															</xsl:if>
															<xsl:if test="cat_EDTS_cu:CustomsDocIdDetails">
																<xsl:text> / </xsl:text>
