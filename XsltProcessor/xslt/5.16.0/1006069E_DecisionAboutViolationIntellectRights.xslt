											...
											<td>
												<table width="100%">
													<tbody>
														...
														<tr>
															<td>
																<xsl:text>3. Наименование товара:</xsl:text>
															</td>
															<td/>
															<td class="value">
														...
														<tr>
															<td>
																<xsl:text>5. Декларант (место нахождения (адрес)</xsl:text>
															</td>
															<td/>
															<td class="value">
			...
			<table>
				<tr>
					...
					<td class="value graphMain" style="width:50%">
						<xsl:apply-templates select="cat_ru:CustomsCode"/>
						<xsl:text>/</xsl:text>
						<xsl:apply-templates select="cat_ru:RegistrationDate" mode="DT_date"/>
						<!--<xsl:call-template name="DT_date">
							<xsl:with-param name="dateIn" select="cat_ru:RegistrationDate"/>
						</xsl:call-template>-->
						<xsl:text>/</xsl:text>
