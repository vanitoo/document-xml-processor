		...
		<html>
			...
			<body>
				<div class="page">
					...
					<br/>
					<xsl:choose>
						<xsl:when test="pcd_bd:TransportMeans/pcd_bd:TransportMeansDetails[substring(cat_ru:TransportKindCode,1,1)='3']">
							<xsl:for-each select="pcd_bd:TransportMeans/pcd_bd:TransportMeansDetails[substring(cat_ru:TransportKindCode,1,1)='3']">
