								...
								<tbody>
											...
											<table width="100%">
												<tbody>
													<tr>
														...
														<td align="center" width="20%" class="value">
															<xsl:apply-templates select="aoir:Answer/aoir:NotifDecisionNumber/cat_ru:PrDocumentDate" mode="date_2"/>
														</td>
														<td align="right" width="45%">
															<xsl:text>№ </xsl:text>
														</td>
														<td align="center" class="value" width="30%">
															<xsl:apply-templates select="aoir:Answer/aoir:NotifDecisionNumber/cat_ru:PrDocumentNumber"/>
														</td>
													</tr>
												</tbody>
											</table>
									...
									<xsl:choose>
												...
												<td>
													<table width="100%">
														<tbody>
															...
															<tr>
																<td class="underlined">
																	<xsl:text>с согласия правообладателя (с соблюдением порядка порядка исчерпания исключительного права на товарный знак)</xsl:text>
																</td>
																<td/>
																<td/>
															</tr>
													...
													<table width="100%">
														<tbody>
															<tr>
																...
																<td valign="bottom" rowspan="2" class="value" width="15%">
										...
										<xsl:when test="aoir:Answer/aoir:AnswerCode = '3' ">
													...
													<td>
														<table width="100%">
															<tbody>
																...
																<tr>
																	<td class="underlined">
																		<xsl:text>размещением на них средств индивидуализации (товарные знаки, наименования мест происхождения, географические указния)</xsl:text>
																	</td>
																	<td/>
																	<td/>
																</tr>
											...
											<tr>
												<td>
													<xsl:text>Основания для продления срока приостановления срока выпуска товаров: </xsl:text>
												</td>
											</tr>
											<tr>
												<td>
													<table width="100%">
														<tbody>
															<tr>
																...
																<td rowspan="2" class="value" width="18%">
																...
																<td rowspan="2" width="3%"/>
																<td rowspan="2" class="value" width="15%">
																	<xsl:for-each select="aoir:DocumentsList">
																		<xsl:choose>
																			<xsl:when test="aoir:DocKind='1'">
			...
			<tbody>
				...
				<xsl:if test="aoir:RightHolderLegal">
					...
					<tr>
						...
						<td class="value graphMain">
							<xsl:apply-templates select="aoir:INNCertificateDate" mode="date"/>
							<!--<xsl:call-template name="russian_date">
					...
					<tr>
						...
						<td class="value graphMain">
							<xsl:apply-templates select="aoir:RegistrationNumber"/>
						</td>
					</tr>
					<tr>
						<td class="annot graphMain">Дата государственной регистрации</td>
						<td class="value graphMain">
							<xsl:apply-templates select="aoir:RegistrationDate" mode="date"/>
							<!--<xsl:call-template name="russian_date">
					...
					<tr>
						...
						<td class="value graphMain">
							<xsl:apply-templates select="aoir:LegalLocation"/>
						</td>
					</tr>
				</xsl:if>
				<xsl:if test="aoir:RightHolderForeignLegal">
					...
					<tr>
						...
						<td class="value graphMain">
							<xsl:apply-templates select="aoir:RegistrationPlace"/>
						</td>
					</tr>
					<tr>
						<td class="annot graphMain">Полный адрес организации (на иностранном языке)</td>
						<td class="value graphMain">
							<xsl:apply-templates select="aoir:FullAddressForeign"/>
						</td>
					</tr>
				</xsl:if>
			</tbody>
