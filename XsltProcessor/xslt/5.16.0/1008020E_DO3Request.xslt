                  ...
                  <tbody>
                     ...
                     <tr>
                        <td class="graph" style="width:180mm;">
                           ...
                           <xsl:text> </xsl:text>
                           <xsl:if test="do3re:CustomsPerson/cat_ru:LNP">ЛНП: 
											<xsl:value-of select="do3re:CustomsPerson/cat_ru:LNP"/>
                           </xsl:if>
                           <br/>
