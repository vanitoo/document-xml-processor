...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:pttf="urn:customs.ru:Information:ExchangeDocuments:PetitionToFTS:5.14.5" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:CategoryCust="urn:customs.ru:Categories:3.0.0">
				...
				<div class="page">
					<table width="100%" class="annot graphMain">
						<tbody>
							...
							<xsl:if test="pttf:PetitionOrganization/pttf:Organization/cat_ru:Address">
								<tr>
									<td>
										<br/>
									</td>
								...
								<tr>
									<td class="value graphMain">
										<xsl:if test="pttf:PetitionOrganization/pttf:Organization/cat_ru:OKATOCode">
											<xsl:text> ОКАТО: </xsl:text>
											<xsl:value-of select="pttf:PetitionOrganization/pttf:Organization/cat_ru:OKATOCode"/>
										</xsl:if>
										<xsl:apply-templates select="pttf:PetitionOrganization/pttf:Organization/cat_ru:Address" mode="AdressStr"/>
									</td>
								</tr>
							</xsl:if>
							<xsl:if test="pttf:PetitionOrganization/pttf:Organization/cat_ru:Contact">
								<tr>
									<td>
										<br/>
									</td>
								...
								<tr>
									<td class="value graphMain">
										<xsl:for-each select="pttf:PetitionOrganization/pttf:Organization/cat_ru:Contact">
