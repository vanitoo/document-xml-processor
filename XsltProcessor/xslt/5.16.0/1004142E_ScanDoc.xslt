...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:scd="urn:customs.ru:Information:ExchangeDocuments:ScanDoc:5.16.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0">
				...
				<div class="page" style="width: {$w}mm;">
					...
					<table>
						<tr>
							...
							<td class="value graphMain" style="width:50%">
								<xsl:apply-templates select="scd:SendDate"/>
							</td>
						</tr>
					</table>
					<xsl:if test="scd:ScanDate">
						<table>
							<tr>
								...
								<td class="value graphMain" style="width:50%">
									<xsl:apply-templates select="scd:ScanDate"/>
								</td>
							</tr>
						</table>
					</xsl:if>
	...
	<xsl:template match="scd:CustDocNumber">
		...
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<xsl:if test="scd:DTRegNum">
				<div class="title marg-top">Регистрационный номер ДТ/Заявления/ТД/Уведомления о прибытии</div>
				<div>
	...
	<xsl:template match="scd:RequestedDoc">
		...
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			...
			<table>
				<tr>
					<td class="annot graphMain" style="width:50%">Идентафикатор позиции</td>
					<td class="value graphMain" style="width:50%">
			...
			<xsl:if test="scd:Note">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Причина предоставления документа</td>
						<td class="value graphMain" style="width:50%">
							<xsl:apply-templates select="scd:Note"/>
						</td>
					</tr>
				</table>
			</xsl:if>
			<xsl:if test="scd:Note">
				<table>
					<tr>
						...
						<td class="value graphMain" style="width:50%">
							<xsl:apply-templates select="scd:ScanInfo">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</td>
					</tr>
