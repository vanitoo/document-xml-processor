...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:pn="urn:customs.ru:Information:ExchangeDocuments:ProlongationNotif:5.16.0" xmlns:mpco="urn:customs.ru:Information:CustomsDocuments:MPOCommon:5.16.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
