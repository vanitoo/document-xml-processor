...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:catESAD_ru="urn:customs.ru:RUCommonAggregateTypes:5.16.0" xmlns:repapp="urn:customs.ru:Information:CustomsDocuments:RepresentativeApplication:5.16.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0">
				...
				<div class="album_page">
                    ...
                    Таможенные сборы
					  ...
					  страна: <xsl:value-of select="repapp:Consignor/repapp:ConsignorCountryCode"/>
						    ...
						    <xsl:value-of select="repapp:Consignor/RUScat_ru:IdentityCard/RUScat_ru:IdentityCardNumber"/></xsl:if>-->
										</span>
									</td>
									<td style="border-top: 2px solid black;">
										<span class="graph">
														...
														<xsl:if test="repapp:URLGood">
															<tr>
																<td style="border: 0px; word-break: break-all;">
																	...
																	<a href="{repapp:URLGood}"><xsl:value-of select="repapp:URLGood"/></a> 
																</td>
															</tr>
														</xsl:if>
													</table>
