...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.16.0" xmlns:catESAD_ru="urn:customs.ru:RUCommonAggregateTypes:5.16.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:rmpo="urn:customs.ru:Information:CustomsDocuments:RegisterMPO:5.16.0">
	...
	<xsl:template match="RUScat_ru:SubjectAddressDetails|rmpo:Address">
		<xsl:choose>
	...
	<xsl:template match="rmpo:Representative">
		...
		<xsl:if test="RUScat_ru:SubjectAddressDetails">
			<table class="w190">
				<tr>
					<td class="graphMain" style="width:50%"><b>Адрес организации</b></td>
					<td class="value graphMain" style="width:50%">
