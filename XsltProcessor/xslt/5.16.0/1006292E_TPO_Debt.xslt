			...
			<body>
				<div class="page" style="width: {$w}mm;">
					...
					<xsl:if test="tpodbt:GoodsIndivisibleHaveSign">
						<table>
							<tr>
								<td class="annot graphMain" style="width:50%">Наличие неделимых товаров весом свыше 35 кг, товаров общим весом свыше 50 кг и (или) общей таможенной стоимостью свыше 1500 евро (1 или true - да; 0 или false - нет)</td>
								<td class="value graphMain" style="width:50%">
									<xsl:choose>
	...
	<xsl:template match="tpodbt:Goods">
		...
		<!--div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;"-->
			<tr>
				...
				<td class="graphMain bordered">
					<xsl:for-each select="tpodbt:GoodsDescription">
				...
				<td class="graphMain bordered">
					<xsl:apply-templates select="tpodbt:OriginCountryCode"/>
				</td>
				<td class="graphMain bordered">
	...
	<xsl:template match="tpodbt:RateDetails">
		...
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<xsl:if test="tpodbt:DutyTaxFeeRateKindCode">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Вид ставки (% - адвалорная, * - специфическая, S – признак сборов для РК)</td>
						<td class="value graphMain" style="width:50%">
			...
			<xsl:if test="tpodbt:UnifiedMeasurementUnitCode">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Кодовое обозначение единицы измерения (кг, л и т.п.)</td>
						<td class="value graphMain" style="width:50%">
			...
			<xsl:if test="tpodbt:UnifiedCurrencyN3Code">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Цифровое кодовое обозначение валюты ставки (специфическая ставка)</td>
						<td class="value graphMain" style="width:50%">
							<xsl:apply-templates select="tpodbt:UnifiedCurrencyN3Code"/>
						</td>
					</tr>
			...
			<xsl:if test="tpodbt:RateQualifierCode">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Код единицы измерения ставки</td>
						<td class="value graphMain" style="width:50%">
