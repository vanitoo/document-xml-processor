					...
					<xsl:if test="$goods/catESAD_cu:CIMIdDetails">
						...
						<xsl:for-each select="$goods/catESAD_cu:CIMIdDetails">
							...
							<xsl:for-each select="catESAD_cu:CIMList">
								<xsl:value-of select="catESAD_cu:CIMID"/>
