...
<xsl:stylesheet version="1.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.16.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:gode="urn:customs.ru:Information:CustomsDocuments:GoodsDeclaration:5.16.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
