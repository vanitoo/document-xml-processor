...
<xsl:stylesheet exclude-result-prefixes="rrg cat_ru" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:rrg="urn:customs.ru:Information:ExchangeDocuments:RepudRecallGTD:5.24.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
