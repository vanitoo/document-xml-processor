...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:drnn="urn:customs.ru:Information:ExchangeDocuments:DocumentRegNumberNotif:5.24.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
	<!-- Шаблон для типа DocumentRegNumberNotifType -->
		...
		<html>
			...
			<body>
				<div class="page" style="width: {$w}mm;">
						...
						<tbody>
							<tr>
								<td align="center" class="title">
									<font size="4">
										<b>Уведомление о регистрации документа (пакета документов)</b>
									</font>
								</td>
							</tr>
						</tbody>
					...
					<table>
						<tr>
							<td class="annot graphMain" style="width:50%">Уникальный номер документа (пакета документов)</td>
							<td class="graphMain value" style="width:50%">
								<xsl:for-each select="drnn:DocumentRegNumber">
	...
	<!-- Шаблон для типа drnn:TDTSOpenVVRegNumberType -->
	<xsl:template match="drnn:TDTSOpenVVRegNumber">
		...
		<xsl:variable name="w" select="$wdth - 5"/>
					...
					<xsl:text> </xsl:text>
					<xsl:for-each select="drnn:TransportIdentifier">
	...
	<xsl:template match="//*[local-name()='DocumentRegNumberNotif']//*" priority="-1">
