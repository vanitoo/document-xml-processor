...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.24.0" xmlns:stz_dpcp="urn:customs.ru:Information:ExchangeDocuments:STZ_DecisionProlongOrCancelPermit:5.27.0">
	<!-- Шаблон для типа STZ_DecisionProlongOrCancelPermitType -->
	<xsl:template match="stz_dpcp:STZ_DecisionProlongOrCancelPermit">
		...
		<html>
			...
			<body>
				<div class="page" style="width: {$w}mm;">
						...
						<tbody>
							<tr>
								<td align="center" class="title">
									<font size="4">
										<b>Сообщение о продлении срока или аннулировании  разрешения таможенного органа на совершение операций, предусмотренных подпунктами 1, 2 и 5 пункта 4 статьи 205 Таможенного кодекса Евразийского экономического союза</b>
									</font>
								</td>
							</tr>
						</tbody>
					...
					<br/>
					<xsl:if test="stz_dpcp:Customs">
						<div class="title marg-top">Сведения о таможенном органе</div>
						<div>
							<xsl:apply-templates select="stz_dpcp:Customs">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
					<xsl:if test="stz_dpcp:Resident">
						<div class="title marg-top">Сведения о лице, которому направляется сообщение</div>
						<div>
							<xsl:apply-templates select="stz_dpcp:Resident">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
					<table>
						<tr>
							...
							<td class="value graphMain" style="width:50%">
								<xsl:choose>
									<xsl:when test="stz_dpcp:Operation='1'">
										<xsl:text>аннулирование разрешения</xsl:text>
									</xsl:when>
									<xsl:when test="stz_dpcp:Operation='2'">
										<xsl:text>продление срока действия разрешения</xsl:text>
									</xsl:when>
									<xsl:otherwise>
										<xsl:value-of select="stz_dpcp:Operation"/>
									</xsl:otherwise>
								</xsl:choose>
							</td>
						</tr>
					</table>
					<xsl:if test="stz_dpcp:AppRegNumber">
						<div class="title marg-top">Номер поданного заявления на совершение операций</div>
						<div>
							<xsl:apply-templates select="stz_dpcp:AppRegNumber">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
					<xsl:if test="stz_dpcp:PermitRegNumber">
						<div class="title marg-top">Регистрационный номер полученного Разрешения таможенного органа</div>
						<div>
							<xsl:apply-templates select="stz_dpcp:PermitRegNumber">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
					<xsl:if test="stz_dpcp:CancelPermit">
						<div class="title marg-top">Решение по аннулированию</div>
						<div>
							<xsl:apply-templates select="stz_dpcp:CancelPermit">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
					<xsl:if test="stz_dpcp:Prolong">
						<div class="title marg-top">Решение по продлению</div>
						<div>
							<xsl:apply-templates select="stz_dpcp:Prolong">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
					<xsl:if test="stz_dpcp:Notes">
						<table>
							<tr>
								<td class="annot graphMain" style="width:50%">Примечание</td>
								<td class="value graphMain" style="width:50%">
									<xsl:apply-templates select="stz_dpcp:Notes"/>
								</td>
							</tr>
						</table>
					</xsl:if>
					<xsl:if test="stz_dpcp:CustomsPerson">
						<div class="title marg-top">Должностное лицо таможенного органа</div>
						<div>
							<xsl:apply-templates select="stz_dpcp:CustomsPerson">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
	...
	<!-- Шаблон для типа stz_dpcp:RegistrationNumberType -->
	<xsl:template match="stz_dpcp:AppRegNumber">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<table>
				<tr>
					...
					<td class="value graphMain" style="width:50%">
						<xsl:apply-templates select="stz_dpcp:CustomsCode"/>
					</td>
				</tr>
			</table>
			<table>
				<tr>
					...
					<td class="value graphMain" style="width:50%">
						<xsl:apply-templates select="stz_dpcp:RegistrationDate" mode="russian_date"/>
					</td>
				</tr>
			</table>
			<table>
				<tr>
					...
					<td class="value graphMain" style="width:50%">
						<xsl:apply-templates select="stz_dpcp:Number"/>
					</td>
				</tr>
			</table>
			<xsl:if test="stz_dpcp:DocKind">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Четвертая часть регистрационного номера документа</td>
						<td class="value graphMain" style="width:50%">
							<xsl:apply-templates select="stz_dpcp:DocKind"/>
						</td>
					</tr>
				</table>
			</xsl:if>
	...
	<!-- Шаблон для типа stz_dpcp:CancelPermitType -->
	<xsl:template match="stz_dpcp:CancelPermit">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<table>
				<tr>
					<td class="annot graphMain" style="width:50%">Решение: 0- аннулирование разрешено; 1 - в аннулировании отказано</td>
					<td class="value graphMain" style="width:50%">
						<xsl:choose>
							<xsl:when test="stz_dpcp:DecisionCancelPermit='true' or stz_dpcp:DecisionCancelPermit='1'">
								<xsl:text>ДА</xsl:text>
							</xsl:when>
							<xsl:when test="stz_dpcp:DecisionCancelPermit='false' or stz_dpcp:DecisionCancelPermit='0'">
								<xsl:text>НЕТ</xsl:text>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="stz_dpcp:DecisionCancelPermit"/>
							</xsl:otherwise>
						</xsl:choose>
					</td>
				</tr>
			</table>
			<xsl:if test="stz_dpcp:CancelReasonRefus">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Причина отказа в аннулировании</td>
						<td class="graphMain value" style="width:50%">
							<xsl:for-each select="stz_dpcp:CancelReasonRefus">
								<xsl:value-of select="."/>
								<xsl:if test="position()!=last()">
									<xsl:text>, </xsl:text>
								</xsl:if>
	...
	<xsl:template match="stz_dpcp:Customs">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<table>
	...
	<xsl:template match="stz_dpcp:CustomsPerson">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
	...
	<!-- Шаблон для типа stz_dpcp:RegistrationNumberType -->
	<xsl:template match="stz_dpcp:PermitRegNumber">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<table>
	...
	<!-- Шаблон для типа stz_dpcp:ProlongType -->
	<xsl:template match="stz_dpcp:Prolong">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<table>
				<tr>
					<td class="annot graphMain" style="width:50%">Решение: 0- продление разрешено; 1 - в продлении отказано</td>
					<td class="value graphMain" style="width:50%">
						<xsl:choose>
							<xsl:when test="stz_dpcp:DecisionProlong='true' or stz_dpcp:DecisionProlong='1'">
								<xsl:text>ДА</xsl:text>
							</xsl:when>
							<xsl:when test="stz_dpcp:DecisionProlong='false' or stz_dpcp:DecisionProlong='0'">
								<xsl:text>НЕТ</xsl:text>
							</xsl:when>
							<xsl:otherwise>
								<xsl:value-of select="stz_dpcp:DecisionProlong"/>
							</xsl:otherwise>
						</xsl:choose>
					</td>
				</tr>
			</table>
			<xsl:if test="stz_dpcp:ExtImpTerm">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Срок, до которого продляется срок вывоза товаров</td>
						<td class="value graphMain" style="width:50%">
							<xsl:apply-templates select="stz_dpcp:ExtImpTerm" mode="russian_date"/>
						</td>
					</tr>
				</table>
			</xsl:if>
			<xsl:if test="stz_dpcp:ProlongReasonRefus">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Причина отказа в продлении срока</td>
						<td class="graphMain value" style="width:50%">
							<xsl:for-each select="stz_dpcp:ProlongReasonRefus">
								<xsl:value-of select="."/>
								<xsl:if test="position()!=last()">
									<xsl:text>, </xsl:text>
								</xsl:if>
	...
	<!-- Шаблон для типа stz_dpcp:ResidentType -->
	<xsl:template match="stz_dpcp:Resident">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			...
			<xsl:if test="stz_dpcp:ResidentCertificate">
				<div class="title marg-top">Cвидетельство о включении в реестр резидентов</div>
				<div>
					<xsl:apply-templates select="stz_dpcp:ResidentCertificate">
						<xsl:with-param name="wdth" select="$w"/>
					</xsl:apply-templates>
				</div>
			</xsl:if>
	...
	<!-- Шаблон для типа stz_dpcp:ResidentCertificateType -->
	<xsl:template match="stz_dpcp:ResidentCertificate">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<table>
				<tr>
					...
					<td class="value graphMain" style="width:50%">
						<xsl:apply-templates select="stz_dpcp:CertificateNumber"/>
					</td>
				</tr>
			</table>
			<table>
				<tr>
					...
					<td class="value graphMain" style="width:50%">
						<xsl:apply-templates select="stz_dpcp:CertificateDate" mode="russian_date"/>
					</td>
				</tr>
			</table>
			<xsl:if test="stz_dpcp:CertificateValidity">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Срок действия</td>
						<td class="value graphMain" style="width:50%">
							<xsl:apply-templates select="stz_dpcp:CertificateValidity" mode="russian_date"/>
						</td>
					</tr>
				</table>
			</xsl:if>
			<xsl:if test="stz_dpcp:CertificateAgency">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Наименование органа, выдавшего свидетельство</td>
						<td class="value graphMain" style="width:50%">
							<xsl:apply-templates select="stz_dpcp:CertificateAgency"/>
						</td>
					</tr>
				</table>
			</xsl:if>
	...
	<xsl:template match="//*[local-name()='STZ_DecisionProlongOrCancelPermit']//*" priority="-1">
