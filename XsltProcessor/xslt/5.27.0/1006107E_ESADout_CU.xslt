...
<xsl:stylesheet exclude-result-prefixes="ESADout_CU cat_ru catESAD_cu" version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:catESAD_ru="urn:customs.ru:RUCommonAggregateTypes:5.27.0" xmlns:ESADout_CU="urn:customs.ru:Information:CustomsDocuments:ESADout_CU:5.27.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.27.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.24.0" xmlns:RUDECLcat="urn:customs.ru:RUDeclCommonAggregateTypesCust:5.27.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:goom="urn:customs.ru:Information:CustomsDocuments:GTDoutCustomsMark:5.27.0" xmlns:nGTDr="urn:customs.ru:Information:ExchangeDocuments:NotifGTDRegistration:5.24.0">
	<xsl:output doctype-public="-//W3C//DTD XHTML 1.0 Strict//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd" encoding="utf-8" indent="yes" media-type="text/html" method="html" omit-xml-declaration="yes" version="1.0"/>
	<xsl:variable name="k" select="1"/>
	
	<xsl:param name="strictView" select="0"/><!-- специальный вид, strictView = 1: А, 5, 14, 31, 32, 33, 41, 54, С -->
	...
	<xsl:template name="get_xpath">
		...
		<xsl:for-each select="$node/ancestor-or-self::*">
			...
			<xsl:value-of select="concat(name(),'[',count(preceding-sibling::*[name()=name(current())]),']')"/>
		</xsl:for-each>
	</xsl:template>
	<xsl:template match="/">
		<html>
								...
								<tr>
									...
									<td valign="top">
										<table class="addInfo" style="width: 100%;">
											<tr>
												<td class="graph" style="border: 0;">
													<span class="graphNo">С</span>
													<br/>													
													<xsl:for-each select="//*[@DocumentModeID='1006078E']/goom:GTDOutGoodsResolution[position() &gt;= $firstEntryPos and position() &lt;= $firstEntryPos + 2]/goom:GTDOutGoodsResult[catESAD_ru:DecisionCode = 10 or catESAD_ru:DecisionCode = 90]">
														<xsl:if test="position() = 1"><xsl:text>2 - </xsl:text></xsl:if>
														<xsl:apply-templates select="catESAD_ru:DecisionCode"/>
														<xsl:text> </xsl:text>
														<xsl:apply-templates select="catESAD_ru:DateInf" mode="russian_date_gtd"/>
														<xsl:text> </xsl:text>
														<xsl:apply-templates select="goom:FoundationDes/goom:ResolutionDescription"/>
														<xsl:text> </xsl:text>
														<xsl:apply-templates select="goom:PersonName"/>
														<xsl:text> </xsl:text>
	...
	<xsl:template match="ESADout_CU:ESADout_CUGoodsShipment">
				...
				<xsl:otherwise>
					...
					<tr>
						...
						<td class="graph" rowspan="3" style="width:{60.6*$k}mm;border-bottom:solid 0.8pt black;" valign="top">
							<xsl:if test="//*[@DocumentModeID='1006078E']/goom:GTDOutCommonMark/catESAD_ru:GRNumber='A'">
				...
				<td rowspan="3" style="width:{86*$k}mm;border:solid 0.8pt black;background:#FFFFFF;">
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr valign="top">
							...
							<!--td class="graph" style="width:{43*$k}mm;">
								<xsl:if test="ESADout_CU:ESADout_CUConsignor/RUDECLcat:AEORegistryIdDetails/catESAD_cu:DocId">
									<xsl:text>№ </xsl:text>
									<xsl:apply-templates select="ESADout_CU:ESADout_CUConsignor/RUDECLcat:AEORegistryIdDetails/catESAD_cu:DocId"/>
								</xsl:if>
							</td-->
							<td class="graph" style="width:{43*$k}mm;">
								<xsl:for-each select="ESADout_CU:ESADout_CUConsignor">
									<xsl:choose>
										...
										<xsl:otherwise>
											<xsl:if test="//ESADout_CU:CustomsProcedure='ИМ' and RUDECLcat:AEORegistryIdDetails/catESAD_cu:DocId">
												<xsl:text>№ </xsl:text>
												<xsl:apply-templates select="RUDECLcat:AEORegistryIdDetails/catESAD_cu:DocId"/>
											</xsl:if>
											<!--xsl:text>№ </xsl:text>
											<xsl:if test="cat_ru:RBOrganizationFeatures/cat_ru:UNP">
						...
						<tr>
							<td class="graph" colspan="2" style="width:{86*$k}mm;">
								<xsl:choose>
									<xsl:when test="$strictView = 1"></xsl:when>
									<xsl:otherwise>
										<xsl:for-each select="ESADout_CU:ESADout_CUConsignor">
											<xsl:apply-templates select="."/>
										</xsl:for-each>
				...
				<td rowspan="2" style="width:{86*$k}mm;border:solid 0.8pt black;background:#FFFFFF;">
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
							...
							<!--td class="graph" style="width:{43*$k}mm;">
								<xsl:if test="ESADout_CU:ESADout_CUConsignee/RUDECLcat:AEORegistryIdDetails/catESAD_cu:DocId">
									<xsl:text>№ </xsl:text>
									<xsl:apply-templates select="ESADout_CU:ESADout_CUConsignee/RUDECLcat:AEORegistryIdDetails/catESAD_cu:DocId"/>
								</xsl:if>
							</td-->
							<td class="graph" style="width:{43*$k}mm;">
								<xsl:for-each select="ESADout_CU:ESADout_CUConsignee">
									<xsl:choose>
										...
										<xsl:otherwise>
											<xsl:if test="//ESADout_CU:CustomsProcedure='ЭК' and RUDECLcat:AEORegistryIdDetails/catESAD_cu:DocId">
												<xsl:text>№ </xsl:text>
												<xsl:apply-templates select="RUDECLcat:AEORegistryIdDetails/catESAD_cu:DocId"/>
											</xsl:if>
											<!--xsl:text>№ </xsl:text>
						...
						<tr>
							<td class="graph" colspan="2" style="width:{86*$k}mm;">
								<xsl:choose>
									<xsl:when test="$strictView = 1"></xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="ESADout_CU:ESADout_CUConsignee"/>
									</xsl:otherwise>
								</xsl:choose>
							...
							<td class="graph" rowspan="2" style="width:{43.6*$k}mm;border-left:solid 0.8pt black;border-right:solid 0.8pt black;">
								...
								<xsl:choose>
									...
									<xsl:otherwise>
										...
										<xsl:choose>
											<xsl:when test="translate(catESAD_cu:CustCostCurrencyCode, 'rub', 'RUB') != 'RUB'">
												<xsl:text> </xsl:text>
												<xsl:apply-templates select="catESAD_cu:CustCostCurrencyCode"/>
											</xsl:when>
											<xsl:otherwise><!--ничего не выводим--></xsl:otherwise>
										</xsl:choose>
									</xsl:otherwise>
								</xsl:choose>
							...
							<td class="graph" style="width:{56.3*$k}mm;background:#FFFFFF;">
								<xsl:choose>
									...
									<xsl:when test="ESADout_CU:ESADout_CUConsigment/ESADout_CU:ESADout_CUDepartureArrivalTransport">
										...
										<xsl:text>:</xsl:text>
										<xsl:for-each select="ESADout_CU:ESADout_CUConsigment/ESADout_CU:ESADout_CUDepartureArrivalTransport/ESADout_CU:RUTransportMeans">
											<xsl:variable name="currentTransportCode" select="cat_ru:TransportKindCode"/>
											<xsl:variable name="nextTransportCode" select="following-sibling::ESADout_CU:RUTransportMeans[1]/cat_ru:TransportKindCode"/>
											<xsl:variable name="codeList" select="'201 202 203 204 205 206 301 302 303 304 305 306 307'"/>
											<xsl:if test="$currentTransportCode and not(contains($codeList, $currentTransportCode)) and position() != 1">
												<xsl:text> / </xsl:text>
											</xsl:if>
											<xsl:apply-templates select="cat_ru:TransportIdentifier"/>
											<xsl:if test="(not($currentTransportCode) or contains($codeList, $nextTransportCode)) and position() != last()">
												<xsl:text>; </xsl:text>
											</xsl:if>
											
											<!--xsl:variable name="transportID" select="cat_ru:TransportIdentifier"/>
											<xsl:for-each select="../ESADout_CU:RUTransportMeans[cat_ru:ActiveTransportIdentifier = $transportID]">
												<xsl:text> / </xsl:text>
												<xsl:apply-templates select="cat_ru:TransportIdentifier"/>
											</xsl:for-each-->
										</xsl:for-each>
								...
								<xsl:choose>
									...
									<xsl:when test="ESADout_CU:ESADout_CUConsigment/ESADout_CU:ESADout_CUBorderTransport">
										...
										<xsl:if test="ESADout_CU:ESADout_CUConsigment/ESADout_CU:ESADout_CUBorderTransport/ESADout_CU:TransportMeansQuantity">
											...
											<xsl:for-each select="ESADout_CU:ESADout_CUConsigment/ESADout_CU:ESADout_CUBorderTransport/ESADout_CU:RUTransportMeans">
												<xsl:variable name="currentTransportCode" select="cat_ru:TransportKindCode"/>
												<xsl:variable name="nextTransportCode" select="following-sibling::ESADout_CU:RUTransportMeans[1]/cat_ru:TransportKindCode"/>
												<xsl:variable name="codeList" select="'201 202 203 204 205 206 301 302 303 304 305 306 307'"/>
												<xsl:if test="$currentTransportCode and not(contains($codeList, $currentTransportCode)) and position() != 1">
								...
								<xsl:choose>
									...
									<xsl:otherwise>
										<xsl:for-each select="ESADout_CU:ESADout_CUPayments/ESADout_CU:ESADout_CUCustomsPayment">
											...
											<xsl:choose>
												<xsl:when test="ESADout_CU:RFOrganizationFeatures/cat_ru:INN">
													<xsl:text>-</xsl:text>
													<xsl:apply-templates select="ESADout_CU:RFOrganizationFeatures/cat_ru:INN"/>
												</xsl:when>
												<xsl:when test="ESADout_CU:PersonId">
													<xsl:text>-</xsl:text>
													<xsl:apply-templates select="ESADout_CU:PersonId"/>
												</xsl:when>
												<xsl:when test="ESADout_CU:IdentityCard">
													<xsl:text>-</xsl:text>
													<xsl:for-each select="ESADout_CU:IdentityCard">
		...
		<table cellpadding="0" cellspacing="0" style="width:100%;">
			<xsl:if test="ESADout_CU:ESADout_CUConsigment/ESADout_CU:ESADout_CUReloadingInfo and $strictView != 1">
				<tr valign="top">
			...
			<xsl:choose>
				<xsl:when test="((..//ESADout_CU:CustomsProcedure = 'ТТ') or (..//ESADout_CU:CustomsProcedure = 'TT')) and $strictView != 1">
					<tr valign="top">
							...
							<table cellpadding="0" cellspacing="0" style="width:100%;">
								<tr>
									...
									<td class="graph" rowspan="4" style="width:{57*$k}mm;border-left:solid 0.8pt black;" valign="top">
										<span class="graphNo">С</span>
										<br/>
										<!--xsl:for-each select="goom:GTDOutGoodsMark[catESAD_ru:GRNumber = 'C' and catESAD_ru:StageMarkIdentifier = 1 and catESAD_ru:NoteMarkIdentifier = '00']">
											<xsl:if test="position() = 1">1 - </xsl:if>
											<xsl:if test="position() != 1"><br/></xsl:if>
											<xsl:apply-templates select=""
										</xsl:for-each-->
										
										<xsl:for-each select="//*[@DocumentModeID='1006078E']/goom:GTDOutGoodsResolution[1]/goom:GTDOutGoodsResult[catESAD_ru:DecisionCode = 10 or catESAD_ru:DecisionCode = 90]">
											<xsl:if test="position() = 1"><xsl:text>2 - </xsl:text></xsl:if>
											<xsl:apply-templates select="catESAD_ru:DecisionCode"/>
											<xsl:text> </xsl:text>
											<xsl:apply-templates select="catESAD_ru:DateInf" mode="russian_date_gtd"/>
			...
			<xsl:if test="not(ESADout_CU:ESADout_CUCarrier) and $strictView != 1">
				<tr valign="top">
									...
									<xsl:otherwise>
										<xsl:for-each select="//ESADout_CU:CUESADCustomsRepresentative">
											...
											<span class="graph">1) </span>
												Свид. о включении в Реестр таможенных представителей № <xsl:apply-templates select="RUDECLcat:BrokerRegistryDocDetails/RUDECLcat:RegistrationNumberId"/>;<br/>
						...
						<table cellpadding="0" cellspacing="0" style="width:100%; vertical-align:bottom;">
							...
							<tr class="graph" align="center">
								...
								<td style="width:{17.8*$k}mm; border-right:solid 0.8pt black;">
									...
									<xsl:choose>
										<xsl:when test="catESAD_cu:GoodsTraceabilityCode">
											<xsl:text> </xsl:text>
											<xsl:apply-templates select="catESAD_cu:GoodsTraceabilityCode"/> <!-- П -->
										</xsl:when>
										<xsl:otherwise>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
										</xsl:otherwise>
						...
						<xsl:for-each select="catESAD_cu:GoodsGroupDescription[catESAD_cu:GoodsGroupInformation]">
							...
							<xsl:for-each select="catESAD_cu:GoodsGroupInformation">
								...
								<xsl:if test="catESAD_cu:SerialNumber">
									...
									<xsl:apply-templates select="catESAD_cu:SerialNumber[position() &lt; 11]"/>
									<xsl:if test="count(catESAD_cu:SerialNumber) &gt; 10"> - список серийных номеров сокращен </xsl:if>
								</xsl:if>
								...
								<xsl:apply-templates select="catESAD_cu:DrugStartingMaterialDetails"/>
							</xsl:for-each>
							<xsl:if test="//ESADout_CU:DeclarationKind='ОКТ'">
								<xsl:if test="position()!=last()">, </xsl:if>
							</xsl:if>
							...
							<xsl:for-each select="catESAD_cu:DTIdentificationMeansDetails">
								...
								<xsl:if test="catESAD_cu:IdentificationMeansDetails">
									<xsl:for-each select="catESAD_cu:IdentificationMeansDetails">
										...
										<xsl:apply-templates select="catESAD_cu:IdentifacationMeansCustomsId"/>
										<xsl:if test="position()!=last()">;</xsl:if>
									</xsl:for-each>
								</xsl:if>
					...
					<td colspan="3" style="width:{67.2*$k}mm; vertical-align: top; border-right:solid 0.8pt black;">
						<table cellpadding="0" cellspacing="0" style="width:100%;">
							...
							<tr class="graph" align="center" style="vertical-align: bottom">
								...
								<td align="left" style="border-right:solid 0.8pt black;border-bottom:solid 0.8pt black;word-break: break-all;">
									<xsl:choose>
										<xsl:when test="catESAD_cu:Preferencii and $strictView != 1">
							...
							<xsl:otherwise>
								<xsl:if test="ESADout_CU:ESADout_CUPresentedDocument">
									<xsl:for-each select="ESADout_CU:ESADout_CUPresentedDocument">
										...
										<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
										<xsl:if test="catESAD_cu:PresentedDocumentModeCode = '07011' and catESAD_cu:GoodsNumeric">
											<xsl:apply-templates select="catESAD_cu:GoodsNumeric"/>
											<xsl:text>/</xsl:text>
											<xsl:apply-templates select="cat_ru:PrDocumentName"/>
											<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
									...
									<table cellpadding="0" cellspacing="0" style="width:100%;">
										...
										<tr>
											<td align="center" class="graph" style="width:{8.8*$k}mm; border-bottom:solid 1.5pt black; border-right:solid 1.5pt black;word-break: break-all;">
												<xsl:choose>
													<xsl:when test="catESAD_cu:CustomsCostCorrectMethod and $strictView != 1">
						...
						<table cellpadding="0" cellspacing="0" style="width:100%">
							<tr class="graph">
								...
								<td rowspan="2" style="width:{30*$k}mm; border-top:solid 0.8pt black;word-break: break-all;" valign="top">
									...
									<br/>
									<xsl:if test="catESAD_cu:CustomsCost and $strictView != 1">
										<xsl:apply-templates select="catESAD_cu:CustomsCost" mode="format_number_2"/>
										<!--xsl:value-of select="format-number(catESAD_cu:CustomsCost,'0.00')"/-->
									</xsl:if>
								</td>
							...
							<tr>
								...
								<td class="graph" style="width:{40*$k}mm; border:solid 0.8pt black;word-break: break-all;">
									...
									<xsl:choose>
										<xsl:when test="$strictView = 1"></xsl:when>
										<xsl:otherwise>
											<xsl:if test="catESAD_cu:StatisticalCost and $strictView != 1">
	...
	<xsl:template match="*[local-name() = 'DrugStartingMaterialDetails']">
		<br/>
		<xsl:text>Исходный материал для производства лекарственных препаратов: </xsl:text>
		<xsl:apply-templates select="*[local-name() = 'StartingMaterialId']"/>
		<xsl:if test="*[local-name() = 'StartingMaterialName']">
			<br/>
			<xsl:apply-templates select="*[local-name() = 'StartingMaterialName']"/>
		</xsl:if>
		<xsl:if test="*[local-name() = 'StartingMaterialName']">
			<br/>
			<xsl:apply-templates select="*[local-name() = 'StartingMaterialName']"/>
		</xsl:if>
		<xsl:for-each select="*[local-name() = 'ProductSeriesId']">
			<br/>
			<xsl:apply-templates select="."/>
		</xsl:for-each>
		<xsl:for-each select="*[local-name() = 'ProductSeriesRangeDetails']">
			<br/>
			<xsl:apply-templates select="*[local-name() = 'FirstProductSeriesId']"/>
			<xsl:text>-</xsl:text>
			<xsl:apply-templates select="*[local-name() = 'LastProductSeriesId']"/>
		</xsl:for-each>
		<xsl:if test="*[local-name() = 'GoodsMeasure']">
			<br/>
			<xsl:apply-templates select="*[local-name() = 'GoodsMeasure']" mode="quantity"/>
		</xsl:if>
		<xsl:if test="*[local-name() = 'FactGoodsMeasure']">
			<br/>
			<xsl:apply-templates select="*[local-name() = 'FactGoodsMeasure']" mode="quantity"/>
		</xsl:if>
		<br/>
	</xsl:template>
	...
	<xsl:template match="catESAD_cu:SerialNumber">
		<xsl:if test="position() != 1">, </xsl:if>
        <xsl:value-of select="."/>
    </xsl:template>
	...
	<xsl:template match="catESAD_cu:PIDocumentNumber">
		<xsl:apply-templates select="catESAD_cu:CountryCode"/>
		<xsl:text>/</xsl:text>
		<xsl:apply-templates select="catESAD_cu:Date" mode="russian_date_gtd"/>
		<xsl:text>/</xsl:text>
		<xsl:apply-templates select="catESAD_cu:PINumber"/>
	</xsl:template>
	...
	<xsl:template match="ESADout_CU:ESADout_CUCustomsPaymentCalculation">
		<xsl:variable name="modeCodeLastDigit" select="substring(catESAD_cu:PaymentModeCode, 4, 1)"/>
		<tr>
			<td class="graph">
				<xsl:apply-templates select="catESAD_cu:PaymentModeCode"/>
			</td>
			...
			<td class="graph">
				<xsl:choose>
					<xsl:when test="contains('123', $modeCodeLastDigit)">
						<xsl:apply-templates select="catESAD_cu:Rate" mode="format_number_2"/>
					</xsl:when>
					<xsl:otherwise>
