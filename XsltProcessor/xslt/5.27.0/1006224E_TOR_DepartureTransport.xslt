...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:tor_dt="urn:customs.ru:Information:CustomsDocuments:TOR_DepartureTransport:5.26.0">
							...
							<tr>
								...
								<td class="value graphMain" style="width:50%">
									<xsl:for-each select="tor_dt:PassNum">
										...
										<xsl:if test="tor_dt:AddNumber">
											<xsl:text>/</xsl:text>
											<xsl:apply-templates select="tor_dt:AddNumber"/>
										</xsl:if>
									</xsl:for-each>
								</td>
							</tr>
