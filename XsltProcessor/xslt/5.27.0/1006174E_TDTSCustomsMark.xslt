...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:catTrans_ru="urn:customs.ru:Information:TransportDocuments:TransportCommonAgregateTypesCust:5.24.0" xmlns:tdts="urn:customs.ru:Information:CustomsDocuments:TDTSCustomsMark:5.24.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		...
		<html>
			...
			<body>
				<div class="page">
					...
					<xsl:if test="tdts:TDTSCloseRegNumber">
						<br/>
						<br/>
						<b>Рег. номер ТДТС завершения временного ввоза/вывоза: </b>
						<span style="text-decoration:underline;">
							<xsl:apply-templates select="tdts:TDTSCloseRegNumber"/>
						</span>
					</xsl:if>
				</div>
			</body>
	...
	<xsl:template match="tdts:TDTSRegNumber|tdts:TDTSCloseRegNumber">
