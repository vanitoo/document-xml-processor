...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ct="urn:customs.ru:Information:EArchDocuments:EADCommonTypes:5.22.0" xmlns:adstr="urn:customs.ru:Information:EArchDocuments:ArchDocStatusRequest:5.22.0">
	<!-- Шаблон для типа ArchDocStatusRequestType -->
	<xsl:template match="adstr:ArchDocStatusRequest">
		<html>
			<head>
				<style>
									body {
						...
						<tbody>
							<tr>
								<td align="center" class="graphMain">
									<font size="4">
										<b>Запрос статуса документа в архиве</b>
									</font>
								</td>
							</tr>
						</tbody>
