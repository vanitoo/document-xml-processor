...
<xsl:stylesheet exclude-result-prefixes="apat cat_ru" version="1.0" xmlns:apat="urn:customs.ru:Information:CustomsDocuments:ApplicationAdminTransport:5.24.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
