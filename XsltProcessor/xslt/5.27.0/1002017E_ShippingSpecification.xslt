...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:catComFin_ru="urn:customs.ru:Information:CommercialFinanceDocuments:CommercialFinanceCommonAgregateTypesCust:5.24.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.27.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:ss="urn:customs.ru:Information:CommercialFinanceDocuments:ShippingSpecification:5.27.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
			...
			<tr>
				...
				<xsl:if test="$row11=1">
					<td align="right">
						...
						<xsl:value-of select="format-number(sum(//ss:Goods/ss:Weight/catComFin_ru:NetWeightQuantity), '0.0#####')"/>
					</td>
					<td align="right">
						<!--xsl:value-of select="sum(//ss:Goods/ss:Weight/catComFin_ru:GrossWeightQuantity)"/-->
						<xsl:value-of select="format-number(sum(//ss:Goods/ss:Weight/catComFin_ru:GrossWeightQuantity), '0.0#####')"/>
					</td>
				</xsl:if>
				<xsl:if test="$row12=1">
					<td/>
