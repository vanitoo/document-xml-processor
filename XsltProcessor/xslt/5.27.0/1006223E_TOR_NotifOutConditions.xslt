		...
		<html>
			...
			<body>
				<div class="page">
					...
					<br/>
					<br/>
					<xsl:apply-templates select="tor_noc:CustomsSignature"/>
				</div>
			</body>
		</html>
	</xsl:template>
	<xsl:template match="tor_noc:CustomsSignature">
		<table>
			<tbody>
				<tr>
					<td width="30%">
					...
					<td width="5%"></td>
					<td width="20%" align="right"><xsl:apply-templates select="cat_ru:PersonPost" mode="russian_date"/></td>
					<td width="5%"></td>
					<td width="40%">
	...
	<xsl:template match="tor_noc:Conditions">
		<tr>
			...
			<td class="bordered">
				...
				<xsl:choose>
					<xsl:when test="tor_noc:Sign='1'">несоответствие номера ТС / отсутствуют сведения о регистрационном номере транспортного средства в информационно-программных средствах ЕАИС таможенных органов</xsl:when>
