...
<xsl:stylesheet version="1.0" xmlns:api="urn:customs.ru:Information:CustomsDocuments:AcceptPaymentInf:5.27.0" xmlns:catESAD_ru="urn:customs.ru:RUCommonAggregateTypes:5.27.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
