										...
										<b>
											...
											<xsl:choose>
												<xsl:when test="rdrp:OrderType='0' and rdrp:DocType='0'">
													<xsl:text>Поручения таможенного органа на бесспорное взыскание</xsl:text>
												</xsl:when>
												<xsl:when test="rdrp:OrderType='0' and rdrp:DocType='1'">
													<xsl:text>Отзыва поручения таможенного органа на бесспорное взыскание</xsl:text>
												</xsl:when>
												...
												<xsl:when test="rdrp:OrderType='1' and rdrp:DocType='1'">
													<xsl:text>Отзыва поручения таможенного органа на продажу иностранной валюты</xsl:text>
												</xsl:when>
												<xsl:when test="rdrp:OrderType='2' and rdrp:DocType='0'">
													<xsl:text>Поручения таможенного органа на перевод электронных денежных средств</xsl:text>
												</xsl:when>
												<xsl:when test="rdrp:OrderType='2' and rdrp:DocType='1'">
													<xsl:text>Отзыва поручения таможенного органа на перевод электронных денежных средств</xsl:text>
												</xsl:when>
												<xsl:when test="rdrp:OrderType='3' and rdrp:DocType='0'">
													<xsl:text>Поручения таможенного органа на перечисление денежных средств с депозитного счета на расчетный</xsl:text>
												</xsl:when>
												<xsl:when test="rdrp:OrderType='3' and rdrp:DocType='1'">
													<xsl:text>Отзыва поручения таможенного органа на перечисление денежных средств с депозитного счета на расчетный</xsl:text>
												</xsl:when>
