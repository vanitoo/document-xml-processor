...
<xsl:stylesheet exclude-result-prefixes="cat_ru porc" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.15.0" xmlns:porc="urn:customs.ru:Information:CustomsDocuments:PreliminaryOriginCountry:5.15.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
