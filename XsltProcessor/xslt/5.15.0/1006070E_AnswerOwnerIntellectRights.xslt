...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.15.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:aoir="urn:customs.ru:Information:AnswerOwnerIntellectRights:5.15.0">
						...
						<tbody>
							...
							<xsl:for-each select="aoir:GoodsWithSignOfViolation">
								<tr>
									<td class="graphMain bordered">
										<xsl:for-each select="aoir:AnswerCode">
											<xsl:choose>
												...
												<xsl:otherwise>
													<xsl:value-of select="aoir:AnswerCode"/>
												</xsl:otherwise>
											</xsl:choose>
									...
									<td class="graphMain bordered">
										<xsl:value-of select="aoir:GoodsNumeric"/>
									</td>
									<td class="graphMain bordered">
										<xsl:value-of select="aoir:GoodsTNVEDCode"/>
									</td>
									<td class="graphMain bordered">
										<xsl:value-of select="aoir:IntellectPropertySign"/>
									</td>
									<td class="graphMain bordered">
									...
									<td class="graphMain bordered">
										<xsl:value-of select="aoir:Period"/>
									</td>
									<td class="graphMain bordered">
										<xsl:value-of select="aoir:Notes"/>
									</td>
								</tr>
							</xsl:for-each>
						</tbody>
			...
			<tbody>
				...
				<xsl:if test="aoir:BirthPlace">
					<tr>
						...
						<td class="value graphMain">
							<xsl:value-of select="aoir:BirthPlace"/>
						</td>
					</tr>
				</xsl:if>
				...
				<xsl:if test="aoir:Phone">
					<tr>
						...
						<td class="value graphMain">
							<xsl:value-of select="aoir:Phone"/>
						</td>
					</tr>
				</xsl:if>
				<xsl:if test="aoir:Email">
					<tr>
						...
						<td class="value graphMain">
							<xsl:value-of select="aoir:Email"/>
						</td>
					</tr>
				</xsl:if>
				...
				<xsl:if test="aoir:RightHolderLegal">
					...
					<tr>
						...
						<td class="value graphMain">
							<xsl:value-of select="aoir:RegistrationNumber"/>
						</td>
					</tr>
					<tr>
				...
				<xsl:if test="aoir:RightHolderForeignLegal">
					...
					<tr>
						...
						<td class="value graphMain">
							<xsl:value-of select="aoir:RegistrationPlace"/>
						</td>
					</tr>
					<tr>
						<td class="annot graphMain">Полный адрес организации (на иностранном языке)</td>
						<td class="value graphMain">
							<xsl:value-of select="aoir:FullAddressForeign"/>
						</td>
					</tr>
				</xsl:if>
			</tbody>
	...
	<xsl:template match="*" mode="document">
		...
		<xsl:if test="aoir:DocCode">
			...
			<xsl:value-of select="aoir:DocCode"/>
		</xsl:if>
