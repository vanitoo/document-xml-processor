...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:catTrans_ru="urn:customs.ru:Information:TransportDocuments:TransportCommonAgregateTypesCust:5.14.3" xmlns:tdts="urn:customs.ru:Information:CustomsDocuments:TDTSCustomsMark:5.14.3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
         ...
         <body>
            <div class="page">
               ...
               <xsl:if test="tdts:CurrentImportProlongNum">
                  ...
                  <span style="text-decoration:underline;"><xsl:value-of select="tdts:CurrentImportProlongNum"/></span>
               </xsl:if>
            </div>
         </body>
      </html>
