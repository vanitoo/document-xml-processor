...
<!-- Приказ ФТС России от 31.01.2019 г. № 156 Приложение № 4 -->
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:cdc="urn:customs.ru:Information:CustomsDocuments:ClassDecisionChange:5.15.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.15.0">
							...
							<td class="graph" colspan="2" style="border:solid 1pt #000000">7. Подпись должностного лица таможенного органа<br/> <br/>
								<table>
									...
									<tr>
										...
										<td class="graph2" style="border:solid 0pt" width="10%"> </td>
										<td align="center" class="graph2" style="border:solid 0pt" width="30%">(фамилия, имя, отчество (при наличии))
									</td>
									</tr>
								</table>
							</td>
	...
	<xsl:template match="cdc:Declarant">
