	...
	<xsl:template match="cos:ConformanceSertif">
		<html>
			...
			<body>
				...
				<xsl:if test="cos:CertificateKind or cos:CertifNormDoc or cos:FederalDocs or cos:AppendInfo or cos:Goods/cos:DocManufacturedInfo">
					<div class="page">
