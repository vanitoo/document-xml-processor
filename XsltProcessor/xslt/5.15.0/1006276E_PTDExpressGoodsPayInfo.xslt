							...
							<tbody>
								...
								<xsl:for-each select="PTDEGP:HouseShipment">
									...
									<tr align="center" valign="top">
										...
										<td class="bordered">
											<xsl:if test="PTDEGP:AllAmount">
												<xsl:value-of select="translate(translate(format-number(PTDEGP:AllAmount, '#,###.00'),',',' '),'.',',')"/>
											</xsl:if>
											<br/>
