...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:KDTout="urn:customs.ru:Information:CustomsDocuments:KDTout:5.15.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.15.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.15.0" xmlns:RUDECLcat="urn:customs.ru:RUDeclCommonAggregateTypesCust:5.15.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="KDTout:KTDoutConsignor| KDTout:KTDoutConsignee">
		<xsl:choose>
			<xsl:when test="RUDECLcat:EqualIndicator='1' or RUDECLcat:EqualIndicator='true' or RUDECLcat:EqualIndicator='True' or RUDECLcat:EqualIndicator='t'">СМ. ГРАФУ 14 КДТ</xsl:when>
			<xsl:otherwise>
					...
					<table style="width:100%;">
						...
						<tr>
							...
							<td style="border-bottom:solid 0pt black;border-left:solid 0pt black;border-right:solid 1.5pt black;" align="center">
								...
								<xsl:if test="catESAD_cu:TotalCustomsValueAmount"> / <xsl:value-of select="format-number(catESAD_cu:TotalCustomsValueAmount,'0.00')"/>
								</xsl:if>
							</td>
								...
								<!--xsl:for-each select="KDTout:KTDoutConsigment/KDTout:KDToutDepartureArrivalTransport/KDTout:TransportMeans[not(cat_ru:ActiveTransportIdentifier)]"-->
										<xsl:for-each select="KDTout:KTDoutConsigment/KDTout:KDToutDepartureArrivalTransport/KDTout:TransportMeans">
											...
											<xsl:if test="catESAD_cu:FirstTrailerRegId">
												<xsl:text> / </xsl:text>
												<xsl:value-of select="catESAD_cu:FirstTrailerRegId"/>
											</xsl:if>
											<xsl:if test="catESAD_cu:SecondTrailerRegId">
												<xsl:text> / </xsl:text>
												<xsl:value-of select="catESAD_cu:SecondTrailerRegId"/>
											</xsl:if>
											<xsl:text> </xsl:text>
						...
						<tr>
							...
							<td align="center" style="border-right:solid 0.8pt black;" width="10%">
								...
								<xsl:if test="KDTout:KDToutMainContractTerms/catESAD_cu:TotalAmount!=''">
									<xsl:text> / </xsl:text>
									<xsl:value-of select="format-number(KDTout:KDToutMainContractTerms/catESAD_cu:TotalAmount,'0.00')"/>
								</xsl:if>
							</td>
						...
						<tr>
                           ...
                           <xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
									...
									<xsl:if test="KDTout:RegisterDocumentIdDetails/catESAD_cu:DocId">
										...
										<xsl:value-of select="KDTout:RegisterDocumentIdDetails/catESAD_cu:DocId"/>
									</xsl:if>
									<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
									<xsl:choose>
									...
									<xsl:when test="KDTout:Guarantee">
										<xsl:for-each select="KDTout:Guarantee">
											<xsl:if test="catESAD_cu:PaymentWayCode">
												<xsl:value-of select="catESAD_cu:PaymentWayCode"/>, 
										  </xsl:if>
											<xsl:value-of select="catESAD_cu:Amount"/>,
							...
							<td rowspan="6" style="border-left:solid 0.8pt black;">
								...
								<xsl:for-each select="/KDTout:KDTout_CU/KDTout:KDTFilledInfo/KDTout:CustomsRepresentative">
									...
									<span class="graph">1) </span>
										Свид. о включении в Реестр таможенных представителей № <xsl:value-of select="RUDECLcat:BrokerRegistryDocDetails/RUDECLcat:RegisterDocumentDetails/RUScat_ru:RegistrationNumberId"/>;<br/>
								...
								<p align="right">
									<xsl:choose>
										<xsl:when test="//KDTout:KDTFilledInfo/KDTout:FilledPerson/RUDECLcat:SigningDetails/RUScat_ru:SigningDate">
											<xsl:call-template name="russian_date">
												<xsl:with-param name="dateIn" select="//KDTout:KDTFilledInfo/KDTout:FilledPerson/RUDECLcat:SigningDetails/RUScat_ru:SigningDate"/>
											</xsl:call-template>
										</xsl:when>
										<xsl:otherwise>
											<xsl:call-template name="russian_date">
												<xsl:with-param name="dateIn" select="//KDTout:EECEDocHeaderAddInfo/RUScat_ru:EDocDateTime"/>
											</xsl:call-template>
										</xsl:otherwise>
									</xsl:choose>
								</p>
		...
		<table width="100%">
							...
							<td align="center" style=" border-right:solid 0.8pt black;">
								<xsl:choose>
									...
									<xsl:when test="$goods/catESAD_cu:LicenseGoodsKindCode">
										<xsl:value-of select="$goods/catESAD_cu:LicenseGoodsKindCode"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
									</xsl:otherwise>
			...
			<tr>
						...
						<xsl:for-each select="catESAD_cu:GoodsGroupInformation">
							...
							<xsl:if test="catESAD_cu:WoodDescriptionDetails">
								<xsl:if test="catESAD_cu:WoodDescriptionDetails/catESAD_cu:WoodSortiment">
									...
									<xsl:value-of select="catESAD_cu:WoodDescriptionDetails/catESAD_cu:WoodSortiment"/>
								</xsl:if>
								<xsl:if test="catESAD_cu:WoodDescriptionDetails/catESAD_cu:WoodKind">
									<xsl:text> Порода древесины: </xsl:text>
									<xsl:value-of select="catESAD_cu:WoodDescriptionDetails/catESAD_cu:WoodKind"/>
								</xsl:if>
								<xsl:if test="catESAD_cu:WoodDescriptionDetails/catESAD_cu:ProductSortName">
									<xsl:text> Наименование сорта:</xsl:text>
									<xsl:value-of select="catESAD_cu:WoodDescriptionDetails/catESAD_cu:ProductSortName"/>
								</xsl:if>
                  ...
                  <xsl:value-of select="$goods/KDTout:SupplementaryGoodsQuantity/cat_ru:MeasureUnitQualifierCode"/>
					...
					<xsl:if test="$goods/KDTout:ESADGoodsPackaging">
                        ...
                        <xsl:if test="$goods/KDTout:ESADGoodsPackaging/catESAD_cu:PakageTypeCode = 1">
							...
							<xsl:if test="$goods/KDTout:ESADGoodsPackaging/catESAD_cu:PackagePalleteInformation[catESAD_cu:InfoKindCode='0']">
								<xsl:for-each select="$goods/KDTout:ESADGoodsPackaging/catESAD_cu:PackagePalleteInformation[catESAD_cu:InfoKindCode='0']">
					...
					<xsl:if test="$goods/KDTout:KDToutCustomsConditions">
						...
						<xsl:if test="$goods/KDTout:KDToutCustomsConditions/RUDECLcat:ProcessingProduct">
							Продукт переработки:
							<xsl:value-of select="$goods/KDTout:KDToutCustomsConditions/RUDECLcat:ProcessingProduct/catESAD_cu:GoodsTNVEDCode"/>
						...
						<xsl:if test="$goods/KDTout:KDToutCustomsConditions/RUDECLcat:WasteProducts">
							Отходы:
							<xsl:value-of select="$goods/KDTout:KDToutCustomsConditions/RUDECLcat:WasteProducts/catESAD_cu:GoodsTNVEDCode"/>
						...
						<xsl:if test="$goods/KDTout:KDToutCustomsConditions/RUDECLcat:Heels">
							Остатки:
							<xsl:value-of select="$goods/KDTout:KDToutCustomsConditions/RUDECLcat:Heels/catESAD_cu:GoodsTNVEDCode"/>
					...
					<xsl:if test="($goods/catESAD_cu:DeliveryTime) or ($goods/catESAD_cu:DeliveryTimeEND)">
						...
						<xsl:call-template name="russian_date">
							<xsl:with-param name="dateIn" select="$goods/catESAD_cu:DeliveryTime"/>
						</xsl:call-template>
						<xsl:if test="$goods/catESAD_cu:DeliveryTimeEND">
								- <xsl:call-template name="russian_date">
								<xsl:with-param name="dateIn" select="$goods/catESAD_cu:DeliveryTimeEND"/>
							</xsl:call-template>
						</xsl:if>
					</xsl:if>
					<xsl:if test="$goods/catESAD_cu:QuantityFact/cat_ru:GoodsQuantity">
						...
						<xsl:value-of select="$goods/catESAD_cu:QuantityFact/cat_ru:GoodsQuantity"/>
						<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
						<xsl:value-of select="$goods/catESAD_cu:QuantityFact/cat_ru:MeasureUnitQualifierName"/>
						<xsl:if test="$goods/catESAD_cu:QuantityFact/cat_ru:MeasureUnitQualifierCode">
							<xsl:text> (</xsl:text>
							<xsl:value-of select="$goods/catESAD_cu:QuantityFact/cat_ru:MeasureUnitQualifierCode"/>
							<xsl:text>)</xsl:text>
						</xsl:if>
					</xsl:if>
					...
					<table>
						...
						<tr>
							...
							<td style="border-right:solid 1.5pt black;border-bottom:solid 1.5pt black;">
								<xsl:value-of select="$goods/catESAD_cu:PrefOriginCountry/catESAD_cu:CountryCode"/>
								<xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
							</td>
						</tr>
					</table>
				...
				<td style="border:solid 0.8pt black;background:#FFFFFF;">
					...
					<xsl:if test="$goods/KDTout:TotalGrossMassMeasure"> / <xsl:value-of select="$goods/KDTout:TotalGrossMassMeasure/cat_ru:GoodsQuantity"/>
					</xsl:if>
				</td>
			...
			<tr>
				...
				<td style="border:solid 0.8pt black;background:#FFFFFF;">
					...
					<xsl:if test="$goods/KDTout:TotalNetMassMeasure"> / <xsl:value-of select="$goods/KDTout:TotalNetMassMeasure/cat_ru:GoodsQuantity"/>
					</xsl:if>
				</td>
				<td style="border:solid 0.8pt black;">
					<b>39</b>
					...
					<xsl:for-each select="$goods/KDTout:KDToutPrecedingDocument">
						...
						<xsl:if test="catESAD_cu:AddNumberPart">
							<xsl:choose>
								...
								<xsl:otherwise><xsl:value-of select="catESAD_cu:AddNumberPart"/></xsl:otherwise>
							</xsl:choose>
								...
								<xsl:choose>
									...
									<xsl:when test="RUDECLcat:DocumentPresentingDetails/RUDECLcat:OtherPrecedingDocId">
										...
										<xsl:if test="RUDECLcat:DocumentPresentingDetails/RUDECLcat:OtherPrecedingDocDate">
											...
											<xsl:value-of select="RUDECLcat:DocumentPresentingDetails/RUDECLcat:OtherPrecedingDocDate"/>
										</xsl:if>
									</xsl:when>
								</xsl:choose>
							</xsl:if>
					...
					<table>
						<tr>
							...
							<td style="border:solid 0.8pt black;">
								...
								<xsl:if test="$goods/catESAD_cu:InvoicedCurrencyCode"> / <xsl:value-of select="$goods/catESAD_cu:InvoicedCurrencyCode"/>
								</xsl:if>
								<xsl:if test="$goods/catESAD_cu:InvoicedCurrencyRate"> / <xsl:value-of select="format-number($goods/catESAD_cu:InvoicedCurrencyRate,'0.0000')"/>
								</xsl:if>
							</td>
					...
					<table>
						...
						<tr>
							...
							<td style="border-bottom:solid 0pt black;border-left:solid 0pt black;border-right:solid 0.8pt black;width:35mm;" align="center">
								<xsl:value-of select="$goods/KDTout:PreviousCustomsCost"/>
							</td>
						</tr>
					</table>
				</td>
					...
					<table>
						<tr>
							...
							<td style="border:solid 0.8pt black;width:35mm;">
								...
								<xsl:if test="$goods/catESAD_cu:TotalStatisticValueAmount"> / <xsl:value-of select="format-number($goods/catESAD_cu:TotalStatisticValueAmount,'0.00')"/>
								</xsl:if>
								<!--xsl:choose>
	...
	<xsl:template match="RUDECLcat:ProcessingPlaceDetails">
		Место переработки: <xsl:value-of select="RUDECLcat:PlaceName"/>
			...
			<tbody>
				...
				Сумма уплаты / возврата 
					...
					<td style="border-left: solid 1pt #000000;width:5mm;">
						<xsl:value-of select="KDTout:PaymentWayCode"/>
					</td>
				</tr>
			</tbody>
		</table>
		...
		<br>
			<xsl:for-each select="catESAD_cu:IdentificationMeansDetails">
				<xsl:if test="catESAD_cu:AggregationKindCode">
					...
					<xsl:value-of select="catESAD_cu:AggregationKindCode"/>
					<xsl:for-each select="catESAD_cu:IdentificationMeansListDetails/catESAD_cu:IdentificationMeansItemDetails">
						<xsl:if test="catESAD_cu:IdentificationMeansKindCode">
							...
							<xsl:value-of select="catESAD_cu:IdentificationMeansKindCode"/>
						</xsl:if>
						<xsl:for-each select="catESAD_cu:IdentificationMeansDataUnitDetails">
							<xsl:if test="catESAD_cu:AIId">
								...
								<xsl:value-of select="catESAD_cu:AIId"/>
							</xsl:if>
							<xsl:if test="catESAD_cu:IdentifacationMeansUnitCharacterValueId">
								...
								<xsl:value-of select="catESAD_cu:IdentifacationMeansUnitCharacterValueId"/>
							</xsl:if>
						</xsl:for-each>
					</xsl:for-each>
					<br>
						<xsl:if test="catESAD_cu:IdentificationMeansRangeDetails">
							...
							<xsl:for-each select="catESAD_cu:IdentificationMeansRangeDetails">
								<xsl:if test="catESAD_cu:FirstIdentificationMeansItemDetails/catESAD_cu:IdentificationMeansKindCode">
									<xsl:text> код вида средства идентификации: </xsl:text>
									<xsl:value-of select="catESAD_cu:FirstIdentificationMeansItemDetails/catESAD_cu:IdentificationMeansKindCode"/>
								</xsl:if>
