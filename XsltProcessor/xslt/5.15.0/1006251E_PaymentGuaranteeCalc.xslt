...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.15.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:pgc="urn:customs.ru:Information:CustomsDocuments:PaymentGuaranteeCalc:5.15.0" xmlns:RUSclt_ru="urn:customs.ru:RUSCommonLeafTypes:5.14.3" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.15.0" xmlns:RUDECLcat="urn:customs.ru:RUDeclCommonAggregateTypesCust:5.15.0" xmlns:cltESAD_cu="urn:customs.ru:CUESADCommonLeafTypes:5.15.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
			...
			<body>
				...
				<xsl:for-each select="pgc:GoodsShipment/pgc:GoodsItemDetails[(position()+1) mod 3 = 0]">
					<div class="page">
						...
						<table>
							<tr valign="top">
								<td class="bordered" style="width:50%;border-top:0;"/>
								<td class="bordered" style="width:50%;border-top:0;" rowspan="2">18. Ф.И.О., должность, дата<br/>
									<xsl:apply-templates select="../../pgc:CustomsPersonSignature"/>
								</td>
							</tr>
	...
	<xsl:template mode="cell4to15" match="pgc:GoodsItemDetails">
		<table>
			...
			<tr valign="top">
				<td class="bordered" rowspan="3" style="width:50%;border-top:0;word-break: break-all;">
	...
	<xsl:template name="header1to3">
		...
		<table>
			...
			<tr>
				<td class="bordered" style="width:45%">
