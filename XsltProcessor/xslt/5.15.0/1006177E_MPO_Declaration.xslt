...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.15.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.15.0" xmlns:mpco="urn:customs.ru:Information:CustomsDocuments:MPOCommon:5.15.0" xmlns:mpod="urn:customs.ru:Information:CustomsDocuments:MPO_Declaration:5.15.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
												...
												<span class="graph">Почтовый индекс<br/>
													<xsl:choose>
														<xsl:when test="mpod:Consignee/mpco:ExPostalCode">
															<xsl:value-of select="mpod:Consignee/mpco:ExPostalCode"/>
														</xsl:when>
														<xsl:otherwise>
															<xsl:value-of select="mpod:Consignee/RUScat_ru:SubjectAddressDetails/RUScat_ru:PostalCode"/>
														</xsl:otherwise>
													</xsl:choose>
												</span>
											</td>
