...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:ntfin="urn:customs.ru:Information:CustomsDocuments:NotifInspectionReqGoods:5.15.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
								...
								<tr>
									<td align="left">
										...
										<xsl:for-each select="ntfin:DecisionNumber">
											...
											<xsl:text>/</xsl:text>
											<xsl:call-template name="russian_date_gtd">
												<xsl:with-param name="gtd" select="cat_ru:RegistrationDate"/>
											</xsl:call-template>
											<xsl:text>/</xsl:text>
