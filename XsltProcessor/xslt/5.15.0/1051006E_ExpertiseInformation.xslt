...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:ei="urn:customs.ru:Information:CustomsDocuments:ExpertiseInformation:5.14.5" xmlns:xs="http://www.w3.org/2001/XMLSchema">
							...
							<td class="value graphMain" style="width:50%">
								...
								<xsl:if test="ei:ExpertisePeriodDayType">
									<xsl:choose>
										...
										<xsl:otherwise>
											<xsl:text>, тип дней: </xsl:text><xsl:value-of select="ei:ExpertisePeriodDayType"/>
										</xsl:otherwise>
									</xsl:choose>
								</xsl:if>
							</td>
