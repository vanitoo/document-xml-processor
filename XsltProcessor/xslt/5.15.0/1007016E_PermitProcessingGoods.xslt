					...
					<td width="73%" class="aling">
						<b>
							<xsl:choose>
								...
								<xsl:when test="ppg:DocumentStatus='7'">
									<xsl:text>Отозвано</xsl:text>
								</xsl:when>
								<xsl:when test="ppg:DocumentStatus='8'">
