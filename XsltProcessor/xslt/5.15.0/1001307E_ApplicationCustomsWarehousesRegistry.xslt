...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:RegCW="urn:customs.ru:Information:RegistrationDocuments:ApplicationCustomsWarehousesRegistry:5.15.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0">
					...
					<div class="page" style="width: {$w}mm;">
							...
							<tbody>
								<tr>
									...
									<td width="45%">
										...
										<br/>
										<xsl:call-template name="text_date"><xsl:with-param name="date" select="RegCW:ApplicationDate"/></xsl:call-template>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<table>
							<tbody>
								...
								<tr valign="top">
									...
									<td class="bordered">
										<xsl:choose>
											...
											<xsl:when test="RegCW:TypeWarehouseIndicator=1 or RegCW:TypeWarehouseIndicator='true'">Закрытый <br/><xsl:value-of select="RegCW:ReasonClosedWH"/></xsl:when>
										</xsl:choose>
									</td>
								</tr>
								<tr valign="top">
								...
								<tr valign="top">
									...
									<td class="bordered">
										...
										<xsl:if test="RegCW:WarehouseEquipmentInfo/RegCW:OpenAreaMeasure">
											<xsl:if test="RegCW:WarehouseEquipmentInfo/RegCW:CubageMeasure"><br/></xsl:if>
								...
								<tr valign="top">
									<td class="bordered"></td>
									<td class="bordered">Сведения о предоставлении обеспечении исполнения обязанностей юридического лица, осуществляющего деятельность в качестве владельца таможенного склада</td>
									<td class="bordered"></td>
								</tr>
								<tr valign="top">
									<td class="bordered"></td>
						...
						<br/>
						<div>Общее количество листов <span style="display:inline-block;width: 20mm;text-align:center;" class="value"><xsl:value-of select="RegCW:TotalSheetNumber"/></span></div>
						<br/>
						<br/>
						<table>
							<tbody>
								<tr valign="bottom">
									...
									<td width="5%"></td>
									<td width="25%" align="center" class="value"></td>
									<td width="5%"></td>
						...
						<div style="inline-block; width:50mm;text-align:right">М.П.<sup>*</sup></div>
						<br/>
						<br/>
						<br/>
						<br/>
						<div style="inline-block; width: 50mm;" class="value"/>
						<div class="descr"><sup>*</sup> При наличии печати</div>
					</div>
				</xsl:if>
							...
							<tbody>
								<tr>
									...
									<td width="60%">
										...
										<br/>
										<div style="width:100%; text-align:right;"><xsl:call-template name="text_date"><xsl:with-param name="date" select="RegCW:ApplicationDate"/></xsl:call-template></div>
									</td>
								</tr>
							</tbody>
						</table>
	...
	<xsl:template match="RegCW:InsurCertificate">
		...
		<xsl:if test="RegCW:CertificateDate">
			...
			<xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="RegCW:CertificateDate"/></xsl:call-template>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="RegCW:InsuranceAgreement">
		...
		<xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="RegCW:AgreemDate"/></xsl:call-template>
