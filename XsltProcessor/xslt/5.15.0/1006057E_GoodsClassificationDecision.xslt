...
-->
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:RUDECLcat="urn:customs.ru:RUDeclCommonAggregateTypesCust:5.15.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.15.0" xmlns:gcd="urn:customs.ru:Information:CustomsDocuments:GoodsClassificationDecision:5.15.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
			...
			<table>
				<tbody>
				   ...
				   <tr>
					  ...
					  <td colspan="3">
						5. Дата принятия решения о классификации товара, перемещаемого в виде компонентов (число, месяц, год)<br/>
						<xsl:call-template name="date">
				   ...
				   <tr>
						<td colspan="2" width="33%">
							7. 10-значный классификационный код товара в соответствии с единой Товарной номенклатурой внешнеэкономической деятельности Евразийского экономического союза (далее по форме - ТН ВЭД ЕАЭС)<br/>
							<xsl:value-of select="gcd:GoodsTNVED"/>
						</td>
						<td colspan="2" width="33%">
							8. Обоснование решения о классификации товара, перемещаемого в виде компонентов<br/>
					...
					<tr>
						<td colspan="6">
							11. Приложение (перечень компонентов товара, включающий в себя: наименования компонентов, в том числе частей, составляющих отдельный компонент товара; количество или вес компонентов, в том числе частей, составляющих отдельный компонент товара, в единицах измерения, применяемых в ТН ВЭД ЕАЭС)<br/>
							На 
							<xsl:choose>
		  ...
		  <xsl:if test="gcd:RegistryNumber/gcd:IDDoc='ОЗ'">
			<table>
				<tbody>
				   ...
				   <tr>
					  <td>
						 3. Регистрационный номер решения об отказе в рассмотрении заявления о принятии решения о классификации товара, перемещаемого в виде компонентов<br/>
						 <xsl:apply-templates select="gcd:RegistryNumber"/>
					  </td>
					  <td>
						 4. Дата принятия решения об отказе в рассмотрении заявления о принятии решения о классификации товара, перемещаемого в виде компонентов (число, месяц, год)<br/>
							<xsl:call-template name="date">
								<xsl:with-param name="text" select="gcd:RegistryNumber/gcd:Date"/>
							</xsl:call-template>
					  </td>
				   ...
				   <tr>
					  <td>
						5. Исходящий номер заявления о принятии решения о классификации товара, перемещаемого в виде компонентов<br/>
						<xsl:value-of select="gcd:ApplicationRegistration/cat_ru:PrDocumentNumber"/>
					  </td>
					  <td>
						6. Дата исходящего заявления о принятии решения о классификации товара, перемещаемого в виде компонентов (число, месяц, год)<br/>
						<xsl:call-template name="date">
				   ...
				   <tr>
					  <td colspan="2">
					  7. Наименование товара, указанного в заявлении о принятии решения о классификации товара, перемещаемого в виде компонентов<br/>
					  <xsl:if test="gcd:GoodsDescription">
						  <xsl:for-each select="gcd:GoodsDescription">
							  <xsl:value-of select="."/>
						  </xsl:for-each>
				   ...
				   <tr>
						<td colspan="2">
							8. Основание(я) принятия решения об отказе в рассмотрении заявления о принятии решения о классификации товара, перемещаемого в виде компонентов<br/>
							<xsl:apply-templates select="gcd:InterpretationRules"/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							9. Причины(а) принятия решения об отказе в рассмотрении заявления о принятии решения о классификации товара, перемещаемого в виде компонентов:<br/>
							<xsl:for-each select="gcd:ReasonsForDecision">
								9.<xsl:value-of select="position()"/><xsl:text> </xsl:text><xsl:value-of select="gcd:Number"/><xsl:text> </xsl:text><xsl:apply-templates select="gcd:Text"/>
								<xsl:if test="position()!=last()"><br/></xsl:if>
							</xsl:for-each>
						</td>
					</tr>
		  ...
		  <xsl:if test="gcd:RegistryNumber/gcd:IDDoc='ОЕ'">
			<table>
				<tbody>
				   ...
				   <tr>
					  <td>
						 3. Регистрационный номер решения об отказе в принятии решения о классификации товара, перемещаемого в виде компонентов<br/>
						 <xsl:apply-templates select="gcd:RegistryNumber"/>
					  </td>
					  <td>
						 4. Дата принятия решения об отказе в принятии решения о классификации товара, перемещаемого в виде компонентов (число, месяц, год)<br/>
							<xsl:call-template name="date">
								<xsl:with-param name="text" select="gcd:RegistryNumber/gcd:Date"/>
							</xsl:call-template>
					  </td>
				   ...
				   <tr>
						<td colspan="2">
							8. Основание(я) принятия решения об отказе в принятии решения о классификации товара, перемещаемого в виде компонентов<br/>
							<xsl:apply-templates select="gcd:InterpretationRules"/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							9. Причины(а) принятия решения об отказе в принятии решения о классификации товара, перемещаемого в виде компонентов:<br/>
							<xsl:for-each select="gcd:ReasonsForDecision">
								9.<xsl:value-of select="gcd:Number"/><xsl:text> </xsl:text><xsl:apply-templates select="gcd:Text"/>
								<xsl:if test="position()!=last()"><br/></xsl:if>
							</xsl:for-each>
						</td>
					</tr>
		  ...
		  <xsl:if test="gcd:RegistryNumber/gcd:IDDoc='ИЗ'">
			<table>
				<tbody>
				   ...
				   <tr>
					  <td colspan="3">
						 3. Регистрационный номер решения о внесении изменений в решение о классификации товара, перемещаемого в виде компонентов<br/>
						 <xsl:apply-templates select="gcd:RegistryNumber"/>
					  </td>
					  <td colspan="3">
						 4. Дата принятия решения о внесении изменений в решение о классификации товара, перемещаемого в виде компонентов (число, месяц, год)<br/>
						<xsl:call-template name="date">
							<xsl:with-param name="text" select="gcd:RegistryNumber/gcd:Date"/>
						</xsl:call-template>
					  </td>
				   ...
				   <tr>
					  <td colspan="3">
						5. Регистрационный номер решения о классификации товара, перемещаемого в виде компонентов, в которое вносятся изменения<br/>
						<xsl:apply-templates select="gcd:PrecedingDecisionRegNumber"/>
					  </td>
					  <td colspan="3">
						6. Дата принятия решения о классификации товара, в которое вносятся изменения (число, месяц, год)<br/>
				   ...
				   <tr>
					...
					<tr>
						<td colspan="6">
						11. Основания(ие) внесения изменений в решение о классификации товара, перемещаемого в виде компонентов<br/>
						<xsl:apply-templates select="gcd:InterpretationRules"/>
						</td>
					</tr>
					<tr>
						<td colspan="6">
						12. Причины(а) внесения изменений в решение о классификации товара, перемещаемого в виде компонентов:<br/>
						<xsl:for-each select="gcd:ReasonsForDecision">
							12.<xsl:value-of select="gcd:Number"/><xsl:text> </xsl:text><xsl:apply-templates select="gcd:Text"/>
							<xsl:if test="position()!=last()"><br/></xsl:if>
						</xsl:for-each>
						</td>
					</tr>
					<tr>
						<td colspan="6">
						13. Приложение к решению о внесении изменений в приложение к решению о классификации товара (перечень компонентов товара):<br/>
					...
					<tr>
						<td colspan="6">
						14. Срок вступления в силу решения о внесении изменений в решение о классификации товара, перемещаемого в виде компонентов<br/>
						<xsl:call-template name="date"><xsl:with-param name="text" select="gcd:DateEntryIntoForce"/></xsl:call-template>
						</td>
					</tr>
					<tr>
						<td colspan="6">
							15. Служебные отметки<br/>
							<xsl:apply-templates select="gcd:Mark"/>
						</td>
					</tr>
				   <tr>
		  ...
		  <xsl:if test="gcd:RegistryNumber/gcd:IDDoc='ОИ'">
			<table>
				<tbody>
				   ...
				   <tr>
					  <td>
						 3. Регистрационный номер решения об отказе в рассмотрении заявления о внесении изменений в решение о классификации товара, перемещаемого в виде компонентов<br/>
						 <xsl:apply-templates select="gcd:RegistryNumber"/>
					  </td>
					  <td>
						 4. Дата принятия решения об отказе в рассмотрении заявления о внесении изменений в решение о классификации товара, перемещаемого в виде компонентов (число, месяц, год)<br/>
							<xsl:call-template name="date">
								<xsl:with-param name="text" select="gcd:RegistryNumber/gcd:Date"/>
							</xsl:call-template>
					  </td>
				   ...
				   <tr>
					  <td>
						5. Исходящий номер заявления о внесении изменений в решение о классификации товара, перемещаемого в виде компонентов<br/>
						<xsl:value-of select="gcd:ApplicationRegistration/cat_ru:PrDocumentNumber"/>
					  </td>
					  <td>
						6. Дата исходящего заявления о внесении изменений в решение о классификации товара, перемещаемого в виде компонентов (число, месяц, год)<br/>
						<xsl:call-template name="date">
							<xsl:with-param name="text" select="gcd:ApplicationRegistration/cat_ru:PrDocumentDate"/>
						</xsl:call-template>
					  </td>
				   ...
				   <tr>
						<td>
							7. Регистрационный номер решения о классификации товара, перемещаемого в виде компонентов<br/>
							<xsl:apply-templates select="gcd:PrecedingDecisionRegNumber"/>
						</td>
						<td>
							8. Дата принятия решения о классификации товара, перемещаемого в виде компонентов (число, месяц, год)<br/>
							<xsl:call-template name="date"><xsl:with-param name="text" select="gcd:PrecedingDecisionRegNumber/gcd:Date"/></xsl:call-template>
						</td>
					</tr>
				   <tr>
					  <td colspan="2">
					  9. Наименование товара, указанное в решении о классификации товара, перемещаемого в виде компонентов<br/>
					  <xsl:if test="gcd:GoodsDescription">
						  <xsl:for-each select="gcd:GoodsDescription">
							  <xsl:value-of select="."/>
						  </xsl:for-each>
					...
					<tr>
						<td colspan="2">
							10. Основание(я) принятия решения об отказе в рассмотрении заявления о внесении изменений в решение о классификации товара, перемещаемого в виде компонентов<br/>
							<xsl:apply-templates select="gcd:InterpretationRules"/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							11. Причины(а) принятия решения об отказе в рассмотрении заявления о внесении изменений в решение о классификации товара, перемещаемого в виде компонентов:<br/>
							<xsl:for-each select="gcd:ReasonsForDecision">
		  ...
		  <xsl:if test="gcd:RegistryNumber/gcd:IDDoc='ПД'">
			<table>
				<tbody>
				   ...
				   <tr>
					  <td>
						 3. Регистрационный номер решения о прекращении действия решения о классификации товара, перемещаемого в виде компонентов<br/>
						 <xsl:apply-templates select="gcd:RegistryNumber"/>
					  </td>
					  <td>
						 4. Дата принятия решения о прекращении действия решения о классификации товара, перемещаемого в виде компонентов (число, месяц, год)<br/>
							<xsl:call-template name="date">
								<xsl:with-param name="text" select="gcd:RegistryNumber/gcd:Date"/>
							</xsl:call-template>
					  </td>
				   ...
				   <tr>
					  <td>
						5. Регистрационный номер решения о классификации товара, перемещаемого в виде компонентов, действие которого прекращается<br/>
						<xsl:apply-templates select="gcd:PrecedingDecisionRegNumber"/>
					  </td>
					  <td>
						6. Дата принятия решения о классификации товара, перемещаемого в виде компонентов, действие которого прекращается (число, месяц, год)<br/>
						<xsl:call-template name="date">
				   ...
				   <tr>
					  <td colspan="2">
					  7. Наименование товара, указанное в решении о классификации товара, перемещаемого в виде компонентов<br/>
					  <xsl:if test="gcd:GoodsDescription">
						  <xsl:for-each select="gcd:GoodsDescription">
							  <xsl:value-of select="."/>
						  </xsl:for-each>
				   ...
				   <tr>
						<td colspan="2">
							8. Основание(я) принятия решения о прекращении действия решения о классификации товара, перемещаемого в виде компонентов<br/>
							<xsl:apply-templates select="gcd:InterpretationRules"/>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							9. Причины(а) принятия решения о прекращении действия решения о классификации товара, перемещаемого в виде компонентов:<br/>
							<xsl:for-each select="gcd:ReasonsForDecision">
								9.<xsl:value-of select="gcd:Number"/><xsl:text> </xsl:text><xsl:apply-templates select="gcd:Text"/>
								<xsl:if test="position()!=last()"><br/></xsl:if>
							</xsl:for-each>
					...
					<tr>
						<td colspan="2">
							10. Срок вступления в силу решения о прекращении действия решения о классификации товара, перемещаемого в виде компонентов<br/>
							<xsl:call-template name="date"><xsl:with-param name="text" select="gcd:DateEntryIntoForce"/></xsl:call-template>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							11. Служебные отметки<br/>
							<xsl:apply-templates select="gcd:Mark"/>
						</td>
					</tr>
					<tr>
      ...
      <xsl:if test="gcd:Comment">
		  <div class="pagePortrait">
			<table width="100%" style="font-size:10pt;border:0px;">
				<tbody>
				   <tr>
					  <td width="100%" style="font-size:10pt;border:0px;">Примечания:</td>
				   </tr>
					<xsl:for-each select="gcd:Comment">
					   <tr>
						  <td style="font-size:10pt;border:0px;border-bottom:1px solid black;">
							  <xsl:value-of select="."/>
						  </td>
					  </tr>	  
					</xsl:for-each>
