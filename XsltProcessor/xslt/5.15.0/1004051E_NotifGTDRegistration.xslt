...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:nGTDr="urn:customs.ru:Information:ExchangeDocuments:NotifGTDRegistration:5.14.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="/">
		<html>
			<head>
							...
							<td class="annot graphMain" style="width:100%">
								<span>
									...
									<xsl:variable name="AddNumber">
										<xsl:if test="nGTDr:NotifGTDRegistration/nGTDr:GTDID/nGTDr:AddNumber">/<xsl:choose>
