						...
						<tbody>
                           ...
                           <!--xsl:if test="soup:COMPLECTBL= 1">ТД1/ТД2</xsl:if>
							<xsl:if test="soup:COMPLECTBL =3">ТД3/ТД4</xsl:if-->
									<br/>
									<xsl:if test="soup:PI_URN">Уникальный идентификатор предварительной информации: <xsl:value-of select="soup:PI_URN"/>
									</xsl:if>
									<br/>
							...
							<table cellpadding="0" cellspacing="0" style="width:100%;border:solid 0pt #000000;">
                                ...
                                Кол-во
                                    ...
                                    ,
													...
													<xsl:if test="soup:ESADGoodsPackaging/catESAD_cu:PackagePalleteInformation[catESAD_cu:InfoKindCode='0']">
														<xsl:for-each select="soup:ESADGoodsPackaging/catESAD_cu:PackagePalleteInformation[catESAD_cu:InfoKindCode='0']">
										...
										<tbody>
													...
													<xsl:choose>
														<xsl:when test="soup:ESADGoodsShipmentP/soup:ESADoutDeclarantP/soup:ESADFilledPerson">
															...
															<xsl:if test="soup:ESADGoodsShipmentP/soup:ESADoutDeclarantP/soup:ESADFilledPerson/catESAD_cu:IdentityCard">
																<br/>
																<xsl:value-of select="soup:ESADGoodsShipmentP/soup:ESADoutDeclarantP/soup:ESADFilledPerson/catESAD_cu:IdentityCard/catESAD_cu:IdentityCardName"/>
																<xsl:value-of select="soup:ESADGoodsShipmentP/soup:ESADoutDeclarantP/soup:ESADFilledPerson/catESAD_cu:IdentityCard/catESAD_cu:IdentityCardSeries"/>
																<xsl:value-of select="soup:ESADGoodsShipmentP/soup:ESADoutDeclarantP/soup:ESADFilledPerson/catESAD_cu:IdentityCard/catESAD_cu:IdentityCardNumber"/>
																<xsl:call-template name="russian_date">
																...
																<xsl:value-of select="soup:ESADGoodsShipmentP/soup:ESADoutDeclarantP/soup:ESADFilledPerson/catESAD_cu:IdentityCard/catESAD_cu:OrganizationName"/>
															</xsl:if>
											...
											<tr>
												<td class="graph" colspan="3" style="width:{65}mm;border-right:solid 0.8pt #000000;">
													<span class="graph">Специальные отметки таможенного органа: <xsl:value-of select="soup:ESADGoodsShipmentP/soup:CustomsRemarks/soup:CustomsRemarksCode"/>
													</span>
												</td>
											</tr>
											<tr>
												<td class="graph" colspan="3" style="width:{103}mm;border-right:solid 0.8pt #000000;">
													<span class="graph">Код вида таможенного контроля: <xsl:value-of select="soup:ESADGoodsShipmentP/soup:CustomsRemarks/soup:ProcedureCode"/>
													</span>
												</td>
											</tr>
											<tr>
