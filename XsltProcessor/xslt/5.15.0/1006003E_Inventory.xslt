...
<xsl:stylesheet exclude-result-prefixes="ivt cat_ru" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:ivt="urn:customs.ru:Information:CustomsDocuments:Inventory:5.15.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
