...
в соответствии с требованиями таможенного органа о представлении документов и (или) сведений</td>
					...
					<table class="graphMain" width="100%">
						<tbody>
							...
							<tr align="center">
								<td class="graphLittle">(указать вид Требования) </td>
							</tr>
							<tr class="delim_3">
								<td>
									<br/>
