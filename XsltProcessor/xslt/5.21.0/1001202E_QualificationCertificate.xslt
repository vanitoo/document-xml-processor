...
<xsl:stylesheet exclude-result-prefixes="quc cat_ru" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:quc="urn:customs.ru:Information:RegistrationDocuments:QualificationCertificate:5.21.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.21.0">
