...
<xsl:stylesheet exclude-result-prefixes="cdi  cat_ru" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:cdi="urn:customs.ru:Information:RegistrationDocuments:CertificatDImmatriculation:5.21.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
