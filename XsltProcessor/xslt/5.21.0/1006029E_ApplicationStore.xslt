...
<xsl:stylesheet version="1.0" xmlns:apps="urn:customs.ru:Information:CustomsDocuments:ApplicationStore:5.21.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.21.0" xmlns:catTrans_ru="urn:customs.ru:Information:TransportDocuments:TransportCommonAgregateTypesCust:5.21.0">
							...
							<tbody>
								...
								<tr>
									<th align="right" class="normal" colspan="10">
										...
										<xsl:if test="apps:StoreInform/apps:Sold">
											в
											<xsl:apply-templates select="apps:StoreInform/apps:Sold/apps:Currency"/>
										</xsl:if>
									</th>
									<td align="center" class="bold" colspan="1">
										<xsl:apply-templates select="apps:StoreInform/apps:Sold/apps:TotalCost"/>
									</td>
									<td align="center" class="bold" colspan="1">
										<xsl:apply-templates select="apps:StoreInform/apps:Sold/apps:CustomsTotalCostGoods"/>
									</td>
					...
					<xsl:if test="apps:Comments">
						<p align="left" class="normal">
							Примечание:	<xsl:for-each select="apps:Comments">
								<xsl:apply-templates select="apps:OtherInform"/>
								<xsl:text> </xsl:text>
							</xsl:for-each>
						</p>
					</xsl:if>
