...
-->
<xsl:stylesheet version="1.0" xmlns:tdld="urn:customs.ru:Information:CustomsDocuments:TransitDateLimitDecision:5.21.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.21.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
		...
		<html>
			...
			<body>
				<div class="page" style="width: {$w}mm;">
									...
									<font size="4">
										<xsl:choose>
											<xsl:when test="tdld:DocKind=1">
												<xsl:text>Решение о продлении срока таможенного транзита </xsl:text>
											</xsl:when>
											<xsl:when test="tdld:DocKind=2">
												<xsl:text>Решение об отказе в продлении установленного срока таможенного транзита</xsl:text>
											</xsl:when>
										</xsl:choose>
									</font>
								</td>
					...
					<table/>-->
					<xsl:if test="tdld:RegistrationNumber">
						<table>
							<tr>
								<td class="annot graphMain" style="width:50%">Регистрационный номер Заявления</td>
								<td class="value graphMain" style="width:50%">
									<xsl:apply-templates mode="GTD_num" select="tdld:RegistrationNumber"/>
								</td>
							</tr>
						</table>
					</xsl:if>
					<xsl:if test="tdld:TransportDoc">
						<div class="title marg-top">Регистрационный номер ТД / номер книжкии МДП или карнета АТА</div>
						<div>
							<xsl:apply-templates select="tdld:TransportDoc">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
					<xsl:if test="tdld:RegDetails">
						<div class="title marg-top">Сведения о ТО, зарегистрировавшем Заявление</div>
						<div>
							<xsl:apply-templates select="tdld:RegDetails">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
					<xsl:if test="tdld:DecisionDetails">
						<div class="title marg-top">Сведения о ТО, принявшем Решение</div>
						<div>
							<xsl:apply-templates select="tdld:DecisionDetails">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
					...
					<xsl:if test="tdld:DocumentDate">
						<table>
							<tr>
								...
								<td class="value graphMain" style="width:50%">
									<xsl:value-of select="tdld:DocumentDate"/>
								</td>
							</tr>
						</table>
					</xsl:if>
					<br/>
					<xsl:if test="tdld:ProlongDate">
						<table>
							<tr>
								<td class="annot graphMain" style="width:50%">Запрашиваемый срок продления</td>
								<td class="value graphMain" style="width:50%">
									<xsl:call-template name="russian_date">
										<xsl:with-param name="dateIn" select="tdld:ProlongDate"/>
									</xsl:call-template>
								</td>
							</tr>
						</table>
					</xsl:if>
					<xsl:if test="tdld:FactProlongDate">
						<table>
							<tr>
								<td class="annot graphMain" style="width:50%">Дата, до которой продлен срок таможенного транзита</td>
								<td class="value graphMain" style="width:50%">
									<xsl:call-template name="russian_date">
										<xsl:with-param name="dateIn" select="tdld:FactProlongDate"/>
									</xsl:call-template>
								</td>
							</tr>
						</table>
					...
					<xsl:if test="tdld:Reason">
						<table>
							<tr>
								<td class="annot graphMain" style="width:50%">Обстоятельства, обусловившие необходимость продления срока таможенного транзита</td>
					...
					<br/>
					<xsl:if test="tdld:Applicant">
						<div class="title marg-top">Сведения о лице, направившем Заявление</div>
						<div>
							<xsl:apply-templates select="tdld:Applicant">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
					<xsl:if test="tdld:Carrier">
						<div class="title marg-top">Сведения о лице, осуществляющем перевозку</div>
						<div>
					...
					<xsl:if test="tdld:CarrierEqualFlag">
						<table>
							<tr>
								<td class="annot graphMain" style="width:50%">Признак совпадения сведений о лице, направившем Заявление, со сведениями о лице, осуществляющем перевозку товаров</td>
								<td class="value graphMain" style="width:50%">
									<xsl:choose>
										<xsl:when test="tdld:CarrierEqualFlag='true'">
					...
					<xsl:if test="tdld:UIN">
						<div class="title marg-top">УИН описи</div>
						<div>
							<xsl:apply-templates select="tdld:UIN">
								<xsl:with-param name="wdth" select="$w"/>
							</xsl:apply-templates>
						</div>
					</xsl:if>
					<xsl:if test="tdld:ProvidedDocuments">
						...
						<table class="bordered">
							<tbody>
								...
								<xsl:for-each select="tdld:ProvidedDocuments">
	...
	<xsl:template match="RUScat_ru:IdentityCard">
		...
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			...
			<xsl:if test="RUScat_ru:FullIdentityCardName">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Полное наименование</td>
						<td class="value graphMain" style="width:50%">
	...
	<xsl:template match="tdld:Address">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<table>
	...
	<xsl:template match="tdld:Applicant">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
	...
	<xsl:template match="tdld:ChiefReg">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<table>
	...
	<xsl:template match="tdld:CustomsPersonReg">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<table>
	...
	<xsl:template match="tdld:CustomsReg">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<table>
	...
	<xsl:template match="tdld:DecisionDetails">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<xsl:if test="tdld:DateDecision">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Дата принятия решения</td>
						<td class="value graphMain" style="width:50%">
							<xsl:call-template name="russian_date">
								<xsl:with-param name="dateIn" select="tdld:DateDecision"/>
							</xsl:call-template>
						</td>
					</tr>
				</table>
			</xsl:if>
			<xsl:if test="tdld:Customs">
			...
			<xsl:if test="tdld:CustomsPerson">
				<div class="title marg-top">Должностно лицо</div>
				<div>
					<xsl:apply-templates select="tdld:CustomsPerson">
						<xsl:with-param name="wdth" select="$w"/>
					</xsl:apply-templates>
				</div>
			</xsl:if>
	...
	<xsl:template match="tdld:InformingWay">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<xsl:if test="cat_ru:Phone">
	...
	<xsl:template match="tdld:MDPNumber">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<table>
				<tr>
					<td class="annot graphMain" style="width:50%">Номер</td>
					<td class="value graphMain" style="width:50%">
						<xsl:value-of select="tdld:TIRID"/>
					</td>
				</tr>
			</table>
			<table>
				<tr>
					<td class="annot graphMain" style="width:50%">Серия</td>
					<td class="value graphMain" style="width:50%">
						<xsl:value-of select="tdld:TIRSeries"/>
					</td>
				</tr>
			</table>
			<xsl:if test="tdld:TIRPageNumber">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Номер листа</td>
						<td class="value graphMain" style="width:50%">
							<xsl:value-of select="tdld:TIRPageNumber"/>
						</td>
					</tr>
				</table>
			</xsl:if>
			<xsl:if test="tdld:RegistrationDate">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Дата регистрации</td>
						<td class="value graphMain" style="width:50%">
							<xsl:call-template name="russian_date">
								<xsl:with-param name="dateIn" select="tdld:RegistrationDate"/>
							</xsl:call-template>
						</td>
					</tr>
				</table>
	...
	<xsl:template match="tdld:ProvidedDocuments">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<tr>
	...
	<xsl:template match="tdld:RegDetails">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<xsl:if test="tdld:DateReg">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Дата регистрации документа</td>
						<td class="value graphMain" style="width:50%">
							<xsl:call-template name="russian_date">
								<xsl:with-param name="dateIn" select="tdld:DateReg"/>
							</xsl:call-template>
						</td>
					</tr>
				</table>
			</xsl:if>
			<xsl:if test="tdld:CustomsReg">
				<div class="title marg-top">Код и наименование</div>
				<div>
					<xsl:apply-templates select="tdld:CustomsReg">
						<xsl:with-param name="wdth" select="$w"/>
					</xsl:apply-templates>
				</div>
			</xsl:if>
			<xsl:if test="tdld:CustomsPersonReg">
				<div class="title marg-top">Должностное лицо</div>
				<div>
					<xsl:apply-templates select="tdld:CustomsPersonReg">
						<xsl:with-param name="wdth" select="$w"/>
					</xsl:apply-templates>
				</div>
			</xsl:if>
			<xsl:if test="tdld:ChiefReg">
				<div class="title marg-top">Начальник</div>
				<div>
					<xsl:apply-templates select="tdld:ChiefReg">
						<xsl:with-param name="wdth" select="$w"/>
					</xsl:apply-templates>
				</div>
			</xsl:if>
	...
	<xsl:template match="tdld:TransportDoc">
		<xsl:param name="wdth" select="0"/>
		<xsl:variable name="w" select="$wdth - 5"/>
		<div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;">
			<xsl:if test="tdld:TD">
				<table>
					<tr>
						...
						<td class="value graphMain" style="width:50%">
							<xsl:apply-templates mode="GTD_num" select="tdld:TD"/>
						</td>
					</tr>
				</table>
			</xsl:if>
			<xsl:if test="tdld:MDPNumber">
				<div class="title marg-top">Номер книжки МДП</div>
				<div>
					<xsl:apply-templates select="tdld:MDPNumber">
						<xsl:with-param name="wdth" select="$w"/>
					</xsl:apply-templates>
				</div>
			</xsl:if>
			<xsl:if test="tdld:CarnetNumber">
				<table>
					<tr>
						<td class="annot graphMain" style="width:50%">Номер карнета АТА</td>
						<td class="value graphMain" style="width:50%">
							<xsl:value-of select="tdld:CarnetNumber"/>
						</td>
					</tr>
				</table>
			</xsl:if>
