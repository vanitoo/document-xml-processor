...
<xsl:stylesheet version="1.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.21.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:rapc="urn:customs.ru:Information:CustomsDocuments:RepresApplicChange:5.21.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
