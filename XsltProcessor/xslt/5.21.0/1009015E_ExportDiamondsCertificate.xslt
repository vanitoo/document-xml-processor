...
<xsl:stylesheet exclude-result-prefixes="cat_ru ediac " version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:ediac="urn:customs.ru:Information:SertifDocuments:ExportDiamondsCertificate:5.21.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
