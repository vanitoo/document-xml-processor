...
<xsl:stylesheet version="1.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.21.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.21.0" xmlns:enfwhg="urn:customs.ru:Information:CustomsDocuments:NonExportNoticeFreeWHGoods:5.21.0" xmlns:catProc_ru="urn:customs.ru:Information:ProcessingDocuments:ProcessingCommonAggregateTypes:5.21.0">
	...
	<xsl:template match="enfwhg:NonExportNoticeFreeWHGoods">
		<html>
			<head>
				<style>
                  body {
						...
						<tbody>
									...
									<table width="100%">
										<tbody>
											...
											<tr>
												...
												<td valign="top" class="graphLittle"> (наименование таможенного органа (с указанием кода таможенного органа) </td>
											</tr>
											<tr>
								...
								<td align="center" class="title">
									<font size="4">
										<b>
											...
											<br/>
											<xsl:text>о невывозе товаров, помещенных под таможенную процедуру свободного склада, и товаров, изготовленных (полученных) из товаров, помещенных под таможенную процедуру свободного склада, со свободного склада отправления в целях их перемещения на территорию свободного склада назначения
</xsl:text>
										</b>
									</font>
								</td>
							...
							<tr>
								<td style="text-align: justify; text-indent: 5%">
									<xsl:text>Настоящим  уведомляю  о невывозе с территории свободного склада товаров (части    товаров),    заявленных    в   Уведомлении   о   вывозе товаров № </xsl:text>
									<span class="value">
										<xsl:apply-templates mode="Certificate" select="enfwhg:NotifRegNum"/>
									</span>
									<xsl:text>, и их нахождении на территории свободного склада.</xsl:text>
								</td>
							</tr>
							<tr>
								<td class="delim_3">
							...
							<tr>
								<td>
									<table>
										<tbody>
											<tr align="center">
												<td class="bordered" width="10%">N п/п </td>
												<td class="bordered" width="30%">Наименование товара </td>
												<td class="bordered" width="15%">Номер товара </td>
												<td class="bordered" width="20%">Количество и единица измерения </td>
												<td class="bordered" width="25%">Отметки таможенного органа </td>
											</tr>
											<tr align="center">
											...
											<xsl:for-each select="enfwhg:Goods">
												<tr>
													<td class="bordered">
										...
										<tbody>
											<tr valign="bottom">
												<td class="value" width="35%">
													...
													<xsl:if test="enfwhg:ApproverPerson/enfwhg:AuthoritesDocument"> (<xsl:apply-templates mode="confirm_authority_doc" select="enfwhg:ApproverPerson/enfwhg:AuthoritesDocument"/>)</xsl:if>
												</td>
												<td width="5%"/>
											...
											<tr valign="top">
												<td class="graphLittle">(владелец свободного склада или лицо, действующее по его поручению) </td>
												<td/>
