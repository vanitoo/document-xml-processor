...
<xsl:stylesheet exclude-result-prefixes="tcp cat_ru catESAD_ru" version="1.0" xmlns:catESAD_ru="urn:customs.ru:RUCommonAggregateTypes:5.21.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:tcp="urn:customs.ru:Information:CustomsDocuments:TransportMeansChassisPassport:5.21.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
