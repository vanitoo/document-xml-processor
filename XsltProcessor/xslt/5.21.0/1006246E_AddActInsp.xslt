...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:ATDcat="urn:customs.ru:Information:CustomsDocuments:ATDCommon:5.21.0" xmlns:aai="urn:customs.ru:Information:CustomsDocuments:AddActInsp:5.21.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
						...
						<tbody>
							<tr>
								<td align="center" class="graphMain">
									<font size="4">
										<b>Дополнение к акту фактического контроля<!--досмотра/осмотра--></b>
									</font>
								</td>
							</tr>
						</tbody>
