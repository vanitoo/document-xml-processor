...
<xsl:stylesheet exclude-result-prefixes="rdro cat_ru" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:rdro="urn:customs.ru:Information:ExchangeDocuments:RejectDeclReqOperation:5.21.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
