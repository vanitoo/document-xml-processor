...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.21.0" xmlns:rstvha="urn:customs.ru:Information:SQDocuments:RosstandartVehicleApproval:5.21.0">
			...
			<body>
										...
										<table>
											<tbody>
												<tr valign="top">
													...
													<td width="67%">
														<xsl:text>N </xsl:text>
														<xsl:value-of select="rstvha:DocId"/>
														<br/>
														<br/>
														...
														<xsl:if test="rstvha:TCvalidityEnd">
															...
															<xsl:call-template name="russian_date">
																<xsl:with-param name="dateIn" select="rstvha:TCvalidityEnd"/>
															</xsl:call-template>
														</xsl:if>
													</td>
												</tr>
											...
											<tbody>
												<tr valign="top">
													...
													<td width="25%" style="border-left:1px solid black;border-top:1px solid black;">
														...
														<br/>
														<xsl:value-of select="rstvha:TransportMean/rstvha:ProductCode"/>
													</td>
												</tr>
												<tr>
													<td/>
											...
											<tbody>
												<tr valign="top">
													...
													<td width="25%" style="border-left:1px solid black;border-top:1px solid black;">
														...
														<br/>
														<xsl:value-of select="rstvha:TransportMean/rstvha:Tnved"/>
													</td>
												</tr>
												<tr>
													<td/>
									...
									<td>
										<table>
											<tbody>
													...
													<td width="50%" class="bordered">
														<xsl:choose>
															<xsl:when test="rstvha:TransportMean/rstvha:Tcbrand">
																<xsl:value-of select="rstvha:TransportMean/rstvha:Tcbrand"/>
															</xsl:when>
															<xsl:otherwise>
																<xsl:text> -- </xsl:text>
															</xsl:otherwise>
													...
													<td class="bordered">
														<xsl:choose>
															<xsl:when test="rstvha:TransportMean/rstvha:TCtradeName">
																<xsl:value-of select="rstvha:TransportMean/rstvha:TCtradeName"/>
															</xsl:when>
															<xsl:otherwise>
																<xsl:text> -- </xsl:text>
															</xsl:otherwise>
												...
												<tr valign="top">
													...
													<td class="bordered">
														<xsl:value-of select="rstvha:TransportMean/rstvha:Tctype"/>
													</td>
												</tr>
												<xsl:if test="rstvha:TransportMean/rstvha:TctypeOtherManufacturer">
													<tr valign="top">
														...
														<td class="bordered">
															<xsl:value-of select="rstvha:TransportMean/rstvha:TctypeOtherManufacturer"/>
														</td>
													</tr>
												</xsl:if>
												<tr valign="top">
													...
													<td class="bordered">
														<xsl:choose>
															<xsl:when test="rstvha:TransportMean/rstvha:Tcmodifications">
																<xsl:value-of select="rstvha:TransportMean/rstvha:Tcmodifications"/>
															</xsl:when>
															<xsl:otherwise>
																<xsl:text> -- </xsl:text>
															</xsl:otherwise>
													...
													<td class="bordered">
														<xsl:choose>
															<xsl:when test="rstvha:TransportMean/rstvha:Tccategory">
																<xsl:value-of select="rstvha:TransportMean/rstvha:Tccategory"/>
															</xsl:when>
															<xsl:otherwise>
																<xsl:text> -- </xsl:text>
															</xsl:otherwise>
													...
													<td class="bordered">
														<xsl:choose>
															<xsl:when test="rstvha:TransportMean/rstvha:EcoClass">
																<xsl:value-of select="rstvha:TransportMean/rstvha:EcoClass"/>
															</xsl:when>
															<xsl:otherwise>
																<xsl:text> -- </xsl:text>
															</xsl:otherwise>
										...
										<xsl:choose>
											...
											<xsl:when test="rstvha:TransportMean/rstvha:SeriesSign=2">
												...
												<xsl:value-of select="rstvha:TransportMean/rstvha:PartySize"/>
												...
												<xsl:if test="rstvha:TransportMean/rstvha:VINIDDetails">
													...
													<xsl:for-each select="rstvha:TransportMean/rstvha:VINIDDetails">
														<xsl:if test="position() &gt; 1">, </xsl:if>
														<xsl:for-each select="rstvha:VINRange">
															<xsl:if test="position() &gt; 1">, </xsl:if>
															<xsl:text> с </xsl:text>
															<xsl:value-of select="rstvha:FirstVIN"/>
															<xsl:text> по </xsl:text>
															<xsl:value-of select="rstvha:LastVIN"/>
														</xsl:for-each>
													</xsl:for-each>
													<xsl:text>.</xsl:text>
												</xsl:if>
											...
											<tbody>
												<tr valign="bottom">
													<td width="50%" style="border-bottom: 1px solid black;">
														<xsl:value-of select="rstvha:CertificateOrg/cat_ru:OrganizationName"/>
														<xsl:if test="not(rstvha:CertificateOrg/cat_ru:OrganizationName) and rstvha:CertificateOrg/cat_ru:ShortName">
															<xsl:value-of select="rstvha:CertificateOrg/cat_ru:ShortName"/>
														</xsl:if>
													</td>
													<td width="1%"/>
													<td width="20%" style="border-bottom: 1px solid black;"/>
								...
								<tr>
									<td>
										...
										<xsl:choose>
											...
											<xsl:when test="rstvha:TransportMean/rstvha:SeriesSign=2">
												<xsl:text>Действие данного ОДОБРЕНИЯ ТИПА ТРАНСПОРТНОГО СРЕДСТВА распространяется на партию транспортных средств в количестве </xsl:text>
												<span class="ib"><xsl:value-of select="rstvha:TransportMean/rstvha:PartySize"/></span>
												<xsl:text> шт. </xsl:text>
												<xsl:if test="rstvha:TransportMean/rstvha:VINIDDetails">
													<xsl:text> с идентификационными номерами (VIN) </xsl:text>
													<xsl:for-each select="rstvha:TransportMean/rstvha:VINIDDetails">
														...
														<xsl:for-each select="rstvha:VINRange">
															<xsl:if test="position() &gt; 1">, </xsl:if>
															<xsl:text> с </xsl:text>
															<span class="ib"><xsl:value-of select="rstvha:FirstVIN"/></span>
															<xsl:text> по </xsl:text>
															<span class="ib"><xsl:value-of select="rstvha:LastVIN"/></span>
														</xsl:for-each>
													</xsl:for-each>
													<xsl:text>.</xsl:text>
												</xsl:if>
							...
							<tbody>
								<tr>
									<td align="center">
										<xsl:text>№ </xsl:text>
										<span style="display:inline-block;width:50mm;border-bottom:1px solid black;text-align:center;">
											<xsl:value-of select="rstvha:DocRegNumber_1"/>
										</span>
									</td>
								</tr>
							</tbody>
							...
							<tbody>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:WheelsInfoKatL"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:WheelsInfoKatO"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:WheelsInfoNotKatO"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:VehicleLayout"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EngineLocation"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:VehicleBody"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:BootSpaceExecution"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:VehicleFunction"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:NumberSeats"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:PassengerCapacity"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:TotalLuggageSpace"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Cabin"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Frame"/>
									</td>
								</tr>
								<tr align="left" valign="top">
								...
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:DimensionInfo/rstvha:Lenght"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:DimensionInfo/rstvha:Wight"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										...
										<xsl:value-of select="rstvha:TransportMean/rstvha:DimensionInfo/rstvha:Height"/>
										<br/>
										<xsl:text>максимальная допустимая: </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:DimensionInfo/rstvha:MaxHeight"/>
									</td>
								</tr>
								<tr align="left" valign="top">
								...
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:FrontTrack"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:BackTrack"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:VehicleMass"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:VehicleMaxMass"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:VehicleMaxMassAxle"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:RoadTrainMaxMass"/>
									</td>
								</tr>
								<tr align="left" valign="top">
								...
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:TrailerBrakeMaxMass"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:MaxLoadFifthWheel"/>
									</td>
								</tr>
								<tr align="left" valign="top">
								...
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:InternalCombustionEngine/rstvha:BrandEngine"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:InternalCombustionEngine/rstvha:TypeEngine"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:InternalCombustionEngine/rstvha:Cylinders"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:InternalCombustionEngine/rstvha:EngineVolumeQuanity"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:InternalCombustionEngine/rstvha:CompressionRatio"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:InternalCombustionEngine/rstvha:EngineMaxPowerMeasure"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:InternalCombustionEngine/rstvha:EngineMaxTorque"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:InternalCombustionEngine/rstvha:Fuel"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:PowerSystem"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:CarburetorKind"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:CarburetorMark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:ControlBlock"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:HPFPKind"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:HPFPMark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:NozzlesKind"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:NozzlesMark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:AirBlowerKind"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:AirBlowerMark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:AirFilterKind"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:AirFilterMark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
								...
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:IntakeSilencers/rstvha:Stage1Mark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:IntakeSilencers/rstvha:Stage2Mark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:IntakeSilencers/rstvha:Stage3Mark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:IgnitionSystemKind"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:DistributorMark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:CommutatorMark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:IgnitionCoilMark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:CandlesMark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
								...
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:ExhaustSystemGas/rstvha:Neutralizers/rstvha:Stage2Mark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:ExhaustSystemGas/rstvha:IntakeSilencers/rstvha:Stage1Mark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									<td class="bordered" width="50%">- 2 ступень
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:ExhaustSystemGas/rstvha:IntakeSilencers/rstvha:Stage2Mark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									<td class="bordered" width="50%">- 3 ступень
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:ExhaustSystemGas/rstvha:IntakeSilencers/rstvha:Stage3Mark"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:ExhaustSystemGas/rstvha:ParticulateFilter"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:ElectricEngine/rstvha:BrandEngine"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:ElectricEngine/rstvha:TypeEngine"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:ElectricEngine/rstvha:OperatingVoltage"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:ElectricEngine/rstvha:EngineMaxPowerMeasure"/>
									</td>
								</tr>
								<tr align="left" valign="top">
								...
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:BrandBattery"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:TypeBattery"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:ElChemicSteam"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:QuantityEl"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:Mass"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									<td class="bordered" width="50%">Рабочее напряжение, В
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:OperatingVoltage"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:Capacity"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:Location"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:BrandCapacitor"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:TypeCapacitor"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:EnergyIntensity"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:BrandGenerator"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:TypeGenerator"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:EnergyStorageDevice/rstvha:PowerReserve"/>
									</td>
								</tr>
								<tr align="left" valign="top">
								...
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:BrandElectricMachine"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:TypeElectricMachine"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									<td class="bordered" width="50%">Рабочее напряжение, В
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:OperatingVoltage"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									<td class="bordered" width="50%">Максимальная 30-минутная мощность, кВт
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:EngineMaxPowerMeasure"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:BrandClutch"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:TypeClutch"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:BrandGearbox"/>
										<xsl:text> </xsl:text>
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:TypeGearbox"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:GearRatios"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:TypeTransferBox"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									<td class="bordered" width="50%">число передач и передаточные числа
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:GearRatiosTransferBox"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:MainGear/rstvha:TypeMainGear"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:MainGear/rstvha:GearRatio"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Transmission/rstvha:MainGear/rstvha:IntermediateGearRatio"/>
									</td>
								</tr>
								<tr align="left" valign="top">
								...
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:FrontSuspension"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:BackSuspension"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Steering/rstvha:Description"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Steering/rstvha:TypeMechanism"/>
									</td>
								</tr>
								<tr align="left" valign="top">
								...
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:BrakeSystems/rstvha:Working"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:BrakeSystems/rstvha:Spare"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:BrakeSystems/rstvha:Parking"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:BrakeSystems/rstvha:Auxiliary"/>
									</td>
								</tr>
								<tr align="left" valign="top">
								...
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Tyres/rstvha:SizeDesign"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Tyres/rstvha:LoadCapacityIndex"/>
									</td>
								</tr>
								<tr align="left" valign="top">
									...
									<td class="bordered" width="50%">
										<xsl:value-of select="rstvha:TransportMean/rstvha:Tyres/rstvha:SpeedCategoryDesign"/>
									</td>
								</tr>
								<tr align="left" valign="top">
							...
							<tbody>
								<tr>
									<td align="right">
										<xsl:text>Дата оформления </xsl:text>
										<xsl:call-template name="date_month">
											<xsl:with-param name="dateIn" select="rstvha:IssueDate"/>
										</xsl:call-template>
									</td>
								</tr>
							</tbody>
										...
										<table>
											<tbody>
												...
												<xsl:for-each select="rstvha:TransportMean">
													<tr valign="top">
														<td class="bordered">
															<xsl:value-of select="rstvha:ProductCode"/>
															<br/>
															<xsl:value-of select="rstvha:Tnved"/>
														</td>
														<td class="bordered">
															<xsl:apply-templates select="."/>
															<br/>
				...
				<xsl:if test="rstvha:DocKind = 2 or rstvha:DocKind = 3">
							...
							<tbody>
								<tr>
									<td align="right">
											Приложение N 1<br/>
											к одобрению типа<br/>
											транспортного средства N <xsl:value-of select="rstvha:DocId"/>
										<br/>
										<br/>
											Стр. ____
									</td>
						...
						<table>
							<tbody>
								...
								<xsl:for-each select="rstvha:ApprovalBaseDocuments">
									<tr valign="top">
										<td class="bordered">
											<xsl:value-of select="rstvha:ElementsObjTechnReg"/>
										</td>
										<td class="bordered">
											<xsl:value-of select="rstvha:NameAndOriginDoc"/>
										</td>
										<td class="bordered">
											<xsl:if test="rstvha:DocumentNumber">
												<xsl:text> № </xsl:text>
												<xsl:value-of select="rstvha:DocumentNumber"/>
											</xsl:if>
											<xsl:if test="rstvha:DocumentDate">
												<xsl:text> от </xsl:text>
												<xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="rstvha:DocumentDate"/></xsl:call-template>
											</xsl:if>
										</td>
									</tr>
								</xsl:for-each>
					...
					<div class="page" style="width: {$w}mm;">
						...
						<br/>
						<p>1. Место расположения и форма единого знака обращения на рынке государств - членов Таможенного союза: <xsl:value-of select="rstvha:VehicleLabel/rstvha:LocationSingleSign"/></p>
						<p>2. Место расположения таблички изготовителя: <xsl:value-of select="rstvha:VehicleLabel/rstvha:ManufNameplateLocation"/></p>
						...
						<table>
							<tbody>
								...
								<xsl:for-each select="rstvha:VehicleLabel/rstvha:IDNumber">
									<tr align="center" valign="middle">
										<td class="bordered"><xsl:value-of select="substring(., 1, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 2, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 3, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 4, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 5, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 6, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 7, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 8, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 9, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 10, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 11, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 12, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 13, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 14, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 15, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 16, 1)"/></td>
										<td class="bordered"><xsl:value-of select="substring(., 17, 1)"/></td>
									</tr>
								</xsl:for-each>
							</tbody>
						</table>
	...
	<xsl:template match="rstvha:TransportMean">
		...
		<xsl:if test="rstvha:Vctype">
			...
			<xsl:value-of select="rstvha:Vctype"/>
		</xsl:if>
		...
		<xsl:if test="rstvha:Standard">
			...
			<xsl:value-of select="rstvha:Standard"/>
		</xsl:if>
		...
		<xsl:if test="rstvha:SerialNumber">
			...
			<xsl:value-of select="rstvha:SerialNumber"/>
		</xsl:if>
		<xsl:if test="rstvha:PartySize">
			<xsl:text> размер: </xsl:text>
			<xsl:value-of select="rstvha:PartySize"/>
		</xsl:if>
	...
	<xsl:template match="rstvha:CertificateOrg | rstvha:Applicant" mode="otts">
		...
		<xsl:if test="rstvha:DocumentDate">
			...
			<xsl:call-template name="russian_date">
				<xsl:with-param name="dateIn" select="rstvha:DocumentDate"/>
			</xsl:call-template>
		</xsl:if>
	</xsl:template>
