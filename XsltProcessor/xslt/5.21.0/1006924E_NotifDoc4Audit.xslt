				...
				<div class="page">
					<table width="100%">
						<tbody align="left" class="graphMain">
							...
							<tr align="center">
								<td width="50%"/>
								<td  width="50%" class="value">	<xsl:apply-templates select="nda:AuditOrganization"></xsl:apply-templates></td>
							</tr>
							<tr align="center">
								<td/>
								<td class="graphLittle">(адресат)</td>
							</tr>
						</tbody>
					</table>
					<table width="100%">
					...
					<table class="graphMain" width="100%">
						<tbody>
							...
							<tr style="text-align: justify;">
								<td class="graphMain">
									<xsl:if test="nda:RequestNumber/nda:DemandKind = '1'">о предоставлении документов и (или) сведений при камеральной таможенной проверке</xsl:if>
									<xsl:if test="nda:RequestNumber/nda:DemandKind = '2'"> о предоставлении документов и (или) сведений при выездной таможенной проверке</xsl:if>
									<xsl:if test="nda:RequestNumber/nda:DemandKind = '3'"> о предоставлении документов и (или) сведений при таможенной проверке у лица, связанного с проверяемым лицом по сделкам (операциям) с товарами, в отношении которых проводитсся таможенная проверка</xsl:if>
								</td>
							</tr>
							<tr class="delim_3">
								<td>
