...
<xsl:stylesheet exclude-result-prefixes="cos catSert_ru cat_ru" version="1.0" xmlns:catSert_ru="urn:customs.ru:Information:SertifDocuments:SertifCommonAggregateTypesCust:5.21.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.21.0" xmlns:cos="urn:customs.ru:Information:SertifDocuments:ConformanceSertif:5.21.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.21.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
