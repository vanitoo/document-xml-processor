...
<xsl:stylesheet version="1.0" 
	...
	xmlns:exnot="urn:customs.ru:Information:CustomsDocuments:OEZ_ExportNotif:5.21.0" 
	xmlns:oeznr="urn:customs.ru:Information:CustomsDocuments:OEZ_NotifReg:5.21.0"
							...
							<tr>
								...
								<td>
									<table style="width:130mm">
										<tbody>
											<tr>
												<td align="left"><span class="incline">B </span>
											...
											<tr>
												<td align="left"><span class="incline">От </span>
							...
							<tr align="left">
								<td>
									...
									<span class="incline">Средство транспорта </span> <u>
										...
										<xsl:if test="exnot:DocSign='1'"><span class="incline">, прицеп/полуприцеп </span> <xsl:for-each select="exnot:TransportMeans/exnot:TransportRegNumber">
