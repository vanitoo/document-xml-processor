...
<xsl:stylesheet version="1.0" xmlns:catTrans_ru="urn:customs.ru:Information:TransportDocuments:TransportCommonAgregateTypesCust:5.24.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:ncf="urn:customs.ru:Information:TransportDocuments:Air:NoticeCanceledFlight:5.24.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
