...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.24.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:dcd="urn:customs.ru:Information:CustomsDocuments:DeclChangeDecision:5.24.0">
							...
							<table style="width:190mm;border:solid 0pt">
								...
								<tr>
									<td align="left" class="graphMain" style="border:solid 0pt">
										<xsl:text>&#160;&#160;&#160;&#160;В соответствии с пунктом 2 статьи 112 Таможенного кодекса Евразийского экономического союза </xsl:text>
