				...
				<div class="page">
					...
					<table>
						<tbody align="left" class="graphMain">
							...
							<tr class="delim_3">
								<td colspan="2">
									<xsl:for-each select="aac:CustomsPerson">
										<xsl:if test="$signatures">
											...
											<xsl:apply-templates select="$signatures/cert[contains(@owner, normalize-space($FIO))]" mode="Signature"/>
										</xsl:if>
									</xsl:for-each>
								</td>
							</tr>
					...
					<table>
						<tbody align="left" class="graphMain">
							...
							<tr>
								<td class="value">
									<br/>
									<xsl:apply-templates select="aac:AuditDescription"/>
									<br/>
