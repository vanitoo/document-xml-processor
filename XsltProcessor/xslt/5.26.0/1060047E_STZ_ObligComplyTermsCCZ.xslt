								...
								<tbody>
									...
									<tr>
										<td style="text-align: justify">
											...
											<xsl:call-template name="inlinetable">
												<xsl:with-param name="data">
													<xsl:choose>
														...
														<xsl:when test="oct:TransportKind = '5'">
											...
											<xsl:text> транспортом от места их нахождения</xsl:text>
											<br/>
											<xsl:text>при таможенном декларировании</xsl:text><br/>
											<xsl:call-template name="inlinetable">
												<xsl:with-param name="data">
