...
<xsl:stylesheet version="1.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.24.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:esif="urn:customs.ru:Information:CustomsDocuments:ESADInfo:5.26.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
