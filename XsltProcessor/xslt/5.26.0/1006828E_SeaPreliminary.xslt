	...
	<xsl:template match="sp:SeaPreliminary">
		...
		<html>
			...
			<body>
              ...
              <xsl:if test="sp:CarrierDetails">
                <tr class="title">
                  <td class="bordered" colspan="4" style="background-color:#ccc;">Сведения о перевозчике</td>
                </tr>
                <xsl:apply-templates select="sp:CarrierDetails" mode="org"/>
              </xsl:if>
