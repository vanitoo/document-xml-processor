...
<xsl:stylesheet exclude-result-prefixes="whdrj cat_ru" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:whdrj="urn:customs.ru:Information:WarehouseDocuments:WHDocReject:5.24.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
