				...
				<div class="page" style="width: {$w * 3}mm;">
					<table width="100%">
						<tbody>
							<tr align="center" valign="top">
								...
								<td class="bordered" colspan="9">Раздел I<br/>Товары, помещенные под таможенную процедуру таможенного склада</td>
								<td class="bordered" colspan="7">Раздел II<br/>Товары, в отношении которых таможенная процедура таможенного склада завершена</td>
							...
							<tr align="center" valign="top">
								...
								<td class="bordered">номер складского места</td>
							...
							<xsl:for-each select="rocw:GoodsInfo">
								<tr align="center" valign="top">
									...
									<td class="bordered">
										<xsl:apply-templates select="rocw:Section1/rocw:StoragePlaceNum"/>
									</td>
									<td class="bordered">
									...
									<td class="bordered">
										<xsl:apply-templates select="rocw:Section2/rocw:IssuanceDate" mode="russian_date"/>
									</td>
									
									<td class="bordered">
										<xsl:apply-templates select="rocw:Section3/rocw:ProtocolDetails" mode="doc"/>
									</td>
									<td class="bordered">
										<xsl:apply-templates select="rocw:Section3/rocw:IssuanceDate" mode="russian_date"/>
									</td>
									
									<td class="bordered">
										<xsl:apply-templates select="rocw:Section4/rocw:GrossWeightQuantity"/>
									</td>
									<td class="bordered">
										<xsl:apply-templates select="rocw:Section4/rocw:GrossWeightQuantity"/>
									</td>
					...
					<table>
						<tbody>
							...
							<tr>
								<td class="descr" style="border-top: 1px solid black;">(подпись руководителя организации или уполномоченного лица)</td>
								<td></td>
