								...
								<tr>
									<td style="text-align: justify;">
										...
										-->
											...
											<xsl:if test="exs:CustomsControl/exs:InitiatorPerson/cat_ru:PersonPost"> (</xsl:if>
