...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:pcd="urn:customs.ru:Information:CustomsDocuments:PermitChangeData:5.24.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template match="/">
      <html>
         ...
         <body>
            ...
            Регистрационный номер КДТ/КДТЭГ: <xsl:apply-templates select="//pcd:KDTRegNumber"/>
            <br/>
            </xsl:if>
