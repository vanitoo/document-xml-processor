								...
								<xsl:when test="impn:ZoneKind = 1 or impn:ZoneKind = 3 or impn:ZoneKind = 4">
											...
											<tr>
												<td align="center" colspan="2" valign="top">
													<b>
														...
														предосавленный резиденту свободного пора Владивосток, на участок 
														резидента Арктической зоны Российской Федерации, на которых 
														применяется таможенная процедура свободной таможенной зоны 
														(за исключением портовой соборой порторвой особой экономической зоны, отдельных 
														участков морских портов, окрытых для междунаровдного сообщения 
														и захода иностранных морских судов, включая акваторию морского 
														пора, и (или) отдельных участков территории аэропорта, открытого 
														...
														зоны, земельного участка, прилегаюшего к автомобильному или 
														...
														логистического особой экономической зоны)
													</b>
													<br/>
													<br/>
													<xsl:text>№ </xsl:text>
														...
														<tbody>
															...
															<tr>
																<td align="center" class="graphLittle" style="border-top:1pt solid black">
																	<xsl:text>(резидент особой экономической зоны, резидент территории опережающего развития, резидент свобдного порта Владивосок, раездиен Арктической зоны Российской Федерации (далее - резидент) или лицо, им уполномоченное)</xsl:text>
																</td>
															</tr>
														</tbody>
													</table>
									...
									<table width="100%">
										<tbody>
											...
											<xsl:for-each select="impn:GoodsInfo/impn:Documents|impn:DocList|impn:PersonSignature">
												<tr align="left">
											...
											<tr>
												<td align="center" colspan="2" valign="top">
													<b>
														...
														открытых для между народног сообщения и захода иностранных морских судов, включая акваторию морского 
										...
										<tbody>
											...
											<tr align="left">
												<td>
													...
													<span class="squareCheckX"><xsl:if test="impn:Purpose/impn:PurposeOfImport = 2">X</xsl:if></span><xsl:text> ввоз товаров, помещаемых (помещенных) под таможенную процедуру свободной таможенной зоны, по договору оказания услуг по складированию (хранению) товаров, а также по подготовке товаров к транспортировке, включая дробение партии, формирование отправок, сортировку, упаковку, переупаковку, маркировку (далее - договор об оказании услуг)</xsl:text><br/>
													<span class="squareCheckX"><xsl:if test="impn:Purpose/impn:PurposeOfImport = 3">X</xsl:if></span><xsl:text> ввоз товаров, помещаемых под таможенную процедуру экспорта, переработки вне таможенной территории, временного вывоза, реэкспорта, специальную таможенную процедуру за пределами портового, логичтического участка, по договору об оказании услуг</xsl:text><br/>
													<span class="squareCheckX"><xsl:if test="impn:Purpose/impn:PurposeOfImport = 4">X</xsl:if></span><xsl:text> ввоз товаров, помещенных под таможенную процедуру свободной таможенной зоны, и (или) товаров, изготовленных (полученных) из товаров, помещенных под аможенную процедуру свободной таможенной зоны, которые были ранее вывезены без завершения аможенной процедуры свободной таможенной зоны в случах, установленных пунктом 4 статьи 205 ТК ЕАЭС</xsl:text><br/>
													<span class="squareCheckX"><xsl:if test="impn:Purpose/impn:PurposeOfImport = 5">X</xsl:if></span><xsl:text> ввоз товаров, не подлежащих помещению под таможенную процедурв свободной таможенной зоны</xsl:text><br/>
													...
													<td width="50%">
														...
														<table class="inlinetable" style="width: 100%;">
															<tbody>
																...
																<tr align="center">
																	<td class="descr">
																		(государственный регистрационный номер, номер вагона, контейнер, номер райса (при наличии)
																	</td>
																</tr>
															</tbody>
														</table>
									...
									<tr>
										<td align="center" colspan="2" valign="top">
											<b>
												...
												к авктомобильному или железнодорожному пункту пропуска свободного порта Владивосток, Арктической зоны 
												Российской Федерации, на котором применяется аможенная процедура свободной таможенной зоны, 
												...
												и (или) на отдельные участки треетории аэропрта, открытого для приема и отправки воздушных судов, 
