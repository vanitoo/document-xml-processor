...
<xsl:stylesheet version="1.0"
	...
	xmlns:ATDcat="urn:customs.ru:Information:CustomsDocuments:ATDCommon:5.24.0" 
	...
	xmlns:tpo="urn:customs.ru:Information:CustomsDocuments:TPO:5.26.0">
	...
	<xsl:template match="tpo:CustomsPersonName" mode="graph22">
		<xsl:if test="tpo:LNP">
			<xsl:apply-templates select="tpo:LNP"/>
			<xsl:text>, </xsl:text>
		</xsl:if>
