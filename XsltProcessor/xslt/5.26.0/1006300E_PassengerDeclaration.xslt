								...
								<tr>
									...
									<td class="bordered" valign="top" align="left" style="padding: 5px;">
										...
										<xsl:if test="pas_d:NetWeightQuantity">
											...
											<xsl:value-of select="pas_d:NetWeightQuantity/catESAD_cu:MeasuredAmount"/>
											<xsl:text> кг</xsl:text>
										</xsl:if>
									</td>
