					...
					<xsl:if test="arcn:MovingToWarehouseIndicator">
						<table>
							<tr>
								...
								<td class="value graphMain" style="width:50%">
									<xsl:choose>
										<xsl:when test="arcn:MovingToWarehouseIndicator='0' or arcn:MovingToWarehouseIndicator='false' or arcn:MovingToWarehouseIndicator='f'">
											<xsl:text>невозможно</xsl:text>
										</xsl:when>
										<xsl:when test="arcn:MovingToWarehouseIndicator='1' or arcn:MovingToWarehouseIndicator='true' or arcn:MovingToWarehouseIndicator='t'">
