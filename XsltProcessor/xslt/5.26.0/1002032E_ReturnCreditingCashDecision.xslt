...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.24.0" xmlns:rccd="urn:customs.ru:Information:CommercialFinanceDocuments:ReturnCreditingCashDecision:5.24.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
							...
							<tbody>
								...
								<xsl:choose>
									<xsl:when test="rccd:RefusalPayPercentSign = 1 or translate(substring(rccd:RefusalPayPercentSign,1,1), 'T', 't') = 't'">
										<tr>
											<td>
												<xsl:text>В связи с отказом Федерального Казначейства/Кредитной организации в возврате процентов на банковский счет, зачет процентов произведен на лицевой счет по КБК "Авансовые платежи".</xsl:text>
											</td>
										</tr>	
									</xsl:when>
