...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:clt_ru="urn:customs.ru:CommonLeafTypes:5.10.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.24.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.24.0" xmlns:fscnpr="urn:customs.ru:Information:SQDocuments:FsTekConclPermit:5.24.0">
											...
											<span class="underlined">
												<xsl:choose>
													...
													<xsl:otherwise>
														...
														<xsl:choose>
															<xsl:when test="substring(fscnpr:Authorization/cat_ru:PrDocumentNumber, $len - 3) = 'СТ20'">на вывоз из РФ</xsl:when>
															<xsl:when test="substring(fscnpr:Authorization/cat_ru:PrDocumentNumber, $len - 2) = 'ВРВ'">на временный вывоз из РФ</xsl:when>
														</xsl:choose>
													</xsl:otherwise>
												</xsl:choose>
												<xsl:text> </xsl:text>
