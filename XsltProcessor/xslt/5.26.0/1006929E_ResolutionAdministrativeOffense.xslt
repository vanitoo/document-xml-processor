						...
						<tbody>
							...
							<tr>
								<td style="text-align: justify"-->
									...
									<br/-->
									<xsl:choose>
										<xsl:when test="resao:OffenceDecisionInfo/resao:DecisionTypeCode='102060' or resao:OffenceDecisionInfo/resao:DecisionTypeCode='102070'">
							...
							<tr>
								<td style="text-align: justify" class="indent">
									...
									<xsl:text>, </xsl:text>
									<xsl:text>29.9, 29.10 КоАП РФ</xsl:text>
								</td>
							</tr>
							<tr align="center">
								<td>
							...
							<xsl:if test="resao:OffenceDecisionInfo/resao:DecisionTypeCode='102070'">
								<tr>
									<td style="text-align: justify" class="indent">
