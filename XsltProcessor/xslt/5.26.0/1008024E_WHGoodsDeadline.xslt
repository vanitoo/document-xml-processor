...
ввезенных по транспортному документу
				...
				<xsl:for-each select="whgd:TransportDoc">
					<tr>
						<td style="width:210mm">
							<table style="width:210mm">
								<tbody>
