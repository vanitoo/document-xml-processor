...
<xsl:stylesheet exclude-result-prefixes="rktsg cat_ru" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:rktsg="urn:customs.ru:Information:ExchangeDocuments:ReqCorrectPayment:5.17.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
						...
						<tbody>
							...
							<tr>
								<td align="left" class="graphMain" colspan="2" style="width:190mm">
									<xsl:text>Уведомляем, что в соответствии со статьей 313 ТК ЕАЭС таможенным органом принято решение о корректировке таможенной стоимости товаров, заявленной в декларации на товары № </xsl:text>
							...
							<tr>
								<td align="left" class="graphMain" colspan="2" style="width:190mm">
									<xsl:text>В соответствии со статьей 112 ТК ЕАЭС Вам необходимо внести следующие изменения и (или) дополнения в декларацию на товары: </xsl:text>
								</td>
							</tr>
							<tr>
