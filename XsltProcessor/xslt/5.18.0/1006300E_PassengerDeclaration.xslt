		...
		<html>
			...
			<body>
				...
				<div class="page">
							...
							<xsl:for-each select="pas_d:GoodsShipmentDetails/pas_d:PassDeclGoodsInfo/pas_d:GoodsListDetails/pas_d:PassDeclGoods">
								<tr>
									...
									<td class="bordered" valign="top">
										...
										<xsl:if test="pas_d:NetWeightQuantity and pas_d:GoodsQuantity"> / </xsl:if>
					...
					<br/>
					<xsl:choose>
						<xsl:when test="pas_d:GoodsShipmentDetails/pas_d:TransportMeans/pas_d:TransportMeansDetails[pas_d:TransportModeCode='30' or (pas_d:TransportModeCode='90' and not(pas_d:LengthMeasure) and not(pas_d:TransportGrossMass))]">
							<xsl:for-each select="pas_d:GoodsShipmentDetails/pas_d:TransportMeans/pas_d:TransportMeansDetails[pas_d:TransportModeCode='30' or (pas_d:TransportModeCode='90' and not(pas_d:LengthMeasure) and not(pas_d:TransportGrossMass))]">
				...
				<tr>
					...
					<td width="5%">
						<xsl:variable name="FirstAuto">
							<xsl:choose>
								<xsl:when test="$node[1] != 'PassengerDeclaration'">true</xsl:when>
