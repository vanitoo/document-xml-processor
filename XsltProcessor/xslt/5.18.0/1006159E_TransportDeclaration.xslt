...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:trdecl="urn:customs.ru:Information:CustomsDocuments:TransportDeclaration:5.18.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="/">
		<html>
			<head>
				...
				<td colspan="2">
					...
					<table border="1" cellpadding="0" cellspacing="0" class="TS" style="border-color:black; margin:5px; font: 10pt; font-family: Times;" width="98%">
						<tr>
							...
							<td align="center">идентификационный номер<br/>рег.номер ТДТС</td>
						</tr>
						<xsl:for-each select="trdecl:TSInfo/trdecl:TransportMeans">
							<tr>
								...
								<td>
									<xsl:apply-templates select="trdecl:TransportRegNumber"/>
								</td>
								<td>
