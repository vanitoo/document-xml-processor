								...
								<tbody>
									...
									<tr>
										<td class="graph" style="width:100%">Время начала таможенного <xsl:choose>
											...
											<xsl:text> </xsl:text>Дата <xsl:apply-templates mode="russian_date_time" select="ain:BeginInspectionDate"/>
											<br/>
											<br/>
										</td>
									</tr>
