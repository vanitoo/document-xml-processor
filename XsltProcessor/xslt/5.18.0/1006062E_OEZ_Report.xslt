...
<xsl:stylesheet exclude-result-prefixes="math" version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:math="http://exslt.org/math" xmlns:oezr="urn:customs.ru:Information:CustomsDocuments:OEZ_Report:5.17.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
