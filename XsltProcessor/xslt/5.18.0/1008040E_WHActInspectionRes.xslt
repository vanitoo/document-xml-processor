...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:wh_ai="urn:customs.ru:Information:WarehouseDocuments:WHActInspectionRes:5.18.0" xmlns:catWH_ru="urn:customs.ru:Information:WarehouseDocuments:WarehouseCommonAggregateTypesCust:5.18.0" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
		...
		<!--div style="width:100%; min-width:{$w}mm; max-width:{$w}mm; padding-left:5mm;"-->
			<tr>
				...
				<td class="annot graphMain bordered">
					...
					<xsl:if test="catWH_ru:CurrencyCode"/> (<xsl:value-of select="catWH_ru:CurrencyCode"/>)</td>
				<td class="annot graphMain bordered">
