		...
		<html>
			...
			<body>
				<div class="pageAlbum">
					<xsl:choose>
<!-- ************************************************************************************************************************************************************************************************************** -->						
<!-- *** заготовка для (Форма расчета УС по ПП 81_С) ************************************************************************************************************************************************* -->						
<!-- ************************************************************************************************************************************************************************************************************** -->						
						<xsl:when test="1=1"> <!-- заготовка для (Форма расчета УС по ПП 81_С) -->
							<table>
								<tbody>
									<tr>
							...
							<table>
								<tr>
									...
									<td class="border-bottom" width="42%"/>
							...
							<table border="1" style="table-layout:fixed;word-wrap:break-word;width:297mm;">
								...
								<xsl:for-each select="rd:UtilCollDetails">
									<tr>
										<td align="center"><xsl:apply-templates select="rd:GoodsRecNumber"/></td>
										...
										<td align="center">
											<xsl:choose>
												<xsl:when test="rd:Vehicle/rd:EngineKindCode = 1">бензиновый</xsl:when>
												<xsl:when test="rd:Vehicle/rd:EngineKindCode = 2">дизельный</xsl:when>
												<xsl:when test="rd:Vehicle/rd:EngineKindCode = 3">электрический</xsl:when>
												<xsl:when test="rd:Vehicle/rd:EngineKindCode = 4">гибридный на основе бензинового</xsl:when>
												<xsl:when test="rd:Vehicle/rd:EngineKindCode = 5">гибридный на основе дизельного</xsl:when>
												<xsl:when test="rd:Vehicle/rd:EngineKindCode = 6">конв. для работы на газе</xsl:when>
												<xsl:when test="rd:Vehicle/rd:EngineKindCode = 7">иной</xsl:when>
												<xsl:otherwise>
													<xsl:apply-templates select="rd:Vehicle/rd:EngineKindCode"/>
												</xsl:otherwise>
											</xsl:choose>
										</td>
										<td align="center">
							...
							<br/>
							<xsl:choose>
								<xsl:when test="rd:Payer[rd:FactPayerIndicator='true' or rd:FactPayerIndicator='1' or rd:FactPayerIndicator='T' or rd:FactPayerIndicator='TRUE']">
									<xsl:for-each select="rd:Payer[rd:FactPayerIndicator='true' or rd:FactPayerIndicator='1' or rd:FactPayerIndicator='T' or rd:FactPayerIndicator='TRUE']">
										...
										<table>
											...
											<tr>
												<td colspan="2" class="border-bottom">
													...
													<xsl:if test="cat_ru:RFOrganizationFeatures/cat_ru:OGRN and rd:IdentityDoc">
											...
											<tr>
												...
												<td class="border-bottom"><xsl:apply-templates mode="TPORegNum" select="rd:TPORegNumber"/></td>
											</tr>
										</table>
									</xsl:for-each>
								</xsl:when>
								<xsl:otherwise>
									<table>
										...
										<tr>
											<td width="30%"><xsl:text>ИНН/КПП (при наличии):</xsl:text></td>
											<td width="70%" class="border-bottom"></td>
										</tr>
										<tr>
											<td colspan="2"><xsl:text>ОГРН, дата регистрации (паспортные данные физического лица):</xsl:text></td>
										</tr>
...
<!-- ************************************************************************************************************************************************************************************************************** -->						
						<xsl:when test="1=2"> <!-- реализация для (Форма расчета УС по ПП 1291_К) -->
							<table>
								<tbody>
									<tr>
										<td align="center" class="title">
							...
							<table border="1" style="table-layout:fixed;word-wrap:break-word;width:297mm;">
								<tr>
									<th width="8%">Идентификационный номер или заводской номер</th>
									<th width="8%">Марка</th>
									<th width="8%">Модель</th>
									<th width="8%">Дата изготовления <sup>1</sup></th>
									<th width="8%">Вид самоходной машины или прицепа<sup>2</sup></th>
									<th width="8%">Мощность силовой установки</th>
									<th width="8%">Модель, номер двигателя</th>
									<th width="8%">Тип двигателя</th>
									<th width="8%">Грузоподъемность (тонн)</th>
								...
								<xsl:for-each select="rd:UtilCollDetails">
									<tr>
										...
										<td align="center">
											<xsl:choose>
												<xsl:when test="rd:Vehicle/rd:EngineVolumeQuanity">
													<xsl:value-of select="rd:Vehicle/rd:EngineVolumeQuanity"/>
												</xsl:when>
											</xsl:choose>
										</td>
										<td align="center">
										...
										<td align="center">
											<xsl:choose>
												...
												<xsl:when test="rd:Vehicle/rd:EngineKindCode = 7">иной</xsl:when>
												<xsl:otherwise>
													<xsl:value-of select="rd:Vehicle/rd:EngineKindCode"/>
												</xsl:otherwise>
											</xsl:choose>
										</td>
										<td align="center">
							...
							<xsl:choose>
								...
								<xsl:otherwise>
									<table>
										...
										<tr>
											<td colspan="2"><xsl:text>Место нахождения (место жительства (адрес) физического лица):</xsl:text></td>
										</tr>
										<tr>
											<td colspan="2" class="border-bottom"></td>
										</tr>
							...
							<table>
								...
								<tr>
									<td class="graphLittle">
										<xsl:text>(фамилия, имя, отчество руководителя (полномочного представителя) организации или физического лица)</xsl:text>
									</td>
									<td/>
									<td class="graphLittle">
										<xsl:text>(подпись)</xsl:text>
							...
							<table>
								...
								<tr>
									<td align="right"><sup>1</sup></td>
									<td colspan="2" width="97%"><xsl:text>Дата изготовления самоходных машин определяется в соответствии с порядком определения момента выпуска и объема двигателя авто-, мототранспортного средства, установленным в приложении № 6 к Соглашению между Правительством Российской Федерации, Правительством Республики Беларусь и Правительством Республики Казахстан о порядке перемещения физическими лицами товаров для личного пользования через таможенную границу Таможенного союза и совершения таможенных операций, связанных с их выпуском, от 18 июня 2010 г.</xsl:text></td>
								</tr>
								<tr>
									<td align="right"><sup>2</sup></td>
									<td colspan="2" width="97%"><xsl:text>Вид самоходной машины или прицепа указывается в соответствии с перечнем видов и категорий самоходных машин и прицепов к ним, в отношении которых уплачивается утилизационный сбор, а также размеров утилизационного сбора, утвержденным постановлением Правительства Российской Федерации от ____________________ г. № ________ "Об утилизационном сборе в отношении самоходных машин и (или) прицепов и о внесении изменений в некоторые акты Правительства Российской Федерации".</xsl:text></td>
								</tr>
							</table>
						</xsl:when>
					</xsl:choose>
