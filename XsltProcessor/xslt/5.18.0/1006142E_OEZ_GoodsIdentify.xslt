...
<xsl:stylesheet version="1.0" xmlns:cat_ru="urn:customs.ru:CommonAggregateTypes:5.10.0" xmlns:gooid="urn:customs.ru:Information:CustomsDocuments:OEZ_GoodsIdentify:5.18.0" xmlns:catESAD_cu="urn:customs.ru:CUESADCommonAggregateTypesCust:5.17.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:RUScat_ru="urn:customs.ru:RUSCommonAggregateTypes:5.16.0">
         ...
         <body>
            <div class="page">
               <table border="0" style="width: 100%">
                  <tbody>
					<tr>
						<td align="center" colspan="3" style="width: 100%"><b><xsl:value-of select="$docSign"/></b><br/>
						<br/>
						<br/>
						</td>
					</tr>
               ...
               <br/>
                  <tbody>
                     <tr>
                        ...
                        <td style="width:40mm"/>
                        <td class="bordered" style="width:60mm"> <br/></td>
                     </tr>
                     <tr align="center">
