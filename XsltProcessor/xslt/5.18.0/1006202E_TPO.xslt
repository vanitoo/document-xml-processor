					...
					<table>
						<tr>
							...
							<td class="graph" colspan="3" rowspan="2" style="border:solid 1pt #000000">1. Тип ордера<br/>
								...
								<xsl:if test="tpo:TPOTypeCode/tpo:TransportModeCode">
									<xsl:text>/</xsl:text>
									<xsl:choose>
										<xsl:when test="tpo:TPOTypeCode/tpo:MovementPurpose = 'ПЛ' and tpo:TPOTypeCode/tpo:TransportModeCode = '1'">--</xsl:when>
						...
						<tr>
							...
							<td class="graph" colspan="2" style="border:solid 1pt #000000">6.1. Общий вес (кг)<br/>
								<xsl:if test="$MPGlobal != 'АС' and $MPGlobal != 'УС'">
				...
				<xsl:otherwise>
					<xsl:choose>
						<xsl:when test="$MP = 'УС'">
							...
							<xsl:call-template name="russian_date"><xsl:with-param name="dateIn" select="tpo:UtilCollDetails/tpo:ChassisOrTrailer/tpo:ManufactureDate"/> </xsl:call-template>
							<xsl:text> </xsl:text>
							<xsl:apply-templates select="tpo:UtilCollDetails/tpo:ChassisOrTrailer/tpo:ManufactureYear"/>
							<xsl:text> </xsl:text>
							<xsl:apply-templates select="tpo:UtilCollDetails/tpo:ChassisOrTrailer/tpo:ManufactureMonth"/>
							<br/>
							<xsl:text> Категория: </xsl:text>
							<xsl:apply-templates select="tpo:UtilCollDetails/tpo:ChassisOrTrailer/tpo:TransportCategoryCode"/>
							<xsl:choose>
								<xsl:when test="tpo:TPO/tpo:Goods/tpo:UtilCollDetails/tpo:ChassisOrTrailerCode = 2">
									<br/>
								...
								<xsl:otherwise>
									<br/>
									<xsl:text> объем двигателя: </xsl:text><xsl:value-of select="tpo:AutomobileInfo/tpo:EngineVolumeQuanity"/>
									<br/>
									<xsl:text> модель/номер двигателя: </xsl:text><xsl:value-of select="tpo:AutomobileInfo/tpo:EngineModel"/>/<xsl:value-of select="tpo:AutomobileInfo/tpo:EngineId"/>
									<br/>
							...
							<br/>
							<xsl:text> грузоподъемность: </xsl:text><xsl:value-of select="tpo:UtilCollDetails/tpo:ChassisOrTrailer/tpo:TotalWeight"/>
						</xsl:when>
						<xsl:when test="$MP = 'АС'">
		...
		<tr>
			...
			<td class="graph" colspan="9" style="border:solid 1pt #000000">
				<table border="0pt #ffffff">
					<tr>
						<td align="center" class="graph" style="border-left:0px solid #ffffff; border-top:0px solid #ffffff; border-right:1px solid #000000; border-bottom:1px solid #0000000;">Вид</td>
						<td align="center" class="graph" style="border-left:1px solid #000000; border-top:0px solid #ffffff; border-right:1px solid #000000; border-bottom:1px solid #0000000;"> </td>
						<td align="center" class="graph" style="border-left:1px solid #000000; border-top:0px solid #ffffff; border-right:1px solid #000000; border-bottom:1px solid #0000000;">Ставка</td>
						<td align="center" class="graph" colspan="2" style="border-left:1px solid #000000; border-top:0px solid #ffffff; border-right:1px solid #000000; border-bottom:1px solid #0000000;">Исчисленная сумма</td>
						<td align="center" class="graph" style="border-left:1px solid #000000; border-top:0px solid #ffffff; border-right:1px solid #000000; border-bottom:1px solid #0000000;">СП</td>
						<td align="center" class="graph" colspan="3" style="border-left:1px solid #000000; border-top:0px solid #ffffff; border-right:0px solid #ffffff; border-bottom:1px solid #0000000;">Подробности уплаты</td>
